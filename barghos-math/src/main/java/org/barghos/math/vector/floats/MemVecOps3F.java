...
public class MemVecOps3F
{
	...
	public static MemorySegment write(float v1X, float v1Y, float v1Z, @ExtractionParam MemorySegment res, long resOffset)
	{
	...
	public static MemorySegment writeBlock8(float v1X, float v1Y, float v1Z, @ExtractionParam MemorySegment res, long resOffset)
	{
		res.set(JAVA_FLOAT, resOffset, v1X);
		res.set(JAVA_FLOAT, resOffset+4, v1Y);
		res.set(JAVA_FLOAT, resOffset+8, v1Z);
	...
	public static MemorySegment writeBlock16(float v1X, float v1Y, float v1Z, @ExtractionParam MemorySegment res, long resOffset)
	{
		res.set(JAVA_FLOAT, resOffset, v1X);
		res.set(JAVA_FLOAT, resOffset+4, v1Y);
		res.set(JAVA_FLOAT, resOffset+8, v1Z);
	...
	{
		MemorySegment.copy(mem, memOffset, res, resOffset, 12);
