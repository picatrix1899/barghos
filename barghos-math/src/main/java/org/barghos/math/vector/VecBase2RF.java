...
/**
 * This interface provides non-modifying operations for basic float vectors with 
 * two components. Therefore the operations of this interface will not alter
 * the component values of this vector.
 */
public interface VecBase2RF extends Tup2RF
{
	/**
	 * Creates a new instance of the original type of this vector and adopts the
	 * component values from the given tuple {@code (t)}.
	 * 
	 * @param t The tuple to adopt the component values from.
	 * 
	 * @return
	 * A new instance of the original type of this vector with the adopted
	 * component values.
	 */
	Tup2RF createNew(Tup2RF t);
	 ...
	 */
	@Override
	Tup2RF createNew(@MinLength(2) TupRF t);
	
	/**
	 * Creates a new instance of the type of this vector and adopts the
	 * component values from the given tuple {@code (t)}. The size of the given
	 * tuple {@code (t)} has to be a minimum of two entries.
	 * 
	 ...
	 */
	@Override
	Tup2RF createNew(@MinLength(2) float... t);
	
	/**
	 * Creates a new instance of the type of this vector and sets the component
	 * values to the given value.
	 * 
	 * @param value The value that will be used for all component values.
	 * 
	 * @return
	 * A new instance of the original type of this vector with the component
	 * values set to the given value.
	 */
	Tup2RF createNew(float value);
	
	/**
	 * Creates a new instance of the original vector of this tuple and adopts
	 * the component values from the given tuple {@code (x, y)}.
	 * 
	 ...
	 * component values.
	 */
	Tup2RF createNew(float x, float y);
	
	/**
	 * Creates a copy of this vector with adopted component values.
	 * Therefore it creates a new instance of the original type of this vector
	 * and adopts the component values from this vector.
	 * 
	 * @return A copy of this vector with the component values adopted.
	 */
	@Override
	VecBase2RF copy();
	...
	/**
	 * Returns the value of the component at the given index from the vector.
	 *
	 * <p>
	 ...
	 */
	@Override
	float getAt(@IntValueRange(min=0, max=1) int index);
	 ...
	 */
	@Override
	float[] toArray(@ExtractionParam @MinLength(2) float[] res);
	 ...
	 */
	@Override
	boolean isFiniteAt(@IntValueRange(min=0, max=1) int index);
	 ...
	 */
	@Override
	boolean isZeroAt(@IntValueRange(min=0, max=1) int index);
	 ...
	 */
	@Override
	boolean isZeroAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index);
	
	/**
	 * Returns whether the x component value is exactly zero.
	 *
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * @return
	 * <p>
	 * {@code true} - If the x component value is exactly zero.
	 * 
	 * <p>
	 * {@code false} - Otherwise.
	 */
	...
	/**
	 * Returns whether the y component value is exactly zero.
	 *
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * @return
	 * <p>
	 * {@code true} - If the y component value is exactly zero.
	 * 
	 * <p>
	 * {@code false} - Otherwise.
	 */
	...
	/**
	 * Returns whether the x component value is approximately zero.
	 * 
	 * <p>
	 * This takes into account an inclusive margin of the given tolerance around
	 * zero in positive and negative direction. This margin allows for example
	 ...
	 * @return
	 * <p>
	 * {@code true} - If the x component value is zero, taking into account
	 * the given tolerance.
	 * 
	 * <p>
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtV0(@FloatMinValue(0.0f) float tolerance);
	
	/**
	 * Returns whether the y component value is approximately zero.
	 * 
	 * <p>
	 * This takes into account an inclusive margin of the given tolerance around
	 * zero in positive and negative direction. This margin allows for example
	 ...
	 * @return
	 * <p>
	 * {@code true} - If the y component value is zero, taking into account
	 * the given tolerance.
	 * 
	 * <p>
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtV1(@FloatMinValue(0.0f) float tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtX(@FloatMinValue(0.0f) float tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtY(@FloatMinValue(0.0f) float tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup2RF t);
	 ...
	 */
	@Override
	boolean equals(@MinLength(2) @Nullable TupRF t);
	 ...
	 */
	@Override
	boolean equals(@MinLength(2) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@FloatMinValue(0.0f) float tolerance, @Nullable Tup2RF t);
	 ...
	 */
	@Override
	boolean equals(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable TupRF t);
	 ...
	 */
	@Override
	boolean equals(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@FloatMinValue(0.0f) float tolerance, float v0, float v1);
	 ...
	 */
	@Override
	boolean equalsAt(@IntValueRange(min=0, max=1) int index, @Nullable Tup2RF t);
	 ...
	 */
	@Override
	boolean equalsAt(@IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable TupRF t);
	 ...
	 */
	@Override
	boolean equalsAt(@IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable float... t);
	 ...
	 */
	@Override
	boolean equalsAt(@IntValueRange(min=0, max=1) int index, float value);
	 ...
	 */
	@Override
	boolean equalsAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, @Nullable Tup2RF t);
	 ...
	 */
	@Override
	boolean equalsAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable TupRF t);
	 ...
	 */
	@Override
	boolean equalsAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable float... t);
	 ...
	 */
	@Override
	boolean equalsAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, float value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@MinLength(1) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@MinLength(1) @Nullable float... t);
	 ...
	 */
	@Override
	boolean equalsAtV1(@Nullable Tup2RF t);
	 ...
	 */
	@Override
	boolean equalsAtV1(@MinLength(2) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@MinLength(2) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@FloatMinValue(0.0f) float tolerance, float value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@FloatMinValue(0.0f) float tolerance, @Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@FloatMinValue(0.0f) float tolerance, float value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@MinLength(1) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@MinLength(1) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@MinLength(2) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@MinLength(2) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtX(@FloatMinValue(0.0f) float tolerance, float value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@FloatMinValue(0.0f) float tolerance, @Nullable Tup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable TupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable float... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtY(@FloatMinValue(0.0f) float tolerance, float value);
	 ...
	 */
	@Override
	VecBase2RF arrangeN(@MinLength(2) @IntValueRange(min=0, max=1) int... indices);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	VecBase2RF arrangeN(@IntValueRange(min=0, max=1) int i0, @IntValueRange(min=0, max=1) int i1);
	 ...
	 */
	@Override
	VecBase2RF swizzleN(@IntValueRange(min=0, max=1) int indexA, @IntValueRange(min=0, max=1) int indexB);
     ...
     */
	@Override
	int compareAt(@IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable Tup2RF t);
     ...
     *
     * <p>
	 * The valid index range is from 0 to 1. The component at the given index in
     ...
     */
	@Override
	int compareAt(@IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable TupRF t);
     ...
     */
	@Override
	int compareAt(@IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable float... t);
     ...
     */
	@Override
	int compareAt(@IntValueRange(min=0, max=1) int index, float value);
     ...
     */
	@Override
	int compareAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, @Nullable Tup2RF t);
     ...
     */
	@Override
	int compareAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable TupRF t);
     ...
     */
	@Override
	int compareAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, @MinLength(2) @Nullable float... t);
     ...
     */
	@Override
	int compareAt(@FloatMinValue(0.0f) float tolerance, @IntValueRange(min=0, max=1) int index, float value);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtV0(@MinLength(1) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtV0(@MinLength(1) @Nullable float... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtV1(@MinLength(2) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtV1(@MinLength(2) @Nullable float... t);
     ...
     * the given tuple.
     */
	int compareAtV0(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtV0(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtV0(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable float... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV0(@FloatMinValue(0.0f) float tolerance, float value);
     ...
     * the given tuple.
     */
	int compareAtV1(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtV1(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtV1(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable float... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV1(@FloatMinValue(0.0f) float tolerance, float value);
     ...
     * the given tuple.
     */
	int compareAtX(@Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtX(@MinLength(1) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtX(@MinLength(1) @Nullable float... t);
     ...
     * the given tuple.
     */
	int compareAtY(@Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtY(@MinLength(2) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtY(@MinLength(2) @Nullable float... t);
     ...
     * the given tuple.
     */
	int compareAtX(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtX(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtX(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable float... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtX(@FloatMinValue(0.0f) float tolerance, float value);
     ...
     * the given tuple.
     */
	int compareAtY(@FloatMinValue(0.0f) float tolerance, @MinLength(2) @Nullable Tup2RF t);
     ...
     * the given tuple.
     */
	int compareAtY(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable TupRF t);
     ...
     * the given tuple.
     */
	int compareAtY(@FloatMinValue(0.0f) float tolerance, @MinLength(1) @Nullable float... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtY(@FloatMinValue(0.0f) float tolerance, float value);
}
