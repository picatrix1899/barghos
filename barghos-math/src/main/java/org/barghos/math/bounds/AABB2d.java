...
public class AABB2d
{
	...
	public <T extends Tup2dW> T getMin(T res)
	{
	...
	public <T extends Tup2dW> T getMax(T res)
	{
	...
	public <T extends Vec2dW> T getSize(T res)
	{
	...
	public <T extends Tup2dW> T getCenter(T res)
	{
