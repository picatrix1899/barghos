...
public interface LineSegment2fR
{
	LineSegment2fR createNew();
	
	default LineSegment2fR createNew(LineSegment2fR line)
	{
		return createNew(line.p0x(), line.p0y(), line.p1x(), line.p1y());
	}
	
	default LineSegment2fR createNew(Tup2fR p0, Tup2fR p1)
	{
		return createNew(p0.v0(), p0.v1(), p1.v0(), p1.v1());
	}
	
	default LineSegment2fR createNew(Tup2fR p0, @MinLength(2) float[] p1)
	{
		return createNew(p0.v0(), p0.v1(), p1[0], p1[1]);
	}
	
	default LineSegment2fR createNew(Tup2fR p0, float p1X, float p1Y)
	{
		return createNew(p0.v0(), p0.v1(), p1X, p1Y);
	}
	
	default LineSegment2fR createNew(@MinLength(2) float[] p0, Tup2fR p1)
	{
		return createNew(p0[0], p0[1], p1.v0(), p1.v1());
	}
	
	default LineSegment2fR createNew(@MinLength(2) float[] p0, @MinLength(2) float[] p1)
	{
		return createNew(p0[0], p0[1], p1[0], p1[1]);
	}
	
	default LineSegment2fR createNew(@MinLength(2) float[] p0, float p1X, float p1Y)
	{
		return createNew(p0[0], p0[1], p1X, p1Y);
	}
	
	default LineSegment2fR createNew(float p0X, float p0Y, Tup2fR p1)
	{
		return createNew(p0X, p0Y, p1.v0(), p1.v1());
	}
	
	default LineSegment2fR createNew(float p0X, float p0Y, @MinLength(2) float[] p1)
	{
		return createNew(p0X, p0Y, p1[0], p1[1]);
	}
	
	LineSegment2fR createNew(float p0X, float p0Y, float p1X, float p1Y);
