...
/**
 * This class provides comoponent tests for the interface {@link Tup4bigdBase}.
 * 
 * @author picatrix1899
 */
class Tup4bigdBaseTest
{
	/**
	...
	{
		assertTrue(Tup4bigdR.class.isAssignableFrom(Tup4bigdBase.class));
	}
	...
	{
		assertTrue(TupbigdBase.class.isAssignableFrom(Tup4bigdBase.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#set(Tup4bigdR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup4bigdBase t = mock(Tup4bigdBase.class);
	...
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#set(BigDecimal)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#set(BigDecimal, BigDecimal, BigDecimal, BigDecimal)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#set(TupbigdR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#setArray(BigDecimal[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#setByIndex(int, BigDecimal)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4bigdBase#setByIndex(int, BigDecimal)} throws
