 ...
 * class {@link ImmutableTup4i}.
 * 
 * @author picatrix1899
 */
class ImmutableTup4i_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup4i#getValueMapping()} function returns the correct components.
	 */
	@Test
