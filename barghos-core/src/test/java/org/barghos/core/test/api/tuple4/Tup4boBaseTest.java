...
/**
 * This class provides comoponent tests for the interface {@link Tup4boBase}.
 * 
 * @author picatrix1899
 */
class Tup4boBaseTest
{
	/**
	...
	{
		assertTrue(Tup4boR.class.isAssignableFrom(Tup4boBase.class));
	}
	...
	{
		assertTrue(TupboBase.class.isAssignableFrom(Tup4boBase.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup4boBase#set(Tup4boR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup4boBase t = mock(Tup4boBase.class);
	...
	/**
	 * This test ensures, that the function {@link Tup4boBase#set(boolean)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4boBase#set(boolean, boolean, boolean, boolean)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup4boBase#set(TupboR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup4boBase#setArray(boolean[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4boBase#setByIndex(int, boolean)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4boBase#setByIndex(int, boolean)} throws
