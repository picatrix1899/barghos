...
/**
 * This class provides component tests for the class {@link org.barghos.core.api.util.ArgumentNullException ArgumentNullException}.
 * 
 * @author picatrix1899
 * 
 * @since 1.0.0.0
...
{
	/**
	 * This test ensures, that the function {@link org.barghos.core.api.util.ArgumentNullException#getArgument() ArgumentNullException.getArgument()}
