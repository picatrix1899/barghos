 ...
 * class {@link ImmutableTup4d}.
 * 
 * @author picatrix1899
 */
class ImmutableTup4d_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup4d#getValueMapping()} function returns the correct components.
	 */
	@Test
