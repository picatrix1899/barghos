 ...
 * class {@link ImmutableTup2bo}.
 * 
 * @author picatrix1899
 */
class ImmutableTup2bo_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup2bo#getValueMapping()} function returns the correct components.
	 */
	@Test
