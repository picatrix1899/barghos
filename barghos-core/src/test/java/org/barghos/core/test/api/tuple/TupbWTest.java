...
/**
 * This class provides component tests for the interface {@link TupbW}.
 * 
 * @author picatrix1899
 */
class TupbWTest
{
	/**
	 * This test ensures, that the function {@link TupbW#set(TupbR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	{
		TupbW t = mock(TupbW.class);
	...
	/**
	 * This test ensures, that the function {@link TupbW#set(byte)} adopts the
	...
	/**
	 * This test ensures, that the function {@link TupbW#setArray(byte[])} relays
	 * all array entries to the corresponding component by calling {@link TupbW#setByIndex(int, byte)}
