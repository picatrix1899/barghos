...
/**
 * This class provides component tests for the interface {@link Tup2iW}.
 * 
 * @author picatrix1899
 */
class Tup2iWTest
{
	...
	{
		assertTrue(TupiW.class.isAssignableFrom(Tup2iW.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup2iW#set(Tup2iR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup2iW t = mock(Tup2iW.class);
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#set(int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#set(int, int)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#set(TupiR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#getDimensions()} always
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#setArray(int[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#setByIndex(int, int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup2iW#setByIndex(int, int)} throws
