 ...
 * class {@link ImmutableTup2bigd}.
 * 
 * @author picatrix1899
 */
class ImmutableTup2bigd_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup2bigd#getValueMapping()} function returns the correct components.
	 */
	@Test
