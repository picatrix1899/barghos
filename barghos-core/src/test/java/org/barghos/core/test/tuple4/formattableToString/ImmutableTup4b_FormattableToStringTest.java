 ...
 * class {@link ImmutableTup4b}.
 * 
 * @author picatrix1899
 */
class ImmutableTup4b_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup4b#getValueMapping()} function returns the correct components.
	 */
	@Test
