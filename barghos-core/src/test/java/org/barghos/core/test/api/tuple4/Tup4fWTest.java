...
/**
 * This class provides component tests for the interface {@link Tup4fW}.
 * 
 * @author picatrix1899
 */
class Tup4fWTest
{
	...
	{
		assertTrue(TupfW.class.isAssignableFrom(Tup4fW.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup4fW#set(Tup4fR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup4fW t = mock(Tup4fW.class);
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#set(float)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#set(float, float, float, float)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#set(TupfR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#getDimensions()} always
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#setArray(float[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#setByIndex(int, float)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4fW#setByIndex(int, float)} throws
