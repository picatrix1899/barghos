 ...
 * class {@link ImmutableTup3bigd}.
 * 
 * @author picatrix1899
 */
class ImmutableTup3bigd_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup3bigd#getValueMapping()} function returns the correct components.
	 */
	@Test
