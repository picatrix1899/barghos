 ...
 * class {@link ImmutableTup4str}.
 * 
 * @author picatrix1899
 */
class ImmutableTup4str_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup4str#getValueMapping()} function returns the correct components.
	 */
	@Test
