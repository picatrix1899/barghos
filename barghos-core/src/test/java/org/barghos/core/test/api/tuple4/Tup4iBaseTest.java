...
/**
 * This class provides comoponent tests for the interface {@link Tup4iBase}.
 * 
 * @author picatrix1899
 */
class Tup4iBaseTest
{
	...
	{
		assertTrue(Tup4iR.class.isAssignableFrom(Tup4iBase.class));
	}
	...
	{
		assertTrue(TupiBase.class.isAssignableFrom(Tup4iBase.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup4iBase#set(Tup4iR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup4iBase t = mock(Tup4iBase.class);
	...
	/**
	 * This test ensures, that the function {@link Tup4iBase#set(int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4iBase#set(int, int, int, int)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup4iBase#set(TupiR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup4iBase#setArray(int[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4iBase#setByIndex(int, int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup4iBase#setByIndex(int, int)} throws
