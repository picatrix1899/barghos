...
/**
 * This class provides component tests for the interface {@link Tup2oBase}.
 * 
 * @author picatrix1899
 */
class Tup2oBaseTest
{
	...
	{
		assertTrue(Tup2oR.class.isAssignableFrom(Tup2oBase.class));
	}

	/**
	 * This test ensures, that the function {@link Tup2oBase#set(Tup2oR)} adopts the
	...
	void set_Tuple2Test()
	{
		...
		Tup2oBase<Integer,Double> t = (Tup2oBase<Integer,Double>)mock(Tup2oBase.class);
	...
	/**
	 * This test ensures, that the function {@link Tup2oBase#set(Object, Object)} adopts
