 ...
 * class {@link PTup3bigi}.
 * 
 * @author picatrix1899
 */
class PTup3bigi_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link PTup3bigi#getValueMapping()} function returns the correct components.
	 */
	@Test
