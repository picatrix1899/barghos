...
/**
 * This class provides comoponent tests for the interface {@link Tup2iBase}.
 * 
 * @author picatrix1899
 */
class Tup2iBaseTest
{
	...
	{
		assertTrue(Tup2iR.class.isAssignableFrom(Tup2iBase.class));
	}
	
	/**
	 * This test ensures, that the interface extends the interface {@link Tup2iBase}.
	 */
	@Test
	void inheritance_TupiBaseTest()
	{
		assertTrue(TupiBase.class.isAssignableFrom(Tup2iBase.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup2iBase#set(Tup2iR)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup2iBase#set(int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup2iBase#set(int, int)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup2iBase#set(TupiR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup2iBase#setByIndex(int, int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup2iBase#setByIndex(int, int)} throws
