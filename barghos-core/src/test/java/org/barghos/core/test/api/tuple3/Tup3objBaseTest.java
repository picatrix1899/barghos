...
/**
 * This class provides comoponent tests for the interface {@link Tup3objBase}.
 * 
 * @author picatrix1899
 */
class Tup3objBaseTest
{
	/**
	...
	{
		assertTrue(Tup3objR.class.isAssignableFrom(Tup3objBase.class));
	}
	...
	{
		assertTrue(TupobjBase.class.isAssignableFrom(Tup3objBase.class));
	}

	/**
	 * This test ensures, that the function {@link Tup3objBase#set(Tup3objR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup3objBase t = mock(Tup3objBase.class);
	...
	/**
	 * This test ensures, that the function {@link Tup3objBase#set(Object)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3objBase#set(Object, Object, Object)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3objBase#set(TupobjR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup3objBase#setArray(Object[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3objBase#setByIndex(int, Object)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3objBase#setByIndex(int, Object)} throws
