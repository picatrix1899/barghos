 ...
 * class {@link ImmutableTup4bo}.
 * 
 * @author picatrix1899
 */
class ImmutableTup4bo_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup4bo#getValueMapping()} function returns the correct components.
	 */
	@Test
