 ...
 * class {@link ImmutableTup2f}.
 * 
 * @author picatrix1899
 */
class ImmutableTup2f_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup2f#getValueMapping()} function returns the correct components.
	 */
	@Test
