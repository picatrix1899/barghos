...
/**
 * This class provides component tests for the interface {@link Tup3bW}.
 * 
 * @author picatrix1899
 */
class Tup3bWTest
{
	...
	{
		assertTrue(TupbW.class.isAssignableFrom(Tup3bW.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup3bW#set(Tup3bR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup3bW t = mock(Tup3bW.class);
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#set(byte)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#set(byte, byte, byte)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#set(TupbR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#getDimensions()} always
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#setArray(byte[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#setByIndex(int, byte)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3bW#setByIndex(int, byte)} throws
