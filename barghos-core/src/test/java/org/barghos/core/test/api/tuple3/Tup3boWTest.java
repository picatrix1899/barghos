...
/**
 * This class provides component tests for the interface {@link Tup3boW}.
 * 
 * @author picatrix1899
 */
class Tup3boWTest
{
	...
	{
		assertTrue(TupboW.class.isAssignableFrom(Tup3boW.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup3boW#set(Tup3boR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup3boW t = mock(Tup3boW.class);
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#set(boolean)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#set(boolean, boolean)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#set(TupboR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#getDimensions()} always
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#setArray(boolean[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#setByIndex(int, boolean)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3boW#setByIndex(int, boolean)} throws
