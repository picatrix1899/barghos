 ...
 * class {@link ImmutableTup4f}.
 * 
 * @author picatrix1899
 */
class ImmutableTup4f_FormattableToStringTest
{
	/**
	 * This test ensures, that the {@link ImmutableTup4f#getValueMapping()} function returns the correct components.
	 */
	@Test
