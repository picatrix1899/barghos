...
/**
 * This class provides comoponent tests for the interface {@link Tup3bigiBase}.
 * 
 * @author picatrix1899
 */
class Tup3bigiBaseTest
{
	/**
	...
	{
		assertTrue(Tup3bigiR.class.isAssignableFrom(Tup3bigiBase.class));
	}
	
	/**
	 * This test ensures, that the interface extends the interface {@link Tup3bigiBase}.
	 */
	@Test
	void inheritance_TupbigiBaseTest()
	{
		assertTrue(TupbigiBase.class.isAssignableFrom(Tup3bigiBase.class));
	}
	
	/**
	 * This test ensures, that the function {@link Tup3bigiBase#set(Tup3bigiR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_Tuple2Test()
	{
		Tup3bigiBase t = mock(Tup3bigiBase.class);
	...
	/**
	 * This test ensures, that the function {@link Tup3bigiBase#set(BigInteger)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3bigiBase#set(BigInteger, BigInteger, BigInteger)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3bigiBase#set(TupbigiR)} adopts the
	 * values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup3bigiBase#setByIndex(int, BigInteger)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3bigiBase#setByIndex(int, BigInteger)} throws
