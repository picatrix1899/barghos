...
public class MathUtils
{
	...
	public static double signumEps(double tolerance, double value)
	{
	...
	public static float signumEps(float tolerance, float value)
	{
	...
	public static long signumEps(long tolerance, long value)
	{
		return Math.abs(value) <= tolerance ? 0l : (long)Math.signum(value);
	}
	
	public static int signumEps_i(double tolerance, double value)
	{
		return Math.abs(value) <= tolerance ? 0 : (int)Math.signum(value);
	}
	
	public static int signumEps_i(float tolerance, float value)
	{
		return Math.abs(value) <= tolerance ? 0 : (int)Math.signum(value);
	}
	
	public static int signumEps_i(long tolerance, long value)
	{
		return Math.abs(value) <= tolerance ? 0 : (int)Math.signum(value);
	}
	
	public static int signumEps(int tolerance, int value)
	{
		return Math.abs(value) <= tolerance ? 0 : (int)Math.signum(value);
	}
	
	public static double signumEps4(double value)
	{
		if(Double.isNaN(value)) return Double.NaN;
	...
	public static float signumEps4(float value)
	{
		if(Float.isNaN(value)) return Float.NaN;
	...
	public static int signumEps4_i(double value)
	{
		return Math.abs(value) <= EM4 ? 0 : (int)Math.signum(value);
	}
	
	public static int signumEps4_i(float value)
	{
		return Math.abs(value) <= EM4f ? 0 : (int)Math.signum(value);
	}
	
	public static double signumEps6(double value)
	{
		if(Double.isNaN(value)) return Double.NaN;
	...
	public static float signumEps6(float value)
	{
		if(Float.isNaN(value)) return Float.NaN;
	...
	public static int signumEps6_i(double value)
	{
		return Math.abs(value) <= EM6 ? 0 : (int)Math.signum(value);
	}
	
	public static int signumEps6_i(float value)
	{
		return Math.abs(value) <= EM6f ? 0 : (int)Math.signum(value);
	}
	
	public static double signumEps8(double value)
	{
		if(Double.isNaN(value)) return Double.NaN;
	...
	public static float signumEps8(float value)
	{
		if(Float.isNaN(value)) return Float.NaN;
	...
	public static int signumEps8_i(double value)
	{
		return Math.abs(value) <= EM8 ? 0 : (int)Math.signum(value);
	}
	
	public static int signumEps8_i(float value)
	{
	...
	public static double clampMinEps(double tolerance, double value, double min)
	{
	...
	public static float clampMinEps(float tolerance, float value, float min)
	{
	...
	public static long clampMinEps(long tolerance, long value, long min)
	{
		return value < min + tolerance ? min : value;
	}
	
	public static int clampMinEps(int tolerance, int value, int min)
	{
		return value < min + tolerance ? min : value;
	}
	
	public static double clampMinEps4(double value, double min)
	{
		if(Double.isNaN(value) || Double.isNaN(min)) return Double.NaN;
	...
	public static float clampMinEps4(float value, float min)
	{
		if(Float.isNaN(value) || Float.isNaN(min)) return Float.NaN;
	...
	public static double clampMinEps6(double value, double min)
	{
		if(Double.isNaN(value) || Double.isNaN(min)) return Double.NaN;
	...
	public static float clampMinEps6(float value, float min)
	{
		if(Float.isNaN(value) || Float.isNaN(min)) return Float.NaN;
	...
	public static double clampMinEps8(double value, double min)
	{
		if(Double.isNaN(value) || Double.isNaN(min)) return Double.NaN;
	...
	public static float clampMinEps8(float value, float min)
	{
		if(Float.isNaN(value) || Float.isNaN(min)) return Float.NaN;
	...
	public static double clampMaxEps(double tolerance, double value, double max)
	{
	...
	public static float clampMaxEps(float tolerance, float value, float max)
	{
	...
	public static long clampMaxEps(long tolerance, long value, long max)
	{
		return value > max - tolerance ? max : value;
	}
	
	public static int clampMaxEps(int tolerance, int value, int max)
	{
		return value > max - tolerance ? max : value;
	}
	
	public static double clampMaxEps4(double value, double max)
	{
		if(Double.isNaN(value) || Double.isNaN(max)) return Double.NaN;
	...
	public static float clampMaxEps4(float value, float max)
	{
		if(Float.isNaN(value) || Float.isNaN(max)) return Float.NaN;
	...
	public static double clampMaxEps6(double value, double max)
	{
		if(Double.isNaN(value) || Double.isNaN(max)) return Double.NaN;
	...
	public static float clampMaxEps6(float value, float max)
	{
		if(Float.isNaN(value) || Float.isNaN(max)) return Float.NaN;
	...
	public static double clampMaxEps8(double value, double max)
	{
		if(Double.isNaN(value) || Double.isNaN(max)) return Double.NaN;
	...
	public static float clampMaxEps8(float value, float max)
	{
		if(Float.isNaN(value) || Float.isNaN(max)) return Float.NaN;
	...
	public static double clampEps(double tolerance, double value, double min, double max)
	{
	...
	public static float clampEps(float tolerance, float value, float min, float max)
	{
	...
	public static long clampEps(long tolerance, long value, long min, long max)
	{
		return value < min + tolerance ? min : value > max - tolerance ? max : value;
	}
	
	public static int clampEps(int tolerance, int value, int min, int max)
	{
		return value < min + tolerance ? min : value > max - tolerance ? max : value;
	}
	
	public static double clampEps4(double tolerance, double value, double min, double max)
	{
		if(Double.isNaN(value) || Double.isNaN(min) || Double.isNaN(max)) return Double.NaN;
	...
	public static float clampEps4(float tolerance, float value, float min, float max)
	{
		if(Float.isNaN(value) || Float.isNaN(min) || Float.isNaN(max)) return Float.NaN;
	...
	public static double clampEps6(double tolerance, double value, double min, double max)
	{
		if(Double.isNaN(value) || Double.isNaN(min) || Double.isNaN(max)) return Double.NaN;
	...
	public static float clampEps6(float tolerance, float value, float min, float max)
	{
		if(Float.isNaN(value) || Float.isNaN(min) || Float.isNaN(max)) return Float.NaN;
	...
	public static double clampEps8(double tolerance, double value, double min, double max)
	{
		if(Double.isNaN(value) || Double.isNaN(min) || Double.isNaN(max)) return Double.NaN;
	...
	public static float clampEps8(float tolerance, float value, float min, float max)
	{
		if(Float.isNaN(value) || Float.isNaN(min) || Float.isNaN(max)) return Float.NaN;
	...
	public static boolean isZeroEps(double tolerance, double value)
	{
		return Math.abs(value) <= tolerance;
	}
	
	public static boolean isZeroEps(float tolerance, float value)
	{
		return Math.abs(value) <= tolerance;
	}
	
	public static boolean isZeroEps(long tolerance, long value)
	{
		return Math.abs(value) <= tolerance;
	}
	
	public static boolean isZeroEps(int tolerance, int value)
	{
		return Math.abs(value) <= tolerance;
	}
	
	public static boolean isZeroEps4(double value)
	{
		return Math.abs(value) <= EM4;
	}
	
	public static boolean isZeroEps4(float value)
	{
		return Math.abs(value) <= EM4f;
	}

	public static boolean isZeroEps6(double value)
	{
		return Math.abs(value) <= EM6;
	}
	
	public static boolean isZeroEps6(float value)
	{
		return Math.abs(value) <= EM6f;
	}
	
	public static boolean isZeroEps8(double value)
	{
		return Math.abs(value) <= EM8;
	}
	
	public static boolean isZeroEps8(float value)
	{
	...
	public static int compareEps(double tolerance, double a, double b)
	{
	...
	public static int compareEps(float tolerance, float a, float b)
	{
		if(MathUtils.abs(a - b) <= tolerance) return 0;
	...
	public static int compareEps(long tolerance, long a, long b)
	{
		if(MathUtils.abs(a - b) <= tolerance) return 0;
	...
	public static int compareEps(int tolerance, int a, int b)
	{
		if(MathUtils.abs(a - b) <= tolerance) return 0;
	...
	public static int compareEps4(double a, double b)
	{
	...
	public static int compareEps4(float a, float b)
	{
	...
	public static int compareEps6(double a, double b)
	{
	...
	public static int compareEps6(float a, float b)
	{
	...
	public static int compareEps8(double a, double b)
	{
	...
	public static int compareEps8(float a, float b)
	{
	...
	public static boolean equalsEps(long tolerance, long a, long b)
	{
		return MathUtils.abs(a - b) <= tolerance;
	}
	
	public static boolean equalsEps(int tolerance, int a, int b)
	{
		return MathUtils.abs(a - b) <= tolerance;
	}
	
	public static boolean equalsEps(double tolerance, double a, double b)
	{
		return MathUtils.abs(a - b) <= tolerance;
	}
	
	public static boolean equalsEps(float tolerance, float a, float b)
	{
		return MathUtils.abs(a - b) <= tolerance;
	}
	
	public static boolean equalsEps4(double a, double b)
	{
		return MathUtils.abs(a - b) <= EM4;
	}
	
	public static boolean equalsEps4(float a, float b)
	{
		return MathUtils.abs(a - b) <= EM4f;
	}
	
	public static boolean equalsEps6(double a, double b)
	{
		return MathUtils.abs(a - b) <= EM6;
	}
	
	public static boolean equalsEps6(float a, float b)
	{
		return MathUtils.abs(a - b) <= EM6f;
	}
	
	public static boolean equalsEps8(double a, double b)
	{
		return MathUtils.abs(a - b) <= EM8;
	}
	
	public static boolean equalsEps8(float a, float b)
	{
		return MathUtils.abs(a - b) <= EM8f;
	}

	public static boolean lessEps(double tolerance, double a, double b)
	{
		return a + tolerance < b;
	}
	
	public static boolean lessEps(float tolerance, float a, float b)
	{
		return a + tolerance < b;
	}
	
	public static boolean lessEps(long tolerance, long a, long b)
	{
		return a + tolerance < b;
	}
	
	public static boolean lessEps(int tolerance, int a, int b)
	{
		return a + tolerance < b;
	}
	
	public static boolean lessEps4(double a, double b)
	{
		return a + EM4 < b;
	}
	
	public static boolean lessEps4(float a, float b)
	{
		return a + EM4f < b;
	}
	
	public static boolean lessEps6(double a, double b)
	{
		return a + EM6 < b;
	}
	
	public static boolean lessEps6(float a, float b)
	{
		return a + EM6f < b;
	}
	
	public static boolean lessEps8(double a, double b)
	{
		return a + EM8 < b;
	}
	
	public static boolean lessEps8(float a, float b)
	{
		return a + EM8f < b;
	}

	public static boolean lessEqualEps(double tolerance, double a, double b)
	{
		return a <= b + tolerance;
	}
	
	public static boolean lessEqualEps(float tolerance, float a, float b)
	{
		return a <= b + tolerance;
	}
	
	public static boolean lessEqualEps(long tolerance, long a, long b)
	{
		return a <= b + tolerance;
	}
	
	public static boolean lessEqualEps(int tolerance, int a, int b)
	{
		return a <= b + tolerance;
	}
	
	public static boolean lessEqualEps4(double a, double b)
	{
		return a <= b + EM4;
	}
	
	public static boolean lessEqualEps4(float a, float b)
	{
		return a <= b + EM4f;
	}
	
	public static boolean lessEqualEps6(double a, double b)
	{
		return a <= b + EM6;
	}
	
	public static boolean lessEqualEps6(float a, float b)
	{
		return a <= b + EM6f;
	}
	
	public static boolean lessEqualEps8(double a, double b)
	{
		return a <= b + EM8;
	}
	
	public static boolean lessEqualEps8(float a, float b)
	{
		return a <= b + EM8f;
	}

	public static boolean greaterEps(double tolerance, double a, double b)
	{
		return a > b + tolerance;
	}
	
	public static boolean greaterEps(float tolerance, float a, float b)
	{
		return a > b + tolerance;
	}
	
	public static boolean greaterEps(long tolerance, long a, long b)
	{
		return a > b + tolerance;
	}
	
	public static boolean greaterEps(int tolerance, int a, int b)
	{
		return a > b + tolerance;
	}
	
	public static boolean greaterEps4(double a, double b)
	{
		return a > b + EM4;
	}
	
	public static boolean greaterEps4(float a, float b)
	{
		return a > b + EM4f;
	}
	
	public static boolean greaterEps6(double a, double b)
	{
		return a > b + EM6;
	}
	
	public static boolean greaterEps6(float a, float b)
	{
		return a > b + EM6f;
	}
	
	public static boolean greaterEps8(double a, double b)
	{
		return a > b + EM8;
	}
	
	public static boolean greaterEps8(float a, float b)
	{
		return a > b + EM8f;
	}
	
	public static boolean greaterEqualEps(double tolerance, double a, double b)
	{
		return a + tolerance >= b;
	}
	
	public static boolean greaterEqualEps(float tolerance, float a, float b)
	{
		return a + tolerance >= b;
	}
	
	public static boolean greaterEqualEps(long tolerance, long a, long b)
	{
		return a + tolerance >= b;
	}
	
	public static boolean greaterEqualEps(int tolerance, int a, int b)
	{
		return a + tolerance >= b;
	}
	
	public static boolean greaterEqualEps4(double a, double b)
	{
		return a + EM4 >= b;
	}
	
	public static boolean greaterEqualEps4(float a, float b)
	{
		return a + EM4f >= b;
	}
	
	public static boolean greaterEqualEps6(double a, double b)
	{
		return a + EM6 >= b;
	}
	
	public static boolean greaterEqualEps6(float a, float b)
	{
		return a + EM6f >= b;
	}
	
	public static boolean greaterEqualEps8(double a, double b)
	{
		return a + EM8 >= b;
	}
	
	public static boolean greaterEqualEps8(float a, float b)
	{
		return a + EM8f >= b;
	}
	...
	public static double round(IRoundMethodD method, double value)
	{
		return method.roundD(value);
	}

	public static float round(IRoundMethodF method, float value)
	{
	...
	public static double sanitizeEps(double tolerance, double value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps(float tolerance, float value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps4(double value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps4(float value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps6(double value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps6(float value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps8(double value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps8(float value)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps(double tolerance, double value, double pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps(float tolerance, float value, float pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps4(double value, double pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps4(float value, float pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps6(double value, double pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps6(float value, float pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double sanitizeEps8(double value, double pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static float sanitizeEps8(float value, float pivot)
	{
		if(!Double.isFinite(value)) return value;
	...
	public static double remapRange(double value, double srcMin, double srcMax, double dstMin, double dstMax)
	{
		return Math.fma(value - srcMin, (srcMax - srcMin) / (dstMax - dstMin), dstMin);
	}
	
	public static float remapRange(float value, float srcMin, float srcMax, float dstMin, float dstMax)
	{
		return Math.fma(value - srcMin, (srcMax - srcMin) / (dstMax - dstMin), dstMin);
	}
}
