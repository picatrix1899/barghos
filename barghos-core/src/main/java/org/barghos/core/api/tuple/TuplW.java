...
/**
 * This interface grants writeonly access to any N-dimensional long tuples.
 * 
 * <p>
...
public interface TuplW
{
	 ...
	 */
	TuplW setByIndex(int index, long value);
	 ...
	 * @return The current tuple.
	 */
	default TuplW setArray(long... values)
	{
