...
/**
 * This interface grants readonly access to any N-dimensional short tuples.
 * 
 * <p>
...
public interface TupsR
{
	 ...
	 */
	default TupsR getNewInstance(TupsR t)
	{
	 ...
	 * @return A new instance of the type of the origin instance
	 */
	default TupsR getNewInstance(short value)
	{
	 ...
	 * @return A new instance of the type of the origin instance
	 */
	TupsR getNewInstanceFromArray(short... values);
}
