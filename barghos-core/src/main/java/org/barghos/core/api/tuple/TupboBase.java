 ...
 * @author picatrix1899
 */
public interface TupboBase extends TupboR, Cloneable
{
	/**
	 ...
	 */
	TupboBase setByIndex(int index, boolean value);
	 ...
	 * @return The current tuple.
	 */
	default TupboBase set(boolean value)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupboBase setArray(boolean... values)
	{
