...
/**
 * This interface grants writeonly access to any N-dimensional big decimal tuples.
 * 
 * <p>
...
public interface TupbigdW
{
	 ...
	 */
	TupbigdW setByIndex(int index, BigDecimal value);
	 ...
	 * @return The current tuple.
	 */
	default TupbigdW set(TupbigdR t)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupbigdW set(BigDecimal value)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupbigdW setArray(BigDecimal... values)
	{
