...
/**
 * This interface grants readonly access to any N-dimensional string tuples.
 * 
 * <p>
...
public interface TupstrR
{
	 ...
	 */
	default TupstrR getNewInstance(TupstrR t)
	{
	 ...
	 * @return A new instance of the type of the origin instance
	 */
	default TupstrR getNewInstance(String value)
	{
	 ...
	 * @return A new instance of the type of the origin instance
	 */
	TupstrR getNewInstanceFromArray(String... values);
}
