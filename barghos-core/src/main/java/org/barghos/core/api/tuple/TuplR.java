...
/**
 * This interface grants readonly access to any N-dimensional long tuples.
 * 
 * <p>
...
public interface TuplR
{
	 ...
	 */
	default TuplR getNewInstance(TuplR t)
	{
	 ...
	 * @return A new instance of the type of the origin instance
	 */
	default TuplR getNewInstance(long value)
	{
	 ...
	 * @return A new instance of the type of the origin instance
	 */
	TuplR getNewInstanceFromArray(long... values);
}
