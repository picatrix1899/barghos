...
/**
 * This interface grants writeonly access to any N-dimensional big integer tuples.
 * 
 * <p>
...
public interface TupbigiW
{
	 ...
	 */
	TupbigiW setByIndex(int index, BigInteger value);
	 ...
	 * @return The current tuple.
	 */
	default TupbigiW set(TupbigiR t)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupbigiW set(BigInteger value)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupbigiW setArray(BigInteger... values)
	{
