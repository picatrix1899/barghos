...
/**
 * This interface grants writeonly access to any N-dimensional short tuples.
 * 
 * <p>
...
public interface TupsW
{
	 ...
	 */
	TupsW setByIndex(int index, short value);
	 ...
	 * @return The current tuple.
	 */
	default TupsW setArray(short... values)
	{
