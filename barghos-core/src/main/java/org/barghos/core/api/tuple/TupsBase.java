 ...
 * @author picatrix1899
 */
public interface TupsBase extends TupsR, Cloneable
{
	/**
	 ...
	 */
	TupsBase setByIndex(int index, short value);
	 ...
	 * @return The current tuple.
	 */
	default TupsBase set(short value)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupsBase setArray(short... values)
	{
