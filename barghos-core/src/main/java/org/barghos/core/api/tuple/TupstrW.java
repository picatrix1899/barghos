...
/**
 * This interface grants writeonly access to any N-dimensional string tuples.
 * 
 * <p>
...
public interface TupstrW
{
	 ...
	 */
	TupstrW setByIndex(int index, String value);
	 ...
	 * @return The current tuple.
	 */
	default TupstrW set(String value)
	{
	 ...
	 * @return The current tuple.
	 */
	default TupstrW setArray(String... values)
	{
