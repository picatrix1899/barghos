...
public interface ConsumerEx2FA2 extends ConsumerEx2<float[][],float[][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2FA2 then(ConsumerEx2FA2 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx2FA2 then(ConsumerEx2<? super float[][],? super float[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx2FA2 then(java.util.function.BiConsumer<? super float[][],? super float[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx2FA2 before(ConsumerEx2FA2 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx2FA2 before(ConsumerEx2<? super float[][],? super float[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default ConsumerEx2FA2 before(java.util.function.BiConsumer<? super float[][],? super float[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer2FA2 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx2FA2 onEx(ConsumerEx2FA2 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx2FA2 onEx(ConsumerEx2<? super float[][],? super float[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer2FA2 onEx(Consumer2FA2 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer2FA2 onEx(Consumer2<? super float[][], ? super float[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@Override
	default Consumer2FA2 onEx(java.util.function.BiConsumer<? super float[][],? super float[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2FA2 of(ConsumerEx2FA2... consumers)
	{
		...
		return (a, b) -> { for(ConsumerEx2FA2 consumer : consumers) consumer.acceptF(a, b); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2FA2 of(ConsumerEx2<? super float[][],? super float[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2FA2 of(Consumer2FA2... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b) -> { for(Consumer2FA2 consumer : consumers) consumer.accept(a, b); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2FA2 of(Consumer2<? super float[][],? super float[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2FA2 of(java.util.function.BiConsumer<? super float[][],? super float[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
