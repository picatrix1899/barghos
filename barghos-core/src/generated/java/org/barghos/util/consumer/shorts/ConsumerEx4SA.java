...
public interface ConsumerEx4SA extends ConsumerEx4<short[],short[],short[],short[]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4SA then(ConsumerEx4SA after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4SA then(ConsumerEx4<? super short[],? super short[],? super short[],? super short[]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4SA before(ConsumerEx4SA before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4SA before(ConsumerEx4<? super short[],? super short[],? super short[],? super short[]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4SA handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx4SA onEx(ConsumerEx4SA consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4SA onEx(ConsumerEx4<? super short[],? super short[],? super short[],? super short[]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4SA onEx(Consumer4SA consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4SA onEx(Consumer4<? super short[],? super short[],? super short[],? super short[]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4SA of(ConsumerEx4SA... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4SA consumer : consumers) consumer.acceptS(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4SA of(ConsumerEx4<? super short[],? super short[],? super short[],? super short[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4SA of(Consumer4SA... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4SA consumer : consumers) consumer.accept(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4SA of(Consumer4<? super short[],? super short[],? super short[],? super short[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
