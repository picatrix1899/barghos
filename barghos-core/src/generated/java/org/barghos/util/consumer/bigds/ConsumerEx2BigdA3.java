 ...
 * arguments and returns no result. Unlike {@link Consumer2BigdA3} this may throw
 * exceptions. {@link ConsumerEx2BigdA3} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx2BigdA3 extends ConsumerEx2<BigDecimal[][][],BigDecimal[][][]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx2BigdA3} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx2BigdA3} performing the given operations in
	 * sequence.
	 * 
