...
public interface ConsumerEx4L extends ConsumerEx4<Long,Long,Long,Long>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4L then(ConsumerEx4L after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4L then(ConsumerEx4<? super Long,? super Long,? super Long,? super Long> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4L before(ConsumerEx4L before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4L before(ConsumerEx4<? super Long,? super Long,? super Long,? super Long> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4L handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx4L onEx(ConsumerEx4L consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4L onEx(ConsumerEx4<? super Long,? super Long,? super Long,? super Long> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4L onEx(Consumer4L consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4L onEx(Consumer4<? super Long,? super Long,? super Long,? super Long> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4L of(ConsumerEx4L... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4L consumer : consumers) consumer.acceptL(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4L of(ConsumerEx4<? super Long,? super Long,? super Long,? super Long>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4L of(Consumer4L... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4L consumer : consumers) consumer.accept(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4L of(Consumer4<? super Long,? super Long,? super Long,? super Long>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
