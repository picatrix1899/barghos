...
public interface ConsumerEx3BA2 extends ConsumerEx3<byte[][],byte[][],byte[][]>
{
	 ...
	 */
	@Override
	default Consumer3BA2 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx3BA2 onEx(ConsumerEx3BA2 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx3BA2 onEx(ConsumerEx3<? super byte[][],? super byte[][],? super byte[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer3BA2 onEx(Consumer3BA2 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer3BA2 onEx(Consumer3<? super byte[][],? super byte[][],? super byte[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	static ConsumerEx3BA2 of(ConsumerEx3BA2... consumers)
	{
		...
		return (a, b, c) -> { for(ConsumerEx3BA2 consumer : consumers) consumer.acceptB(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3BA2 of(Consumer3BA2... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c) -> { for(Consumer3BA2 consumer : consumers) consumer.accept(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3BA2 of(Consumer3<? super byte[][],? super byte[][],? super byte[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
