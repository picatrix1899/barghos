...
/**
 * This interface provides non invasive (readonly) functions and methods for int tuples with three dimensions.
 * 
 * @author picatrix1899
 */
public interface Tup3iR extends TupiR
{
	 ...
	 */
	boolean equals(@Nullable Tup3iR other);
	 ...
	 * @return True if this tuple is componentwise equal to the other tuple.
	 */
	boolean equals(@Nullable Tup3iR other, @IntMinValue(0) int tolerance);
}