...
/**
 * This interface provides non invasive (readonly) functions and methods for double tuples with flexible dimension counts.
 * 
 * @author picatrix1899
 */
public interface TupdR
{
	 ...
	 */
	boolean equals(@Nullable TupdR other);
	 ...
	 * @return True if this tuple is componentwise equal to the other tuple.
	 */
	boolean equals(@Nullable TupdR other, @DoubleMinValue(0.0) double tolerance);
}
