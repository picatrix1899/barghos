...
/**
 * This interface provides non invasive (readonly) functions and methods for object tuples with flexible dimension counts.
 * 
 * @author picatrix1899
 */
public interface TupobjR
{
	 ...
	 */
	boolean equals(@Nullable TupobjR other);
}
