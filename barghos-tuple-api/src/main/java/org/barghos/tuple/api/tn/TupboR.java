...
/**
 * This interface provides non invasive (readonly) functions and methods for boolean tuples with flexible dimension counts.
 * 
 * @author picatrix1899
 */
public interface TupboR
{
	 ...
	 */
	boolean equals(@Nullable TupboR other);
}
