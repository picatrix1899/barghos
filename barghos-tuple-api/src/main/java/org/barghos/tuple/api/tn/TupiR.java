...
/**
 * This interface provides non invasive (readonly) functions and methods for int tuples with flexible dimension counts.
 * 
 * @author picatrix1899
 */
public interface TupiR
{
	 ...
	 */
	boolean equals(@Nullable TupiR other);
	 ...
	 * @return True if this tuple is componentwise equal to the other tuple.
	 */
	boolean equals(@Nullable TupiR other, @IntMinValue(0) int tolerance);
}
