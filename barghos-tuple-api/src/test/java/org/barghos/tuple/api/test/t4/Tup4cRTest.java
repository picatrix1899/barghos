...
class Tup4cRTest
{
	...
	/**
	 * this test ensures, that the function {@link Tup4cR#getDimensions()}
	...
	/**
	 * This test ensures, that the function {@link Tup4cR#getByIndex(int)}
	...
	/**
	 * This test ensures, that the function {@link Tup4cR#toArray(char[])}
