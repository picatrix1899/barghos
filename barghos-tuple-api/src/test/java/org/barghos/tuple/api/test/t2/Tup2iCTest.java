...
import org.barghos.tuple.api.t2.Tup2iC;
...
class Tup2iCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup2iC#set(Tup2iR)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup2iC#setByIndex(int, int)}
	...
	/**
	 * This test ensures, that the function {@link Tup2iC#setArray(int[])}
