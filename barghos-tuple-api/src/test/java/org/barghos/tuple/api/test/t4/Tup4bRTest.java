...
class Tup4bRTest
{
	...
	/**
	 * this test ensures, that the function {@link Tup4bR#getDimensions()}
	...
	/**
	 * This test ensures, that the function {@link Tup4bR#getByIndex(int)}
	...
	/**
	 * This test ensures, that the function {@link Tup4bR#isZero()} returns
	...
	/**
	 * This test ensures, that the function {@link Tup4bR#isZero(byte)} returns
	...
	/**
	 * This test ensures, that the function {@link Tup4bR#toArray(byte[])}
