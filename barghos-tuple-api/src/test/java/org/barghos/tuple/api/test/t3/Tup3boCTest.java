...
import org.barghos.tuple.api.t3.Tup3boC;
...
class Tup3boCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup3boC#set(Tup3boR)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3boC#set(boolean)} adopts
	 ...
	 * {@link Tup3boC#set(boolean, boolean, boolean)} adopts the values and
	...
	/**
	 * This test ensures, that the function {@link Tup3boC#set(TupboR)} adopts
	 * the values from the input tuple and returns the current instance.
	 */
	@Test
	void set_TupleTest()
	...
	/**
	 * This test ensures, that the function {@link Tup3boC#setArray(boolean[])}
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup3boC#setByIndex(int, boolean)} adopts the value to the x
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup3boC#setByIndex(int, boolean)} adopts the value to the y
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup3boC#setByIndex(int, boolean)} adopts the value to the z
