...
import org.barghos.tuple.api.t3.Tup3strC;
...
class Tup3strCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup3strC#set(Tup3strR)}
	...
	/**
	 * This test ensures, that the function {@link Tup3strC#set(String)} adopts
	 ...
	 * {@link Tup3strC#set(String, String, String)} adopts the values and
	...
	/**
	 * This test ensures, that the function {@link Tup3strC#set(TupstrR)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3strC#setArray(String[])}
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup3strC#setByIndex(int, String)} adopts the value to the x
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup3strC#setByIndex(int, String)} adopts the value to the y
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup3strC#setByIndex(int, String)} adopts the value to the z
