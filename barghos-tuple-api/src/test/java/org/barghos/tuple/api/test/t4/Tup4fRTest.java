...
class Tup4fRTest
{
	...
	/**
	 * this test ensures, that the function {@link Tup4fR#getDimensions()}
	...
	/**
	 * This test ensures, that the function {@link Tup4fR#getByIndex(int)}
	...
	void isFinite_Fail_W_PositiveInfTest()
	{
		...
		when(t.getV1()).thenReturn(1.0f);
		when(t.getV2()).thenReturn(1.0f);
		when(t.getV3()).thenReturn(Float.POSITIVE_INFINITY);
	...
	void isFinite_Fail_W_NegativeInfTest()
	{
		...
		when(t.getV1()).thenReturn(1.0f);
		when(t.getV2()).thenReturn(1.0f);
		when(t.getV3()).thenReturn(Float.NEGATIVE_INFINITY);
	...
	void isFinite_Fail_W_NaNTest()
	{
		...
		when(t.getV1()).thenReturn(1.0f);
		when(t.getV2()).thenReturn(1.0f);
		when(t.getV3()).thenReturn(Float.NaN);
	...
	/**
	 * This test ensures, that the function {@link Tup4fR#isZero()} returns
	...
	/**
	 * This test ensures, that the function {@link Tup4fR#isZero(float)} returns
	...
	/**
	 * This test ensures, that the function {@link Tup4fR#toArray(float[])}
