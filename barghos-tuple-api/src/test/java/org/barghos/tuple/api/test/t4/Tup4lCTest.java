...
import org.barghos.tuple.api.t4.Tup4lC;
...
class Tup4lCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup4lC#set(Tup4lR)} adopts
	 ...
	 * {@link Tup4lC#set(long, long, long, long)} adopts the values and
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4lC#setByIndex(int, long)} adopts the value to the x component
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4lC#setByIndex(int, long)} adopts the value to the y component
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4lC#setByIndex(int, long)} adopts the value to the z component
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4lC#setByIndex(int, long)} adopts the value to the w component
	...
	/**
	 * This test ensures, that the function {@link Tup4lC#setArray(long[])}
