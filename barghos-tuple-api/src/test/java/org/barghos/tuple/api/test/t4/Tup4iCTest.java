...
import org.barghos.tuple.api.t4.Tup4iC;
...
class Tup4iCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup4iC#set(Tup4iR)} adopts
	 ...
	 * {@link Tup4iC#set(int, int, int, int)} adopts the values and
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4iC#setByIndex(int, int)} adopts the value to the x component
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4iC#setByIndex(int, int)} adopts the value to the y component
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4iC#setByIndex(int, int)} adopts the value to the z component
	...
	/**
	 * This test ensures, that the function
	 * {@link Tup4iC#setByIndex(int, int)} adopts the value to the w component
	...
	/**
	 * This test ensures, that the function {@link Tup4iC#setArray(int[])}
