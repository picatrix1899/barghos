...
import org.barghos.tuple.api.t2.Tup2bC;
...
class Tup2bCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup2bC#set(Tup2bR)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup2bC#set(byte, byte)}
	...
	/**
	 * This test ensures, that the function {@link Tup2bC#setByIndex(int, byte)}
	...
	/**
	 * This test ensures, that the function {@link Tup2bC#setArray(byte[])}
	 * adopts the values and returns the current instance.
	 */
	@Test
	void setArrayTest()
