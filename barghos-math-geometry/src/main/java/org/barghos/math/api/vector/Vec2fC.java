...
public interface Vec2fC extends Vec2fR, SimpleVec2fC
{
	 ...
	 */
	default Vec2fC integrateLinear(Tup2fR v2, float alpha)
	{
		return Vec2fErpUtils.integrateLinear(this, v2, alpha, this);
	}
	 ...
	 * @return A new instance of this vector with the result.
	 */
	default Vec2fC integrateLinear(@MinLength(2) float[] v2, float alpha)
	{
		return Vec2fErpUtils.integrateLinear(this, v2, alpha, this);
	}
	 ...
	 * @return A new instance of this vector with the result.
	 */
	default Vec2fC integrateLinear(float v2x, float v2y, float alpha)
	{
		return Vec2fErpUtils.integrateLinear(this, v2x, v2y, alpha, this);
	}
	...
	/** {@inheritDoc} */
	@Override
	default Vec2fC integrateLinearN(Tup2fR v2, float alpha)
	{
	...
	/** {@inheritDoc} */
	@Override
	default Vec2fC integrateLinearN(@MinLength(2) float[] v2, float alpha)
	{
		return Vec2fErpUtils.integrateLinearFunc(this, v2, alpha, (x, y) -> createNew(x, y));
	}
	...
	/** {@inheritDoc} */
	@Override
	default Vec2fC integrateLinearN(float v2x, float v2y, float alpha)
	{
