...
public interface Vec2fR extends SimpleVec2fR
{
	...
	{
		return Vec2fUtils.min(this, new FloatIndexValuePair());
	}
	...
	{
		return Vec2fUtils.max(this, new FloatIndexValuePair());
	}
	 ...
	 * @return A new instance of this vector with the result.
	 */
	default Vec2fR integrateLinearN(Tup2fR v2, float alpha)
	{
		return Vec2fErpUtils.integrateLinearFunc(this, v2, alpha, (x, y) -> createNew(x, y));
	}
	 ...
	 * @return A new instance of this vector with the result.
	 */
	default Vec2fR integrateLinearN(@MinLength(2) float[] v2, float alpha)
	{
		return Vec2fErpUtils.integrateLinearFunc(this, v2, alpha, (x, y) -> createNew(x, y));
	}
	 ...
	 * @return A new instance of this vector with the result.
	 */
	default Vec2fR integrateLinearN(float v2x, float v2y, float alpha)
	{
		return Vec2fErpUtils.integrateLinearFunc(this, v2x, v2y, alpha, (x, y) -> createNew(x, y));
	}
	...
	{
		return Vec2fUtils.add(this, v2.v0(), v2.v1(), res);
	}
	...
	{
		return Vec2fUtils.sub(this, v2.v0(), v2.v1(), res);
	}
	...
	{
		return Vec2fUtils.revSub(this, v2.v0(), v2.v1(), res);
	}
	 ...
	 * @return The extraction parameter with the result.
	 */
	default <T extends Tup2fC> T signumR(@ExtractionParam T res)
	{
	 ...
	 * @return The extraction parameter with the result.
	 */
	default float[] signumR(@ExtractionParam @MinLength(2) float[] res)
	{
		return Vec2fUtils.signum(this, res);
	}
	 ...
	 * @return The extraction parameter object with the result.
	 */
	default <T extends Tup2fC> T integrateLinearR(Tup2fR v2, float alpha, @ExtractionParam T res)
	{
		return Vec2fErpUtils.integrateLinear(this, v2, alpha, res);
	}
	 ...
	 * @return The extraction parameter object with the result.
	 */
	default <T extends Tup2fC> T integrateLinearR(@MinLength(2) float[] v2, float alpha, @ExtractionParam T res)
	{
		return Vec2fErpUtils.integrateLinear(this, v2, alpha, res);
	}
	 ...
	 * @return The extraction parameter object with the result.
	 */
	default <T extends Tup2fC> T integrateLinearR(float v2x, float v2y, float alpha, @ExtractionParam T res)
	{
		return Vec2fErpUtils.integrateLinear(this, v2x, v2y, alpha, res);
	}
	 ...
	 * @return The extraction parameter with the result.
	 */
	default float[] integrateLinearR(Tup2fR v2, float alpha, @ExtractionParam @MinLength(2) float[] res)
	{
		return Vec2fErpUtils.integrateLinear(this, v2, alpha, res);
	}
	 ...
	 * @return The extraction parameter with the result.
	 */
	default float[] integrateLinearR(@MinLength(2) float[] v2, float alpha, @ExtractionParam @MinLength(2) float[] res)
	{
		return Vec2fErpUtils.integrateLinear(this, v2, alpha, res);
	}
	 ...
	 * @return The extraction parameter with the result.
	 */
	default float[] integrateLinearR(float v2x, float v2y, float alpha, @ExtractionParam @MinLength(2) float[] res)
	{
		return Vec2fErpUtils.integrateLinear(this, v2x, v2y, alpha, res);
	}
}
