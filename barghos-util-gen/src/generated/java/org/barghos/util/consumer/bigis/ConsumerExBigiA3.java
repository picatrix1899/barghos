...
/**
 * Represents an operation that accepts one 3-dimensional BigInteger array input
 * arguments and returns no result. Unlike {@link ConsumerBigiA3} this may throw
 * exceptions. {@link ConsumerExBigiA3} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerExBigiA3 extends ConsumerEx<BigInteger[][][]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerExBigiA3} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerExBigiA3} performing the given operations in
	 * sequence.
	 * 
