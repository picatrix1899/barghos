...
public interface Consumer4CA3 extends Consumer4<char[][][],char[][][],char[][][],char[][][]>
{
	 ...
	 * operation after.
	 */
	default Consumer4CA3 then(Consumer4CA3 after)
	{
	 ...
	 */
	@Override
	default Consumer4CA3 then(Consumer4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default Consumer4CA3 before(Consumer4CA3 before)
	{
	 ...
	 */
	@Override
	default Consumer4CA3 before(Consumer4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	@SafeVarargs
	static Consumer4CA3 of(Consumer4CA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4CA3 consumer : consumers) consumer.acceptC(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static Consumer4CA3 of(Consumer4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
