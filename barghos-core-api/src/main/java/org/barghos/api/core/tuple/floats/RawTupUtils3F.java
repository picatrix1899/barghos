...
public class RawTupUtils3F
{
	...
	public static boolean equalsEM(float tolerance, @AllowNull float[] t1, float t2V0, float t2V1, float t2V2)
	{
		if (t1 == null) return false;
	...
	public static boolean equalsEM(float tolerance, float t1V0, float t1V1, float t1V2, @AllowNull float[] t2)
	{
		if (t2 == null) return false;
	...
	public static boolean equalsEM(float tolerance, float t1V0, float t1V1, float t1V2, float t2V0, float t2V1, float t2V2)
	{
	...
	public static boolean equalsAtEM(float tolerance, int index, @AllowNull float[] t1, float t2V0, float t2V1, float t2V2)
	{
		if (t1 == null) return false;
	...
	public static boolean equalsAtEM(float tolerance, int index, float t1V0, float t1V1, float t1V2, @AllowNull float[] t2)
	{
		if (t2 == null) return false;
	...
	public static boolean equalsAtEM(float tolerance, int index, float t1V0, float t1V1, float t1V2, float value)
	{
		return switch (index) {
	...
	public static boolean equalsAtEM(float tolerance, int index, float t1V0, float t1V1, float t1V2, float t2V0, float t2V1, float t2V2)
	{
		return switch (index) {
	...
	{
		return Float.isInfinite(t[0]) && Float.isInfinite(t[1]) && Float.isInfinite(t[2]);
	}

	public static boolean isInfinite(float tV0, float tV1, float tV2)
	{
		return Float.isInfinite(tV0) && Float.isInfinite(tV1) && Float.isInfinite(tV2);
	}
	...
	public static boolean isInfiniteAt(int index, float tV0, float tV1, float tV2)
	{
		return switch (index) {
	...
	{
		return Float.isNaN(t[0]) && Float.isNaN(t[1]) && Float.isNaN(t[2]);
	}

	public static boolean isNaN(float tV0, float tV1, float tV2)
	{
		return Float.isNaN(tV0) && Float.isNaN(tV1) && Float.isNaN(tV2);
	}
	...
	public static boolean isNaNAt(int index, float tV0, float tV1, float tV2)
	{
		return switch (index) {
	...
	{
		return MathUtils.isZeroEM(tolerance, t[0]) && MathUtils.isZeroEM(tolerance, t[1]) && MathUtils.isZeroEM(tolerance, t[2]);
	}

	public static boolean isZeroEM(float tolerance, float tV0, float tV1, float tV2)
	{
		return MathUtils.isZeroEM(tolerance, tV0) && MathUtils.isZeroEM(tolerance, tV1) && MathUtils.isZeroEM(tolerance, tV2);
	}
	...
	public static boolean isZeroAtEM(float tolerance, int index, float tV0, float tV1, float tV2)
	{
		return switch (index) {
