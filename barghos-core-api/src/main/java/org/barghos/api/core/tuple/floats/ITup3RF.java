...
public interface ITup3RF extends ITupRF
{
	...
	boolean equalsEM(float tolerance, @AllowNull ITup3RF t);
	...
	boolean equalsEM(float tolerance, float v0, float v1, float v2);
	...
	boolean equalsAtEM(float tolerance, int index, @AllowNull ITup3RF t);
	...
	boolean equalsAtV0EM(float tolerance, @AllowNull ITup3RF t);
	...
	boolean equalsAtV1EM(float tolerance, @AllowNull ITup3RF t);
	...
	boolean equalsAtV2EM(float tolerance, @AllowNull ITup3RF t);
