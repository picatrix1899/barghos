 ...
 * Extraction parameters are used to shift the responsibility for creating and maintaining the
 * instance of a return object to the function caller. The type of a extraction parameter
