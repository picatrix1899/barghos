...
public class Stopwatch
{
	...
	public Stopwatch setTimeSupplier(LongSupplier timeSupplier, @Nullable Resolution timeResolution)
	{
	...
	public static interface Format
	{
		...
		public static final Format SEC_MILLI_MICRO = (sec, milli, micro, nano) -> sec + "s/" + milli + "ms/" + micro + "탎";
		public static final Format SEC_MILLI_MICRO_NANO = (sec, milli, micro, nano) -> sec + "s/" + milli + "ms/" + micro + "탎/" + nano + "ns";
		
		public static final Format MILLI = (sec, milli, micro, nano) -> milli + "ms";
		public static final Format MILLI_MICRO = (sec, milli, micro, nano) -> milli + "ms/" + micro + "탎";
		public static final Format MILLI_MICRO_NANO = (sec, milli, micro, nano) -> milli + "ms/" + micro + "탎/" + nano + "ns";
		
		public static final Format MICRO = (sec, milli, micro, nano) -> micro + "탎";
		public static final Format MICRO_NANO = (sec, milli, micro, nano) -> micro + "탎/" + nano + "ns";
