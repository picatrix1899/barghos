 ...
 * @author picatrix1899
 */
public interface TupbigdC extends TupbigdR, ExtendedCloneable
{
	/**
	 ...
	 */
	TupbigdC setByIndex(int index, BigDecimal value);
