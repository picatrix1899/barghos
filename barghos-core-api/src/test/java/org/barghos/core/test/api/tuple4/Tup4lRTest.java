...
class Tup4lRTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup4lR#isExactlyZero()} returns true,
	...
	/**
	 * This test ensures, that the function {@link Tup4lR#isExactlyZero()} returns false,
	...
	/**
	 * This test ensures, that the function {@link Tup4lR#isZero(long)} returns true,
	...
	/**
	 * This test ensures, that the function {@link Tup4lR#isZero(long)} returns false,
	...
	/**
	 * This test ensures, that the function {@link Tup4lR#toArray(long[])} returns
	...
	/**
	 * This test ensures, that the function {@link Tup4lR#toBuffer(LongBuffer)}
