...
class TupboCTest
{
	...
	/**
	 * This test ensures, that the function {@link TupboC#set(TupboR)} adopts the
	...
	/**
	 * This test ensures, that the function {@link TupboC#set(boolean)} adopts the
	...
	/**
	 * This test ensures, that the function {@link TupboC#setArray(boolean[])} relays
	 * all array entries to the corresponding component by calling {@link TupboC#setByIndex(int, boolean)}
	...
	/**
	 * This test ensures, that the function {@link TupboC#shallowClone()} calls
	 * by default the standard {@link TupboC#clone()}-function.
	 */
	@Test
	void shallowCloneTest()
	{
		TupboC t = mock(TupboC.class);
		TupboC res = mock(TupboC.class);
	...
	/**
	 * This test ensures, that the function {@link TupboC#deepClone()} calls
	 * by default the standard {@link TupboC#clone()}-function.
	 */
	@Test
	void deepCloneTest()
