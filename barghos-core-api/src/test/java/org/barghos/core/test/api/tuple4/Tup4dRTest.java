...
class Tup4dRTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup4dR#isExactlyZero()} returns true,
	...
	/**
	 * This test ensures, that the function {@link Tup4dR#isExactlyZero()} returns false,
	...
	/**
	 * This test ensures, that the function {@link Tup4dR#isZero(double)} returns true,
	...
	/**
	 * This test ensures, that the function {@link Tup4dR#isZero(double)} returns false,
	...
	/**
	 * This test ensures, that the function {@link Tup4dR#toArray(double[])} returns
