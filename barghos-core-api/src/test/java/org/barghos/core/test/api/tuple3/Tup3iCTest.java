...
class Tup3iCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#set(Tup3iR)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#set(int, int, int)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#setArray(int[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#setByIndex(int, int)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#setByIndex(int, int)} throws
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#shallowClone()} calls
	 * by default the standard {@link Tup3iC#clone()}-function.
	 */
	@Test
	void shallowCloneTest()
	{
		Tup3iC t = mock(Tup3iC.class);
		Tup3iC res = mock(Tup3iC.class);
	...
	/**
	 * This test ensures, that the function {@link Tup3iC#deepClone()} calls
	 * by default the standard {@link Tup3iC#clone()}-function.
	 */
	@Test
	void deepCloneTest()
