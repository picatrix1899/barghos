...
class Tup3fCTest
{
	...
	/**
	 * This test ensures, that the function {@link Tup3fC#set(Tup3fR)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3fC#set(float, float, float)} adopts
	...
	/**
	 * This test ensures, that the function {@link Tup3fC#setArray(float[])} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3fC#setByIndex(int, float)} adopts the
	...
	/**
	 * This test ensures, that the function {@link Tup3fC#setByIndex(int, float)} throws
