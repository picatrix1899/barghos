...
public interface ConsumerEx3OA3 extends ConsumerEx3<Object[][][],Object[][][],Object[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx3OA3 then(ConsumerEx3OA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx3OA3 then(ConsumerEx3<? super Object[][][],? super Object[][][],? super Object[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx3OA3 before(ConsumerEx3OA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx3OA3 before(ConsumerEx3<? super Object[][][],? super Object[][][],? super Object[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer3OA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx3OA3 onEx(ConsumerEx3OA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx3OA3 onEx(ConsumerEx3<? super Object[][][],? super Object[][][],? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer3OA3 onEx(Consumer3OA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer3OA3 onEx(Consumer3<? super Object[][][],? super Object[][][],? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3OA3 of(ConsumerEx3OA3... consumers)
	{
		...
		return (a, b, c) -> { for(ConsumerEx3OA3 consumer : consumers) consumer.acceptO(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3OA3 of(ConsumerEx3<? super Object[][][],? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3OA3 of(Consumer3OA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c) -> { for(Consumer3OA3 consumer : consumers) consumer.accept(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3OA3 of(Consumer3<? super Object[][][],? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
