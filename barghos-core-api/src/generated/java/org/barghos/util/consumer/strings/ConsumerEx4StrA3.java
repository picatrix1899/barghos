...
public interface ConsumerEx4StrA3 extends ConsumerEx4<String[][][],String[][][],String[][][],String[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4StrA3 then(ConsumerEx4StrA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4StrA3 then(ConsumerEx4<? super String[][][],? super String[][][],? super String[][][],? super String[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4StrA3 before(ConsumerEx4StrA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4StrA3 before(ConsumerEx4<? super String[][][],? super String[][][],? super String[][][],? super String[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4StrA3 handleEx(ExceptionHandler handler)
	{
	...
	@Override
	default Consumer4StrA3 ignoreEx()
	{
		return (a, b, c, d) -> {
			try
			{
	...
	default ConsumerEx4StrA3 onEx(ConsumerEx4StrA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4StrA3 onEx(ConsumerEx4<? super String[][][],? super String[][][],? super String[][][],? super String[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4StrA3 onEx(Consumer4StrA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4StrA3 onEx(Consumer4<? super String[][][],? super String[][][],? super String[][][],? super String[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4StrA3 of(ConsumerEx4StrA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4StrA3 consumer : consumers) consumer.acceptStr(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4StrA3 of(ConsumerEx4<? super String[][][],? super String[][][],? super String[][][],? super String[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4StrA3 of(Consumer4StrA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4StrA3 consumer : consumers) consumer.accept(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4StrA3 of(Consumer4<? super String[][][],? super String[][][],? super String[][][],? super String[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
