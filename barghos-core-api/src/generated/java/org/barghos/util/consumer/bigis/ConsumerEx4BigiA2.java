...
/**
 * Represents an operation that accepts four 2-dimensional BigInteger array input
 * arguments and returns no result. Unlike {@link Consumer4BigiA2} this may throw
 * exceptions. {@link ConsumerEx4BigiA2} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx4BigiA2 extends ConsumerEx4<BigInteger[][],BigInteger[][],BigInteger[][],BigInteger[][]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx4BigiA2} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx4BigiA2} performing the given operations in
	 * sequence.
	 * 
