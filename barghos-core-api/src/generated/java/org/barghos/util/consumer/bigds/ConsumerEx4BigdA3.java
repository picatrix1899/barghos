 ...
 * arguments and returns no result. Unlike {@link Consumer4BigdA3} this may throw
 * exceptions. {@link ConsumerEx4BigdA3} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx4BigdA3 extends ConsumerEx4<BigDecimal[][][],BigDecimal[][][],BigDecimal[][][],BigDecimal[][][]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx4BigdA3} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx4BigdA3} performing the given operations in
	 * sequence.
	 * 
