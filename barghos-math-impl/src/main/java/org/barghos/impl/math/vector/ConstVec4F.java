...
public class ConstVec4F implements IVec4RF
{
	...
	public ConstVec4F(ConstVec4F v)
	{
		this.x = v.x;
		this.y = v.y;
		this.z = v.z;
	...
	public ConstVec4F(float x, float y, float z, float w)
	{
		this.x = x;
		this.y = y;
		this.z = z;
	...
	{
		return "constvec3f(x=" + this.x + ", y=" + this.y + ", z=" + this.z + ", w=" + this.w + ")";
	}
