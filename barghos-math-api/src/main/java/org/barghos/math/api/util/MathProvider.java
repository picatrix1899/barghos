...
public interface MathProvider extends MathConstants
{
	/**
	...
	// MISSING_DOC
	boolean isZeroWithMargin(float value, float tolerance);
	
	// MISSING_DOC
	boolean isZeroWithMargin(double value, double tolerance);
