...
public class Mat4VecOpsI3F
{
	private Mat4VecOpsI3F() { }
	...
	public static float[] transform(IVec3RF v1, IMat4RF m1, @ExtractionParam float[] res)
	{
		...
		res[0] = Math.fma(m1.m00(), v1X, Math.fma(m1.m10(), v1Y, m1.m20() * v1Z));
		res[1] = Math.fma(m1.m01(), v1X, Math.fma(m1.m11(), v1Y, m1.m21() * v1Z));
		res[2] = Math.fma(m1.m02(), v1X, Math.fma(m1.m12(), v1Y, m1.m22() * v1Z));
	...
	public static float[] transform(IVec3RF v1, float[] m1, @ExtractionParam float[] res)
	{
		...
		res[0] = Math.fma(m1[0], v1X, Math.fma(m1[4], v1Y, m1[8] * v1Z));
		res[1] = Math.fma(m1[1], v1X, Math.fma(m1[5], v1Y, m1[9] * v1Z));
		res[2] = Math.fma(m1[2], v1X, Math.fma(m1[6], v1Y, m1[10] * v1Z));
	...
	public static <T extends IVec3WF> T transform(IVec3RF v1, IMat4RF m1, @ExtractionParam T res)
	{
		...
		res.set(
			Math.fma(m1.m00(), v1X, Math.fma(m1.m10(), v1Y, m1.m20() * v1Z)),
			Math.fma(m1.m01(), v1X, Math.fma(m1.m11(), v1Y, m1.m21() * v1Z)),
			Math.fma(m1.m02(), v1X, Math.fma(m1.m12(), v1Y, m1.m22() * v1Z))
		);
	...
	public static <T extends IVec3WF> T transform(IVec3RF v1, float[] m1, @ExtractionParam T res)
	{
		...
		res.set(
			Math.fma(m1[0], v1X, Math.fma(m1[4], v1Y, m1[8] * v1Z)),
			Math.fma(m1[1], v1X, Math.fma(m1[5], v1Y, m1[9] * v1Z)),
			Math.fma(m1[2], v1X, Math.fma(m1[6], v1Y, m1[10] * v1Z))
		);
