...
//
//public interface LineSegment3fR
//{
//	LineSegment3fR createNew();
//	
//	default LineSegment3fR createNew(LineSegment3fR line)
//	{
//		return createNew(line.p0x(), line.p0y(), line.p0z(), line.p1x(), line.p1y(), line.p1z());
//	}
//	
//	default LineSegment3fR createNew(Tup3fR p0, Tup3fR p1)
//	{
//		return createNew(p0.v0(), p0.v1(), p0.v2(), p1.v0(), p1.v1(), p1.v2());
//	}
//	
//	default LineSegment3fR createNew(Tup3fR p0, @MinLength(3) float[] p1)
//	{
//		return createNew(p0.v0(), p0.v1(), p0.v2(), p1[0], p1[1], p1[2]);
//	}
//	
//	default LineSegment3fR createNew(Tup3fR p0, float p1x, float p1y, float p1z)
//	{
//		return createNew(p0.v0(), p0.v1(), p0.v2(), p1x, p1y, p1z);
//	}
//	
//	default LineSegment3fR createNew(@MinLength(3) float[] p0, Tup3fR p1)
//	{
//		return createNew(p0[0], p0[1], p0[2], p1.v0(), p1.v1(), p1.v2());
//	}
//	
//	default LineSegment3fR createNew(@MinLength(3) float[] p0, @MinLength(3) float[] p1)
//	{
//		return createNew(p0[0], p0[1], p0[2], p1[0], p1[1], p1[2]);
//	}
//	
//	default LineSegment3fR createNew(@MinLength(3) float[] p0, float p1x, float p1y, float p1z)
//	{
//		return createNew(p0[0], p0[1], p0[2], p1x, p1y, p1z);
//	}
//	
//	default LineSegment3fR createNew(float p0x, float p0y, float p0z, Tup3fR p1)
//	{
//		return createNew(p0x, p0y, p0z, p1.v0(), p1.v1(), p1.v2());
//	}
//	
//	default LineSegment3fR createNew(float p0x, float p0y, float p0z, @MinLength(3) float[] p1)
//	{
//		return createNew(p0x, p0y, p0z, p1[0], p1[1], p1[2]);
//	}
//	
//	LineSegment3fR createNew(float p0x, float p0y, float p0z, float p1x, float p1y, float p1z);
//	
//	/**
