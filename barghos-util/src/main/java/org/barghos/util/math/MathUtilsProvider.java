...
public class MathUtilsProvider implements IMathUtilsProvider
{
	public long ceilDiv(long v0, long v1)
	{
		return Math.ceilDiv(v0, v1);
	}

	public int ceilDiv(int v0, int v1)
	{
		return Math.ceilDiv(v0, v1);
	}

	public long floorDiv(long v0, long v1)
	{
		return Math.floorDiv(v0, v1);
	}

	public int floorDiv(int v0, int v1)
	{
		return Math.floorDiv(v0, v1);
	}
	...
	public static class CompareProvider implements IMathUtilsProvider.ICompareProvider
	{
		@Override
	...
	public static class LerpProvider implements IMathUtilsProvider.ILerpProvider
	{
		@Override
	...
	public static class RoundProvider implements IMathUtilsProvider.IRoundProvider
	{
		@Override
		...
		@Override
		public double round(double value, IRoundMethodD method)
		{
			return method.roundD(value);
		}

		@Override
		public double roundF2D(float value, IRoundMethodF method)
		{
			return method.roundF(value);
		}

		@Override
		public float round(float value, IRoundMethodF method)
		{
			return method.roundF(value);
		}

		@Override
		public long roundD2L(double value, IRoundMethodD method)
		{
			return (long)method.roundD(value);
		}

		@Override
		public long roundF2L(float value, IRoundMethodF method)
		{
			return (long)method.roundF(value);
		}

		@Override
		public int roundF2I(float value, IRoundMethodF method)
		{
