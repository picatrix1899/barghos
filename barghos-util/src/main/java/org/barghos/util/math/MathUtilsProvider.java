...
public interface MathUtilsProvider
{
	...
	public interface RoundProvider
	{
		...
		double round(double value, RoundMethodD method);

		double roundF2D(float value, RoundMethodF method);
		
		float round(float value, RoundMethodF method);

		long roundD2L(double value, RoundMethodD method);
		
		long roundF2L(float value, RoundMethodF method);
		
		int roundF2I(float value, RoundMethodF method);
