...
import org.barghostest.util.collection.core.consumer.BoolMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a boolean collection that can work with the primitive values instead of
 * boxed ones. For more details see {@link Iterator}.
 */
public interface BoolIterator
{
	/**
     ...
     * or other mutator methods of {@link BoolIterator} subtypes),
     ...
     */
	default void forEachRemaining(BoolMonoConsumer action)
	{
