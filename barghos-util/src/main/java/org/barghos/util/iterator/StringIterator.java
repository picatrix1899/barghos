...
import org.barghostest.util.collection.core.consumer.StringMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a string collection that can work with the primitive values instead of
...
public interface StringIterator
{
	 ...
	 * 
	 * <p>
	 * Unlike {@link #next} this returns the primitive value instead of the boxed ones.
	 *
	 ...
	 * or other mutator methods of {@link StringIterator} subtypes),
	 ...
	 */
	default void forEachRemaining(StringMonoConsumer action)
	{
