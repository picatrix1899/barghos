...
import org.barghostest.util.collection.core.consumer.BigIntMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a {@link BigInteger} collection that can work with the primitive values instead of
 * boxed ones. For more details see {@link Iterator}.
 */
public interface BigIntIterator
{
	/**
	 ...
	 * or other mutator methods of {@link BigIntIterator} subtypes),
	 ...
	 */
	default void forEachRemaining(BigIntMonoConsumer action)
	{
