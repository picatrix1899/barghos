...
import org.barghostest.util.collection.core.consumer.ObjectMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over an object collection that can work with the primitive values instead of
...
public interface ObjectIterator
{
     ...
     * or other mutator methods of {@link ObjectIterator} subtypes),
     ...
     */
	default void forEachRemaining(ObjectMonoConsumer action)
	{
