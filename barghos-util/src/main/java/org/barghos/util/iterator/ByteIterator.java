...
import org.barghostest.util.collection.core.consumer.ByteMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a byte collection that can work with the primitive values instead of
...
public interface ByteIterator extends Iterator<Byte>
{
     ...
     * or other mutator methods of {@link ByteIterator} subtypes),
     ...
     */
	default void forEachRemaining(ByteMonoConsumer action)
	{
