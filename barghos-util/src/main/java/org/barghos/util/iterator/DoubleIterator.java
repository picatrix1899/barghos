...
import org.barghostest.util.collection.core.consumer.DoubleMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a double collection that can work with the primitive values instead of
...
public interface DoubleIterator
{
	 ...
	 * or other mutator methods of {@link DoubleIterator} subtypes),
	 ...
	 */
	default void forEachRemaining(DoubleMonoConsumer action)
	{
