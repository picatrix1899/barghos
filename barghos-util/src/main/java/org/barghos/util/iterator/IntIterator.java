...
import org.barghostest.util.collection.core.consumer.IntMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over an integer collection that can work with the primitive values instead of
...
public interface IntIterator
{
	 ...
	 * or other mutator methods of {@link IntIterator} subtypes),
	 ...
	 */
	default void forEachRemaining(IntMonoConsumer action)
	{
