...
import org.barghostest.util.collection.core.consumer.LongMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a long collection that can work with the primitive values instead of
...
public interface LongIterator
{
     ...
     * or other mutator methods of {@link LongIterator} subtypes),
     ...
     */
	default void forEachRemaining(LongMonoConsumer action)
	{
