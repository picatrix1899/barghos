...
import org.barghostest.util.collection.core.consumer.ShortMonoConsumer;
import org.barghostest.util.collection.core.util.Validation;

/**
 * An iterator over a short collection that can work with the primitive values instead of
...
public interface ShortIterator
{
	 ...
	 * or other mutator methods of {@link ShortIterator} subtypes),
	 ...
	 */
	default void forEachRemaining(ShortMonoConsumer action)
	{
