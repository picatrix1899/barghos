package org.barghos.util.optional;
 ...
 * @since 1.8
 */
public final class Optionalf
{
	/**
     * Common instance for {@code empty()}.
     */
    public static final Optionalf EMPTY = new Optionalf();
     ...
     */
    public static Optionalf of(float value)
    {
        return new Optionalf(value);
    }
    ...
    public float get()
    {
        if (!this.hasValue) throw new NoSuchElementException("No value present");
     ...
     */
    public Optionalf filter(Predicate<? super Float> predicate)
    {
    ...
    {  
        ...
        if(obj instanceof Optionalf)
        {
        	Optionalf other = ((Optionalf) obj);
        	
        	if(this.hasValue != other.hasValue) return false;
        	
        	return this.hasValue && this.value == other.value;
        }
     ...
     *         otherwise {@code false}
     */
    public boolean equals(Optionalf other)
    {  
    	if(this.hasValue != other.hasValue) return false;
    ...
    {
        return this.hasValue ? "Optionalf[" + value + "]" : "Optional.empty";
    }
}
