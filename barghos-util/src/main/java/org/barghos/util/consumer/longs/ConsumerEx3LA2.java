...
public interface ConsumerEx3LA2 extends ConsumerEx3<long[][],long[][],long[][]>
{
     ...
     * operation after.
     */
    default ConsumerEx3LA2 thenLong(ConsumerEx3LA2 after)
    {
	...
	default ConsumerEx3LA2 thenLong(ConsumerEx3LA2... after)
    {
    	...
    	return (a, b, c) -> {acceptLongArray(a, b, c); for(ConsumerEx3LA2 consumer : after) consumer.acceptLongArray(a, b, c);};
    }
     ...
     * this operation.
     */
    default ConsumerEx3LA2 beforeLong(ConsumerEx3LA2 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3LA2} performing the operations before and
     * this operation.
     */
    default ConsumerEx3LA2 beforeLong(ConsumerEx3LA2... before)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3LA2 consumer : before) consumer.acceptLongArray(a, b, c); acceptLongArray(a, b, c);};
    }
     ...
     */
	static ConsumerEx3LA2 sequenceLong(ConsumerEx3LA2... consumers)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3LA2 consumer : consumers) consumer.acceptLongArray(a, b, c);};
    }
    ...
    default ConsumerEx3LA2 then(ConsumerEx3<long[][],long[][],long[][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx3LA2)
    	{
    		final ConsumerEx3LA2 originalAfter = (ConsumerEx3LA2)after;
	...
	default ConsumerEx3LA2 then(ConsumerEx3<long[][],long[][],long[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx3LA2)
        	{
        		final ConsumerEx3LA2 originalAfter = (ConsumerEx3LA2)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx3LA2)
    				((ConsumerEx3LA2)consumer).acceptLongArray(a, b, c);
    			else
    ...
    default ConsumerEx3LA2 before(ConsumerEx3<long[][],long[][],long[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx3LA2)
    	{
    		final ConsumerEx3LA2 originalBefore = (ConsumerEx3LA2)before;
    ...
    default ConsumerEx3LA2 before(ConsumerEx3<long[][],long[][],long[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx3LA2)
        	{
        		final ConsumerEx3LA2 originalBefore = (ConsumerEx3LA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3LA2 sequence(ConsumerEx3<long[][],long[][],long[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx3LA2)
    			return (ConsumerEx3LA2) consumers[0];
    		else
    			return (ConsumerEx3LA2) consumers[0]::accept;
    	}
