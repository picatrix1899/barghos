 ...
 * array input arguments and returns no result. {@link Consumer3BigdA2} is
...
public interface Consumer3BigdA2 extends Consumer3<BigDecimal[][],BigDecimal[][],BigDecimal[][]>
{
	 ...
	 */
	void accept3BigdA2(BigDecimal[][] a, BigDecimal[][] b, BigDecimal[][] c);
	 ...
	 * operation after.
	 */
	default Consumer3BigdA2 then3BigdA2(Consumer3BigdA2 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer3BigdA2 before3BigdA2(Consumer3BigdA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer3BigdA2 of3BigdA2(Consumer3BigdA2... consumers)
	{
		...
		return (a, b, c) -> { for(Consumer3BigdA2 consumer : consumers) consumer.accept3BigdA2(a, b, c); };
	}
	 ...
	 */
	@Override
	default Consumer3BigdA2 then(Consumer3<BigDecimal[][],BigDecimal[][],BigDecimal[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default Consumer3BigdA2 before(Consumer3<BigDecimal[][],BigDecimal[][],BigDecimal[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer3BigdA2 of(Consumer3<BigDecimal[][],BigDecimal[][],BigDecimal[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
