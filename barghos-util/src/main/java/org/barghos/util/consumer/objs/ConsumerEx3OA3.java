...
public interface ConsumerEx3OA3 extends ConsumerEx3<Object[][][],Object[][][],Object[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx3OA3 thenObject(ConsumerEx3OA3 after)
    {
	...
	default ConsumerEx3OA3 thenObject(ConsumerEx3OA3... after)
    {
    	...
    	return (a, b, c) -> {acceptObjectArray(a, b, c); for(ConsumerEx3OA3 consumer : after) consumer.acceptObjectArray(a, b, c);};
    }
     ...
     * this operation.
     */
    default ConsumerEx3OA3 beforeObject(ConsumerEx3OA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3OA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx3OA3 beforeObject(ConsumerEx3OA3... before)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3OA3 consumer : before) consumer.acceptObjectArray(a, b, c); acceptObjectArray(a, b, c);};
    }
     ...
     */
	static ConsumerEx3OA3 sequenceObject(ConsumerEx3OA3... consumers)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3OA3 consumer : consumers) consumer.acceptObjectArray(a, b, c);};
    }
    ...
    default ConsumerEx3OA3 then(ConsumerEx3<Object[][][],Object[][][],Object[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx3OA3)
    	{
    		final ConsumerEx3OA3 originalAfter = (ConsumerEx3OA3)after;
	...
	default ConsumerEx3OA3 then(ConsumerEx3<Object[][][],Object[][][],Object[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx3OA3)
        	{
        		final ConsumerEx3OA3 originalAfter = (ConsumerEx3OA3)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx3OA3)
    				((ConsumerEx3OA3)consumer).acceptObjectArray(a, b, c);
    			else
    ...
    default ConsumerEx3OA3 before(ConsumerEx3<Object[][][],Object[][][],Object[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx3OA3)
    	{
    		final ConsumerEx3OA3 originalBefore = (ConsumerEx3OA3)before;
    ...
    default ConsumerEx3OA3 before(ConsumerEx3<Object[][][],Object[][][],Object[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx3OA3)
        	{
        		final ConsumerEx3OA3 originalBefore = (ConsumerEx3OA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3OA3 sequence(ConsumerEx3<Object[][][],Object[][][],Object[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx3OA3)
    			return (ConsumerEx3OA3) consumers[0];
    		else
    			return (ConsumerEx3OA3) consumers[0]::accept;
    	}
