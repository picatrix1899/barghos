...
public interface ConsumerEx4Bo extends ConsumerEx4<Boolean,Boolean,Boolean,Boolean>
{
	 ...
	 */
	void accept4Bo(boolean a, boolean b, boolean c, boolean d) throws Exception;
	 ...
	 * operation after.
	 */
	default ConsumerEx4Bo then4Bo(ConsumerEx4Bo after)
	{
	 ...
	 * this operation.
	 */
	default ConsumerEx4Bo before4Bo(ConsumerEx4Bo before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4Bo of4Bo(ConsumerEx4Bo... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4Bo consumer : consumers) consumer.accept4Bo(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4Bo of(ConsumerEx4<Boolean,Boolean,Boolean,Boolean>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
