...
public interface ConsumerEx4LA2 extends ConsumerEx4<long[][],long[][],long[][],long[][]>
{
     ...
     */
    void acceptLongArray(long[][] a, long[][] b, long[][] c, long[][] d) throws Exception;
     ...
     * operation after.
     */
    default ConsumerEx4LA2 thenLong(ConsumerEx4LA2 after)
    {
	...
	default ConsumerEx4LA2 thenLong(ConsumerEx4LA2... after)
    {
    	...
    	return (a, b, c, d) -> {acceptLongArray(a, b, c, d); for(ConsumerEx4LA2 consumer : after) consumer.acceptLongArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4LA2 beforeLong(ConsumerEx4LA2 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4LA2} performing the operations before and
     * this operation.
     */
    default ConsumerEx4LA2 beforeLong(ConsumerEx4LA2... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4LA2 consumer : before) consumer.acceptLongArray(a, b, c, d); acceptLongArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4LA2 sequenceLong(ConsumerEx4LA2... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4LA2 consumer : consumers) consumer.acceptLongArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4LA2 then(ConsumerEx4<long[][],long[][],long[][],long[][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4LA2)
    	{
    		final ConsumerEx4LA2 originalAfter = (ConsumerEx4LA2)after;
	...
	default ConsumerEx4LA2 then(ConsumerEx4<long[][],long[][],long[][],long[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4LA2)
        	{
        		final ConsumerEx4LA2 originalAfter = (ConsumerEx4LA2)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4LA2)
    				((ConsumerEx4LA2)consumer).acceptLongArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4LA2 before(ConsumerEx4<long[][],long[][],long[][],long[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4LA2)
    	{
    		final ConsumerEx4LA2 originalBefore = (ConsumerEx4LA2)before;
    ...
    default ConsumerEx4LA2 before(ConsumerEx4<long[][],long[][],long[][],long[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4LA2)
        	{
        		final ConsumerEx4LA2 originalBefore = (ConsumerEx4LA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4LA2 sequence(ConsumerEx4<long[][],long[][],long[][],long[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4LA2)
    			return (ConsumerEx4LA2) consumers[0];
    		else
    			return (ConsumerEx4LA2) consumers[0]::accept;
    	}
