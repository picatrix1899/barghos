...
public interface Consumer3LA extends Consumer3<long[],long[],long[]>
{
     ...
     * operation after.
     */
    default Consumer3LA thenLong(Consumer3LA after)
    {
	...
	default Consumer3LA thenLong(Consumer3LA... after)
    {
    	...
    	return (a, b, c) -> {acceptLongArray(a, b, c); for(Consumer3LA consumer : after) consumer.acceptLongArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link Consumer3LA} performing the operation before and this
     * operation.
     */
    default Consumer3LA beforeLong(Consumer3LA before)
    {
     ...
     * 
     * @return A new {@link Consumer3LA} performing the operations before and
     * this operation.
     */
    default Consumer3LA beforeLong(Consumer3LA... before)
    {
    	...
    	return (a, b, c) -> {for(Consumer3LA consumer : before) consumer.acceptLongArray(a, b, c); acceptLongArray(a, b, c);};
    }
     ...
     */
	static Consumer3LA sequenceLong(Consumer3LA... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3LA consumer : consumers) consumer.acceptLongArray(a, b, c);};
    }
    ...
    default Consumer3LA then(Consumer3<long[],long[],long[]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer3LA)
    	{
    		final Consumer3LA originalAfter = (Consumer3LA)after;
	...
	default Consumer3LA then(Consumer3<long[],long[],long[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3LA)
        	{
        		final Consumer3LA originalAfter = (Consumer3LA)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3LA)
    				((Consumer3LA)consumer).acceptLongArray(a, b, c);
    			else
    ...
    default Consumer3LA before(Consumer3<long[],long[],long[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3LA)
    	{
    		final Consumer3LA originalBefore = (Consumer3LA)before;
    ...
    default Consumer3LA before(Consumer3<long[],long[],long[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3LA)
        	{
        		final Consumer3LA originalBefore = (Consumer3LA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3LA sequence(Consumer3<long[],long[],long[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3LA)
    			return (Consumer3LA) consumers[0];
    		else
    			return (Consumer3LA) consumers[0]::accept;
    	}
