...
public interface Consumer3O extends Consumer3<Object,Object,Object>
{
	 ...
	 */
	void accept3O(Object a, Object b, Object c);
	 ...
	 * operation after.
	 */
	default Consumer3O then3O(Consumer3O after)
	{
	 ...
	 * operation.
	 */
	default Consumer3O before3O(Consumer3O before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer3O of3O(Consumer3O... consumers)
	{
		...
		return (a, b, c) -> { for(Consumer3O consumer : consumers) consumer.accept3O(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer3O of(Consumer3<Object,Object,Object>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
