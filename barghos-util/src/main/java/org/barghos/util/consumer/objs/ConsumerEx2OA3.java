...
public interface ConsumerEx2OA3 extends ConsumerEx2<Object[][][],Object[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx2OA3 thenObject(ConsumerEx2OA3 after)
    {
	...
	default ConsumerEx2OA3 thenObject(ConsumerEx2OA3... after)
    {
    	...
    	return (a, b) -> {acceptObjectArray(a, b); for(ConsumerEx2OA3 consumer : after) consumer.acceptObjectArray(a, b);};
    }
     ...
     * this operation.
     */
    default ConsumerEx2OA3 beforeObject(ConsumerEx2OA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx2OA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx2OA3 beforeObject(ConsumerEx2OA3... before)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2OA3 consumer : before) consumer.acceptObjectArray(a, b); acceptObjectArray(a, b);};
    }
     ...
     */
	static ConsumerEx2OA3 sequenceObject(ConsumerEx2OA3... consumers)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2OA3 consumer : consumers) consumer.acceptObjectArray(a, b);};
    }
    ...
    default ConsumerEx2OA3 then(ConsumerEx2<Object[][][],Object[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx2OA3)
    	{
    		final ConsumerEx2OA3 originalAfter = (ConsumerEx2OA3)after;
	...
	default ConsumerEx2OA3 then(ConsumerEx2<Object[][][],Object[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx2OA3)
        	{
        		final ConsumerEx2OA3 originalAfter = (ConsumerEx2OA3)after[0];
    	...
    	return (a, b) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx2OA3)
    				((ConsumerEx2OA3)consumer).acceptObjectArray(a, b);
    			else
    				consumer.accept(a, b);
    		}
    	};
    ...
    default ConsumerEx2OA3 before(ConsumerEx2<Object[][][],Object[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx2OA3)
    	{
    		final ConsumerEx2OA3 originalBefore = (ConsumerEx2OA3)before;
    ...
    default ConsumerEx2OA3 before(ConsumerEx2<Object[][][],Object[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx2OA3)
        	{
        		final ConsumerEx2OA3 originalBefore = (ConsumerEx2OA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx2OA3 sequence(ConsumerEx2<Object[][][],Object[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx2OA3)
    			return (ConsumerEx2OA3) consumers[0];
    		else
    			return (ConsumerEx2OA3) consumers[0]::accept;
    	}
