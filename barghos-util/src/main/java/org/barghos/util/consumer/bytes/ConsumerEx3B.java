 ...
 * no result. Unlike {@link Consumer3B} this may throw exceptions.
...
public interface ConsumerEx3B extends ConsumerEx3<Byte,Byte,Byte>
{
     ...
     * operation after.
     */
    default ConsumerEx3B thenByte(ConsumerEx3B after)
    {
     ...
     * this operation.
     */
    default ConsumerEx3B beforeByte(ConsumerEx3B before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3B} performing the operations before and
     * this operation.
     */
    default ConsumerEx3B beforeByte(ConsumerEx3B... before)
    {
     ...
     */
	static ConsumerEx3B sequenceByte(ConsumerEx3B... consumers)
    {
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3B sequence(ConsumerEx3<Byte,Byte,Byte>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
