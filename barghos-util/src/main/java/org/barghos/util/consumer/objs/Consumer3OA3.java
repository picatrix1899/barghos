...
public interface Consumer3OA3 extends Consumer3<Object[][][],Object[][][],Object[][][]>
{
     ...
     * operation after.
     */
    default Consumer3OA3 thenObject(Consumer3OA3 after)
    {
	...
	default Consumer3OA3 thenObject(Consumer3OA3... after)
    {
    	...
    	return (a, b, c) -> {acceptObjectArray(a, b, c); for(Consumer3OA3 consumer : after) consumer.acceptObjectArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link Consumer3OA3} performing the operation before and this
     * operation.
     */
    default Consumer3OA3 beforeObject(Consumer3OA3 before)
    {
     ...
     * 
     * @return A new {@link Consumer3OA3} performing the operations before and
     * this operation.
     */
    default Consumer3OA3 beforeObject(Consumer3OA3... before)
    {
    	...
    	return (a, b, c) -> {for(Consumer3OA3 consumer : before) consumer.acceptObjectArray(a, b, c); acceptObjectArray(a, b, c);};
    }
     ...
     */
	static Consumer3OA3 sequenceObject(Consumer3OA3... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3OA3 consumer : consumers) consumer.acceptObjectArray(a, b, c);};
    }
    ...
    default Consumer3OA3 then(Consumer3<Object[][][],Object[][][],Object[][][]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer3OA3)
    	{
    		final Consumer3OA3 originalAfter = (Consumer3OA3)after;
	...
	default Consumer3OA3 then(Consumer3<Object[][][],Object[][][],Object[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3OA3)
        	{
        		final Consumer3OA3 originalAfter = (Consumer3OA3)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3OA3)
    				((Consumer3OA3)consumer).acceptObjectArray(a, b, c);
    			else
    ...
    default Consumer3OA3 before(Consumer3<Object[][][],Object[][][],Object[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3OA3)
    	{
    		final Consumer3OA3 originalBefore = (Consumer3OA3)before;
    ...
    default Consumer3OA3 before(Consumer3<Object[][][],Object[][][],Object[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3OA3)
        	{
        		final Consumer3OA3 originalBefore = (Consumer3OA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3OA3 sequence(Consumer3<Object[][][],Object[][][],Object[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3OA3)
    			return (Consumer3OA3) consumers[0];
    		else
    			return (Consumer3OA3) consumers[0]::accept;
    	}
