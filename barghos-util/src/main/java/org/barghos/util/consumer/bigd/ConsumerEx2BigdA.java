...
public interface ConsumerEx2BigdA extends ConsumerEx2<BigDecimal[],BigDecimal[]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2BigdA then(Consumer2BigdA after)
	{
		Validate.Arg.checkNotNull("after", after);
	...
	@Override
	default ConsumerEx2BigdA then(Consumer2<? super BigDecimal[],? super BigDecimal[]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * and this operation.
	 */
	default ConsumerEx2BigdA before(Consumer2BigdA before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	@Override
	default ConsumerEx2BigdA before(Consumer2<? super BigDecimal[],? super BigDecimal[]> before)
	{
		Validate.Arg.checkNotNull("before", before);
