...
public interface ConsumerEx4IA2 extends ConsumerEx4<int[][],int[][],int[][],int[][]>
{
     ...
     * operation after.
     */
    default ConsumerEx4IA2 thenInt(ConsumerEx4IA2 after)
    {
	...
	default ConsumerEx4IA2 thenInt(ConsumerEx4IA2... after)
    {
    	...
    	return (a, b, c, d) -> {acceptIntArray(a, b, c, d); for(ConsumerEx4IA2 consumer : after) consumer.acceptIntArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4IA2 beforeInt(ConsumerEx4IA2 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4IA2} performing the operations before and
     * this operation.
     */
    default ConsumerEx4IA2 beforeInt(ConsumerEx4IA2... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4IA2 consumer : before) consumer.acceptIntArray(a, b, c, d); acceptIntArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4IA2 sequenceInt(ConsumerEx4IA2... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4IA2 consumer : consumers) consumer.acceptIntArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4IA2 then(ConsumerEx4<int[][],int[][],int[][],int[][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4IA2)
    	{
    		final ConsumerEx4IA2 originalAfter = (ConsumerEx4IA2)after;
	...
	default ConsumerEx4IA2 then(ConsumerEx4<int[][],int[][],int[][],int[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4IA2)
        	{
        		final ConsumerEx4IA2 originalAfter = (ConsumerEx4IA2)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4IA2)
    				((ConsumerEx4IA2)consumer).acceptIntArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4IA2 before(ConsumerEx4<int[][],int[][],int[][],int[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4IA2)
    	{
    		final ConsumerEx4IA2 originalBefore = (ConsumerEx4IA2)before;
    ...
    default ConsumerEx4IA2 before(ConsumerEx4<int[][],int[][],int[][],int[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4IA2)
        	{
        		final ConsumerEx4IA2 originalBefore = (ConsumerEx4IA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4IA2 sequence(ConsumerEx4<int[][],int[][],int[][],int[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4IA2)
    			return (ConsumerEx4IA2) consumers[0];
    		else
    			return (ConsumerEx4IA2) consumers[0]::accept;
    	}
