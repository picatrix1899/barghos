...
public interface ConsumerEx2StrA3 extends ConsumerEx2<String[][][],String[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx2StrA3 thenString(ConsumerEx2StrA3 after)
    {
	...
	default ConsumerEx2StrA3 thenString(ConsumerEx2StrA3... after)
    {
    	...
    	return (a, b) -> {acceptStringArray(a, b); for(ConsumerEx2StrA3 consumer : after) consumer.acceptStringArray(a, b);};
    }
     ...
     * this operation.
     */
    default ConsumerEx2StrA3 beforeString(ConsumerEx2StrA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx2StrA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx2StrA3 beforeString(ConsumerEx2StrA3... before)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2StrA3 consumer : before) consumer.acceptStringArray(a, b); acceptStringArray(a, b);};
    }
     ...
     */
	static ConsumerEx2StrA3 sequenceString(ConsumerEx2StrA3... consumers)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2StrA3 consumer : consumers) consumer.acceptStringArray(a, b);};
    }
    ...
    default ConsumerEx2StrA3 then(ConsumerEx2<String[][][],String[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx2StrA3)
    	{
    		final ConsumerEx2StrA3 originalAfter = (ConsumerEx2StrA3)after;
	...
	default ConsumerEx2StrA3 then(ConsumerEx2<String[][][],String[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx2StrA3)
        	{
        		final ConsumerEx2StrA3 originalAfter = (ConsumerEx2StrA3)after[0];
    	...
    	return (a, b) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx2StrA3)
    				((ConsumerEx2StrA3)consumer).acceptStringArray(a, b);
    			else
    				consumer.accept(a, b);
    		}
    	};
    ...
    default ConsumerEx2StrA3 before(ConsumerEx2<String[][][],String[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx2StrA3)
    	{
    		final ConsumerEx2StrA3 originalBefore = (ConsumerEx2StrA3)before;
    ...
    default ConsumerEx2StrA3 before(ConsumerEx2<String[][][],String[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx2StrA3)
        	{
        		final ConsumerEx2StrA3 originalBefore = (ConsumerEx2StrA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx2StrA3 sequence(ConsumerEx2<String[][][],String[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx2StrA3)
    			return (ConsumerEx2StrA3) consumers[0];
    		else
    			return (ConsumerEx2StrA3) consumers[0]::accept;
    	}
     ...
     * 
     * @return A new {@link Consumer2StrA3} performing the operations and
     * exception handling.
     */
    default Consumer2StrA3 handled(ExceptionHandler handler)
    {
     ...
     * again a {@link ConsumerEx2StrA3} relaying the exceptions of the passed
     * consumer.
     * 
     ...
     * @return A new {@link ConsumerEx2StrA3} performing the operations.
     */
    default ConsumerEx2StrA3 onException(ConsumerEx2StrA3 consumer)
    {
     ...
     * is a {@link Consumer2StrA3}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
     * @return A new {@link Consumer2StrA3} performing the operations.
     */
    default Consumer2StrA3 onException(Consumer2StrA3 consumer)
    {
    	Validation.validateNotNull("consumer", consumer);
