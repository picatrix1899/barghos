...
/**
 * Represents an operation that accepts two long input argument and returns no result.
 * Unlike {@link Consumer2l} this may throw Exceptions.
...
public interface ConsumerEx2l extends ConsumerEx2<Long,Long>
{
     ...
     * 
     * @return A new {@link ConsumerEx2l} performing this operation and the operation after.
     */
    default ConsumerEx2l andThenLong(ConsumerEx2l after)
    {
    	/*
     ...
     * 
     * @return A new {@link ConsumerEx2l} performing this operation and the operations after.
     */
	default ConsumerEx2l andThenLong(ConsumerEx2l... after)
    {
		/*
     ...
     * @return A new {@link ConsumerEx2l} performing this operation and the operations after.
     */
	default ConsumerEx2l andThenLong(Iterable<ConsumerEx2l> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx2l} performing the operation before and this operation.
     */
    default ConsumerEx2l beforeThatLong(ConsumerEx2l before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx2l} performing the operations before and this operation.
     */
    default ConsumerEx2l beforeThatLong(ConsumerEx2l... before)
    {
    	/*
     ...
     * @return A new {@link ConsumerEx2l} performing the operations before and this operation.
     */
    default ConsumerEx2l beforeThatLong(Iterable<ConsumerEx2l> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link ConsumerEx2l} performing the given operations in sequence.
     * 
     * @param consumers The operations to perform.
     * 
     * @return A new {@link ConsumerEx2l} performing the operations.
     */
	static ConsumerEx2l inSequenceLong(ConsumerEx2l... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null.
    	 * Also no entry must be null.
     ...
     * @return A new {@link ConsumerEx2l} performing the operations.
     */
    static ConsumerEx2l inSequenceLong(Iterable<ConsumerEx2l> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2l} performing this operation and the operation after.
     */
    default ConsumerEx2l andThen(ConsumerEx2<Long,Long> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2l} performing this operation and the operations after.
     */
	default ConsumerEx2l andThen(Iterable<ConsumerEx2<Long,Long>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2l} performing the operation before and this operation.
     */
    default ConsumerEx2l beforeThat(ConsumerEx2<Long,Long> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2l} performing the operations before and this operation.
     */
    default ConsumerEx2l beforeThat(Iterable<ConsumerEx2<Long,Long>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx2l inSequence(ConsumerEx2<Long,Long>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null.
    	 * Also no entry must be null.
     ...
     * @return A new {@link ConsumerEx2l} performing the operations.
     */
    static ConsumerEx2l inSequence(Iterable<ConsumerEx2<Long,Long>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
