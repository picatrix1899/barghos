...
public interface ConsumerEx4SA3 extends ConsumerEx4<short[][][],short[][][],short[][][],short[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx4SA3 thenShort(ConsumerEx4SA3 after)
    {
	...
	default ConsumerEx4SA3 thenShort(ConsumerEx4SA3... after)
    {
    	...
    	return (a, b, c, d) -> {acceptShortArray(a, b, c, d); for(ConsumerEx4SA3 consumer : after) consumer.acceptShortArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4SA3 beforeShort(ConsumerEx4SA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4SA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx4SA3 beforeShort(ConsumerEx4SA3... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4SA3 consumer : before) consumer.acceptShortArray(a, b, c, d); acceptShortArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4SA3 sequenceShort(ConsumerEx4SA3... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4SA3 consumer : consumers) consumer.acceptShortArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4SA3 then(ConsumerEx4<short[][][],short[][][],short[][][],short[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4SA3)
    	{
    		final ConsumerEx4SA3 originalAfter = (ConsumerEx4SA3)after;
	...
	default ConsumerEx4SA3 then(ConsumerEx4<short[][][],short[][][],short[][][],short[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4SA3)
        	{
        		final ConsumerEx4SA3 originalAfter = (ConsumerEx4SA3)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4SA3)
    				((ConsumerEx4SA3)consumer).acceptShortArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4SA3 before(ConsumerEx4<short[][][],short[][][],short[][][],short[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4SA3)
    	{
    		final ConsumerEx4SA3 originalBefore = (ConsumerEx4SA3)before;
    ...
    default ConsumerEx4SA3 before(ConsumerEx4<short[][][],short[][][],short[][][],short[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4SA3)
        	{
        		final ConsumerEx4SA3 originalBefore = (ConsumerEx4SA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4SA3 sequence(ConsumerEx4<short[][][],short[][][],short[][][],short[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4SA3)
    			return (ConsumerEx4SA3) consumers[0];
    		else
    			return (ConsumerEx4SA3) consumers[0]::accept;
    	}
