...
public interface Consumer3SA2 extends Consumer3<short[][],short[][],short[][]>
{
     ...
     * operation after.
     */
    default Consumer3SA2 thenShort(Consumer3SA2 after)
    {
	...
	default Consumer3SA2 thenShort(Consumer3SA2... after)
    {
    	...
    	return (a, b, c) -> {acceptShortArray(a, b, c); for(Consumer3SA2 consumer : after) consumer.acceptShortArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link Consumer3SA2} performing the operation before and this
     * operation.
     */
    default Consumer3SA2 beforeShort(Consumer3SA2 before)
    {
     ...
     * 
     * @return A new {@link Consumer3SA2} performing the operations before and this operation.
     */
    default Consumer3SA2 beforeShort(Consumer3SA2... before)
    {
    	Validation.validateNotNull("before", before);
    	...
    	return (a, b, c) -> {for(Consumer3SA2 consumer : before) consumer.acceptShortArray(a, b, c); acceptShortArray(a, b, c);};
    }
     ...
     */
	static Consumer3SA2 sequenceShort(Consumer3SA2... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3SA2 consumer : consumers) consumer.acceptShortArray(a, b, c);};
    }
    ...
    default Consumer3SA2 then(Consumer3<short[][],short[][],short[][]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer3SA2)
    	{
    		final Consumer3SA2 originalAfter = (Consumer3SA2)after;
	...
	default Consumer3SA2 then(Consumer3<short[][],short[][],short[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3SA2)
        	{
        		final Consumer3SA2 originalAfter = (Consumer3SA2)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3SA2)
    				((Consumer3SA2)consumer).acceptShortArray(a, b, c);
    			else
    ...
    default Consumer3SA2 before(Consumer3<short[][],short[][],short[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3SA2)
    	{
    		final Consumer3SA2 originalBefore = (Consumer3SA2)before;
     ...
     * @param before The operations to perform before this operation.
     * 
     * @return A new {@link Consumer3SA2} performing the operations before and
     * this operation.
     */
    @SuppressWarnings("unchecked")
    default Consumer3SA2 before(Consumer3<short[][],short[][],short[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3SA2)
        	{
        		final Consumer3SA2 originalBefore = (Consumer3SA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3SA2 sequence(Consumer3<short[][],short[][],short[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3SA2)
    			return (Consumer3SA2) consumers[0];
    		else
    			return (Consumer3SA2) consumers[0]::accept;
    	}
