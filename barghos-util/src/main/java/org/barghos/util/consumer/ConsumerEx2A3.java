 ...
 * and returns no result. Unlike {@link Consumer2A3} this may throw Exceptions.
...
public interface ConsumerEx2A3<A,B> extends ConsumerEx2<A[][][],B[][][]>
{
     ...
     * 
     * @return A new {@link ConsumerEx2A3} performing this operation and the
     * operation after.
     */
    default ConsumerEx2A3<A,B> thenArray(ConsumerEx2A3<A,B> after)
    {
     ...
     * operations after.
     */
	default ConsumerEx2A3<A,B> thenArray(java.util.List<ConsumerEx2A3<A,B>> after)
    {
		Validation.validateNotNull("after", after);
		Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default ConsumerEx2A3<A,B> thenArray(Iterable<ConsumerEx2A3<A,B>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * 
     * @return A new {@link ConsumerEx2A3} performing the operation before and
     * this operation.
     */
    default ConsumerEx2A3<A,B> beforeArray(ConsumerEx2A3<A,B> before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx2A3} performing the operations before and
     * this operation.
     */
    @SuppressWarnings("unchecked")
	default ConsumerEx2A3<A,B> beforeArray(ConsumerEx2A3<A,B>... before)
     ...
     * this operation.
     */
	default ConsumerEx2A3<A,B> beforeArray(java.util.List<ConsumerEx2A3<A,B>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * this operation.
     */
    default ConsumerEx2A3<A,B> beforeArray(Iterable<ConsumerEx2A3<A,B>> before)
    {
    	Validation.validateNotNull("before", before);
    ...
    /**
     * Composes a new {@link ConsumerEx2A3} performing the given operations in
     * sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B> ConsumerEx2A3<A,B> sequenceArray(ConsumerEx2A3<A,B>... consumers)
    {
     ...
     * @return A new {@link ConsumerEx2A3} performing the operations.
     */
	static <A,B> ConsumerEx2A3<A,B> sequenceArray(java.util.List<ConsumerEx2A3<A,B>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link ConsumerEx2A3} performing the operations.
     */
    static <A,B> ConsumerEx2A3<A,B> sequenceArray(Iterable<ConsumerEx2A3<A,B>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default ConsumerEx2A3<A,B> then(ConsumerEx2<A[][][],B[][][]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default ConsumerEx2A3<A,B> then(java.util.List<ConsumerEx2<A[][][],B[][][]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(first instanceof ConsumerEx2A3<A,B>)
        	{
        		final ConsumerEx2A3<A,B> originalAfter = (ConsumerEx2A3<A,B>)first;
     ...
     * operations after.
     */
	default ConsumerEx2A3<A,B> then(Iterable<ConsumerEx2<A[][][],B[][][]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * this operation.
     */
    default ConsumerEx2A3<A,B> before(ConsumerEx2<A[][][],B[][][]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default ConsumerEx2A3<A,B> before(java.util.List<ConsumerEx2<A[][][],B[][][]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof ConsumerEx2A3<A,B>)
        	{
        		final ConsumerEx2A3<A,B> originalBefore = (ConsumerEx2A3<A,B>)first;
     ...
     * this operation.
     */
    default ConsumerEx2A3<A,B> before(Iterable<ConsumerEx2<A[][][],B[][][]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B> ConsumerEx2A3<A,B> sequence(ConsumerEx2<A[][][],B[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link ConsumerEx2A3} performing the operations.
     */
	static <A,B> ConsumerEx2A3<A,B> sequence(java.util.List<ConsumerEx2<A[][][],B[][][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof ConsumerEx2A3<A,B>)
    			return (ConsumerEx2A3<A,B>) first;
    		else
    			return (ConsumerEx2A3<A,B>) first::accept;
    	}
     ...
     * @return A new {@link ConsumerEx2A3} performing the operations.
     */
    static <A,B> ConsumerEx2A3<A,B> sequence(Iterable<ConsumerEx2<A[][][],B[][][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * 
     * @return A new {@link Consumer2A3} performing the operations and exception
     * handling.
     */
     ...
     * again a {@link ConsumerEx2A3} relaying the exceptions of the passed
     * consumer.
     * 
