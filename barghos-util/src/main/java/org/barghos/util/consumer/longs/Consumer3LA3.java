...
public interface Consumer3LA3 extends Consumer3<long[][][],long[][][],long[][][]>
{
	 ...
	 */
	void accept3LA3(long[][][] a, long[][][] b, long[][][] c);
	 ...
	 * operation after.
	 */
	default Consumer3LA3 then3LA3(Consumer3LA3 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer3LA3 before3LA3(Consumer3LA3 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer3LA3 of3LA3(Consumer3LA3... consumers)
	{
		...
		return (a, b, c) -> { for(Consumer3LA3 consumer : consumers) consumer.accept3LA3(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer3LA3 of(Consumer3<long[][][],long[][][],long[][][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
