...
public interface Consumer3LA3 extends Consumer3<long[][][],long[][][],long[][][]>
{
     ...
     * operation after.
     */
    default Consumer3LA3 thenLong(Consumer3LA3 after)
    {
	...
	default Consumer3LA3 thenLong(Consumer3LA3... after)
    {
    	...
    	return (a, b, c) -> {acceptLongArray(a, b, c); for(Consumer3LA3 consumer : after) consumer.acceptLongArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link Consumer3LA3} performing the operation before and this
     * operation.
     */
    default Consumer3LA3 beforeLong(Consumer3LA3 before)
    {
     ...
     * 
     * @return A new {@link Consumer3LA3} performing the operations before and
     * this operation.
     */
    default Consumer3LA3 beforeLong(Consumer3LA3... before)
    {
    	...
    	return (a, b, c) -> {for(Consumer3LA3 consumer : before) consumer.acceptLongArray(a, b, c); acceptLongArray(a, b, c);};
    }
     ...
     */
	static Consumer3LA3 sequenceLong(Consumer3LA3... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3LA3 consumer : consumers) consumer.acceptLongArray(a, b, c);};
    }
     ...
     * operation after.
     */
    default Consumer3LA3 then(Consumer3<long[][][],long[][][],long[][][]> after)
    {
    	Validation.validateNotNull("after", after);
		 ...
		 */
    	if(after instanceof Consumer3LA3)
    	{
    		final Consumer3LA3 originalAfter = (Consumer3LA3)after;
	...
	default Consumer3LA3 then(Consumer3<long[][][],long[][][],long[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3LA3)
        	{
        		final Consumer3LA3 originalAfter = (Consumer3LA3)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3LA3)
    				((Consumer3LA3)consumer).acceptLongArray(a, b, c);
    			else
     ...
     * operation.
     */
    default Consumer3LA3 before(Consumer3<long[][][],long[][][],long[][][]> before)
    {
    	Validation.validateNotNull("before", before);
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3LA3)
    	{
    		final Consumer3LA3 originalBefore = (Consumer3LA3)before;
    ...
    default Consumer3LA3 before(Consumer3<long[][][],long[][][],long[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3LA3)
        	{
        		final Consumer3LA3 originalBefore = (Consumer3LA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3LA3 sequence(Consumer3<long[][][],long[][][],long[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3LA3)
    			return (Consumer3LA3) consumers[0];
    		else
    			return (Consumer3LA3) consumers[0]::accept;
    	}
