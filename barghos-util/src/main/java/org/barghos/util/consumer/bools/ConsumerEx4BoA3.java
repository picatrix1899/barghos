...
public interface ConsumerEx4BoA3 extends ConsumerEx4<boolean[][][],boolean[][][],boolean[][][],boolean[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4BoA3 then(ConsumerEx4BoA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4BoA3 then(ConsumerEx4<? super boolean[][][],? super boolean[][][],? super boolean[][][],? super boolean[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4BoA3 before(ConsumerEx4BoA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4BoA3 before(ConsumerEx4<? super boolean[][][],? super boolean[][][],? super boolean[][][],? super boolean[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4BoA3 handleEx(ExceptionHandler handler)
	{
	...
	@Override
	default Consumer4BoA3 ignoreEx()
	{
		return (a, b, c, d) -> {
			try
			{
	...
	default ConsumerEx4BoA3 onEx(ConsumerEx4BoA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4BoA3 onEx(ConsumerEx4<? super boolean[][][],? super boolean[][][],? super boolean[][][],? super boolean[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4BoA3 onEx(Consumer4BoA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4BoA3 onEx(Consumer4<? super boolean[][][],? super boolean[][][],? super boolean[][][],? super boolean[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx4BoA3 of(ConsumerEx4BoA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4BoA3 consumer : consumers) consumer.acceptBo(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4BoA3 of(ConsumerEx4<? super boolean[][][],? super boolean[][][],? super boolean[][][],? super boolean[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4BoA3 of(Consumer4BoA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4BoA3 consumer : consumers) consumer.accept(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4BoA3 of(Consumer4<? super boolean[][][],? super boolean[][][],? super boolean[][][],? super boolean[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
