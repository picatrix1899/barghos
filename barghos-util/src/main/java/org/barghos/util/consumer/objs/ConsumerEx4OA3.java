...
public interface ConsumerEx4OA3 extends ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx4OA3 thenObject(ConsumerEx4OA3 after)
    {
	...
	default ConsumerEx4OA3 thenObject(ConsumerEx4OA3... after)
    {
    	...
    	return (a, b, c, d) -> {acceptObjectArray(a, b, c, d); for(ConsumerEx4OA3 consumer : after) consumer.acceptObjectArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4OA3 beforeObject(ConsumerEx4OA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4OA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx4OA3 beforeObject(ConsumerEx4OA3... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4OA3 consumer : before) consumer.acceptObjectArray(a, b, c, d); acceptObjectArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4OA3 sequenceObject(ConsumerEx4OA3... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4OA3 consumer : consumers) consumer.acceptObjectArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4OA3 then(ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4OA3)
    	{
    		final ConsumerEx4OA3 originalAfter = (ConsumerEx4OA3)after;
	...
	default ConsumerEx4OA3 then(ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4OA3)
        	{
        		final ConsumerEx4OA3 originalAfter = (ConsumerEx4OA3)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4OA3)
    				((ConsumerEx4OA3)consumer).acceptObjectArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4OA3 before(ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4OA3)
    	{
    		final ConsumerEx4OA3 originalBefore = (ConsumerEx4OA3)before;
    ...
    default ConsumerEx4OA3 before(ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4OA3)
        	{
        		final ConsumerEx4OA3 originalBefore = (ConsumerEx4OA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4OA3 sequence(ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4OA3)
    			return (ConsumerEx4OA3) consumers[0];
    		else
    			return (ConsumerEx4OA3) consumers[0]::accept;
    	}
