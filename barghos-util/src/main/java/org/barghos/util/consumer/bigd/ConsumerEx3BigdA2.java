...
public interface ConsumerEx3BigdA2 extends ConsumerEx3<BigDecimal[][],BigDecimal[][],BigDecimal[][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx3BigdA2 then(Consumer3BigdA2 after)
	{
		Validate.Arg.checkNotNull("after", after);
	...
	@Override
	default ConsumerEx3BigdA2 then(Consumer3<? super BigDecimal[][],? super BigDecimal[][],? super BigDecimal[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * and this operation.
	 */
	default ConsumerEx3BigdA2 before(Consumer3BigdA2 before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	@Override
	default ConsumerEx3BigdA2 before(Consumer3<? super BigDecimal[][],? super BigDecimal[][],? super BigDecimal[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
