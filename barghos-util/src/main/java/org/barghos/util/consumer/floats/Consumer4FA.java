...
public interface Consumer4FA extends Consumer4<float[],float[],float[],float[]>
{
     ...
     */
    void acceptFloatArray(float[] a, float[] b, float[] c, float[] d);
     ...
     * operation after.
     */
    default Consumer4FA thenFloat(Consumer4FA after)
    {
     ...
     * 
     * @return A new {@link Consumer4FA} performing the operation before and this
     * operation.
     */
    default Consumer4FA beforeFloat(Consumer4FA before)
    {
    ...
    static Consumer4FA of(Consumer4FA... consumers)
    {
    	...
    	return (a, b, c, d) -> {
    		for(Consumer4FA consumer : consumers)
    		{
	...
	static Consumer4FA of(Consumer4<float[],float[],float[],float[]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (Consumer4FA) consumers[0]::accept;
    	}
