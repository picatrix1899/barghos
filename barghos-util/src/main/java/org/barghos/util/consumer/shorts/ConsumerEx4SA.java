...
public interface ConsumerEx4SA extends ConsumerEx4<short[],short[],short[],short[]>
{
     ...
     * operation after.
     */
    default ConsumerEx4SA thenShort(ConsumerEx4SA after)
    {
	...
	default ConsumerEx4SA thenShort(ConsumerEx4SA... after)
    {
    	...
    	return (a, b, c, d) -> {acceptShortArray(a, b, c, d); for(ConsumerEx4SA consumer : after) consumer.acceptShortArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4SA beforeShort(ConsumerEx4SA before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4SA} performing the operations before and
     * this operation.
     */
    default ConsumerEx4SA beforeShort(ConsumerEx4SA... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4SA consumer : before) consumer.acceptShortArray(a, b, c, d); acceptShortArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4SA sequenceShort(ConsumerEx4SA... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4SA consumer : consumers) consumer.acceptShortArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4SA then(ConsumerEx4<short[],short[],short[],short[]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4SA)
    	{
    		final ConsumerEx4SA originalAfter = (ConsumerEx4SA)after;
	...
	default ConsumerEx4SA then(ConsumerEx4<short[],short[],short[],short[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4SA)
        	{
        		final ConsumerEx4SA originalAfter = (ConsumerEx4SA)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4SA)
    				((ConsumerEx4SA)consumer).acceptShortArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4SA before(ConsumerEx4<short[],short[],short[],short[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4SA)
    	{
    		final ConsumerEx4SA originalBefore = (ConsumerEx4SA)before;
    ...
    default ConsumerEx4SA before(ConsumerEx4<short[],short[],short[],short[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4SA)
        	{
        		final ConsumerEx4SA originalBefore = (ConsumerEx4SA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4SA sequence(ConsumerEx4<short[],short[],short[],short[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4SA)
    			return (ConsumerEx4SA) consumers[0];
    		else
    			return (ConsumerEx4SA) consumers[0]::accept;
    	}
