...
public interface Consumer3StrA3 extends Consumer3<String[][][],String[][][],String[][][]>
{
     ...
     * operation after.
     */
    default Consumer3StrA3 thenString(Consumer3StrA3 after)
    {
	...
	default Consumer3StrA3 thenString(Consumer3StrA3... after)
    {
    	...
    	return (a, b, c) -> {acceptStringArray(a, b, c); for(Consumer3StrA3 consumer : after) consumer.acceptStringArray(a, b, c);};
    }
     ...
     * this operation.
     */
    default Consumer3StrA3 beforeString(Consumer3StrA3 before)
    {
     ...
     * 
     * @return A new {@link Consumer3StrA3} performing the operations before and
     * this operation.
     */
    default Consumer3StrA3 beforeString(Consumer3StrA3... before)
    {
    	...
    	return (a, b, c) -> {for(Consumer3StrA3 consumer : before) consumer.acceptStringArray(a, b, c); acceptStringArray(a, b, c);};
    }
     ...
     */
	static Consumer3StrA3 sequenceString(Consumer3StrA3... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3StrA3 consumer : consumers) consumer.acceptStringArray(a, b, c);};
    }
    ...
    default Consumer3StrA3 then(Consumer3<String[][][],String[][][],String[][][]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer3StrA3)
    	{
    		final Consumer3StrA3 originalAfter = (Consumer3StrA3)after;
	...
	default Consumer3StrA3 then(Consumer3<String[][][],String[][][],String[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3StrA3)
        	{
        		final Consumer3StrA3 originalAfter = (Consumer3StrA3)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3StrA3)
    				((Consumer3StrA3)consumer).acceptStringArray(a, b, c);
    			else
    ...
    default Consumer3StrA3 before(Consumer3<String[][][],String[][][],String[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3StrA3)
    	{
    		final Consumer3StrA3 originalBefore = (Consumer3StrA3)before;
    ...
    default Consumer3StrA3 before(Consumer3<String[][][],String[][][],String[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3StrA3)
        	{
        		final Consumer3StrA3 originalBefore = (Consumer3StrA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3StrA3 sequence(Consumer3<String[][][],String[][][],String[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3StrA3)
    			return (Consumer3StrA3) consumers[0];
    		else
    			return (Consumer3StrA3) consumers[0]::accept;
    	}
