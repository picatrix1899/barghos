...
public interface Consumer3SA3 extends Consumer3<short[][][],short[][][],short[][][]>
{
	 ...
	 */
	void accept3SA3(short[][][] a, short[][][] b, short[][][] c);
	 ...
	 * operation after.
	 */
	default Consumer3SA3 then3SA3(Consumer3SA3 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer3SA3 before3SA3(Consumer3SA3 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer3SA3 of3SA3(Consumer3SA3... consumers)
	{
		...
		return (a, b, c) -> { for(Consumer3SA3 consumer : consumers) consumer.accept3SA3(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer3SA3 of(Consumer3<short[][][],short[][][],short[][][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
