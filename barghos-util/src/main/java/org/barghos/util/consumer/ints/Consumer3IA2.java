...
public interface Consumer3IA2 extends Consumer3<int[][],int[][],int[][]>
{
     ...
     * operation after.
     */
    default Consumer3IA2 thenInt(Consumer3IA2 after)
    {
	...
	default Consumer3IA2 thenInt(Consumer3IA2... after)
    {
    	...
    	return (a, b, c) -> {acceptIntArray(a, b, c); for(Consumer3IA2 consumer : after) consumer.acceptIntArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link Consumer3IA2} performing the operation before and this
     * operation.
     */
    default Consumer3IA2 beforeInt(Consumer3IA2 before)
    {
     ...
     * 
     * @return A new {@link Consumer3IA2} performing the operations before and
     * this operation.
     */
    default Consumer3IA2 beforeInt(Consumer3IA2... before)
    {
    	...
    	return (a, b, c) -> {for(Consumer3IA2 consumer : before) consumer.acceptIntArray(a, b, c); acceptIntArray(a, b, c);};
    }
     ...
     */
	static Consumer3IA2 sequenceInt(Consumer3IA2... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3IA2 consumer : consumers) consumer.acceptIntArray(a, b, c);};
    }
    ...
    default Consumer3IA2 then(Consumer3<int[][],int[][],int[][]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer3IA2)
    	{
    		final Consumer3IA2 originalAfter = (Consumer3IA2)after;
	...
	default Consumer3IA2 then(Consumer3<int[][],int[][],int[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3IA2)
        	{
        		final Consumer3IA2 originalAfter = (Consumer3IA2)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3IA2)
    				((Consumer3IA2)consumer).acceptIntArray(a, b, c);
    			else
    ...
    default Consumer3IA2 before(Consumer3<int[][],int[][],int[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3IA2)
    	{
    		final Consumer3IA2 originalBefore = (Consumer3IA2)before;
    ...
    default Consumer3IA2 before(Consumer3<int[][],int[][],int[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3IA2)
        	{
        		final Consumer3IA2 originalBefore = (Consumer3IA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3IA2 sequence(Consumer3<int[][],int[][],int[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3IA2)
    			return (Consumer3IA2) consumers[0];
    		else
    			return (Consumer3IA2) consumers[0]::accept;
    	}
