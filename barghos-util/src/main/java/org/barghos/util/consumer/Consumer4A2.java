...
/**
 * Represents an operation that accepts four 2-dimensional array input arguments
...
public interface Consumer4A2<A,B,C,D>extends Consumer4<A[][],B[][],C[][],D[][]>
{
     ...
     * 
     * @return A new {@link Consumer4A2} performing this operation and the
     * operation after.
     */
    default Consumer4A2<A,B,C,D> thenArray(Consumer4A2<A,B,C,D> after)
    {
     ...
     * operations after.
     */
	default Consumer4A2<A,B,C,D> thenArray(java.util.List<Consumer4A2<A,B,C,D>> after)
    {
		Validation.validateNotNull("after", after);
		Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer4A2<A,B,C,D> thenArray(Iterable<Consumer4A2<A,B,C,D>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * 
     * @return A new {@link Consumer4A2} performing the operation before and
     * this operation.
     */
    default Consumer4A2<A,B,C,D> beforeArray(Consumer4A2<A,B,C,D> before)
    {
     ...
     * 
     * @return A new {@link Consumer4A2} performing the operations before and
     * this operation.
     */
    @SuppressWarnings("unchecked")
	default Consumer4A2<A,B,C,D> beforeArray(Consumer4A2<A,B,C,D>... before)
     ...
     * this operation.
     */
	default Consumer4A2<A,B,C,D> beforeArray(java.util.List<Consumer4A2<A,B,C,D>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer4A2<A,B,C,D> beforeArray(Iterable<Consumer4A2<A,B,C,D>> before)
    {
    	Validation.validateNotNull("before", before);
    ...
    /**
     * Composes a new {@link Consumer4A2} performing the given operations in
     * sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B,C,D> Consumer4A2<A,B,C,D> sequenceArray(Consumer4A2<A,B,C,D>... consumers)
    {
     ...
     * @return A new {@link Consumer4A2} performing the operations.
     */
	static <A,B,C,D> Consumer4A2<A,B,C,D> sequenceArray(java.util.List<Consumer4A2<A,B,C,D>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer4A2} performing the operations.
     */
    static <A,B,C,D> Consumer4A2<A,B,C,D> sequenceArray(Iterable<Consumer4A2<A,B,C,D>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default Consumer4A2<A,B,C,D> then(Consumer4<A[][],B[][],C[][],D[][]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer4A2<A,B,C,D> then(java.util.List<Consumer4<A[][],B[][],C[][],D[][]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(first instanceof Consumer4A2<A,B,C,D>)
        	{
        		final Consumer4A2<A,B,C,D> originalAfter = (Consumer4A2<A,B,C,D>)first;
     ...
     * operations after.
     */
	default Consumer4A2<A,B,C,D> then(Iterable<Consumer4<A[][],B[][],C[][],D[][]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * this operation.
     */
    default Consumer4A2<A,B,C,D> before(Consumer4<A[][],B[][],C[][],D[][]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer4A2<A,B,C,D> before(java.util.List<Consumer4<A[][],B[][],C[][],D[][]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer4A2<A,B,C,D>)
        	{
        		final Consumer4A2<A,B,C,D> originalBefore = (Consumer4A2<A,B,C,D>)first;
     ...
     * this operation.
     */
    default Consumer4A2<A,B,C,D> before(Iterable<Consumer4<A[][],B[][],C[][],D[][]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B,C,D> Consumer4A2<A,B,C,D> sequence(Consumer4<A[][],B[][],C[][],D[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer4A2} performing the operations.
     */
	static <A,B,C,D> Consumer4A2<A,B,C,D> sequence(java.util.List<Consumer4<A[][],B[][],C[][],D[][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer4A2<A,B,C,D>)
    			return (Consumer4A2<A,B,C,D>) first;
    		else
    			return (Consumer4A2<A,B,C,D>) first::accept;
    	}
     ...
     * @return A new {@link Consumer4A2} performing the operations.
     */
    static <A,B,C,D> Consumer4A2<A,B,C,D> sequence(Iterable<Consumer4<A[][],B[][],C[][],D[][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
