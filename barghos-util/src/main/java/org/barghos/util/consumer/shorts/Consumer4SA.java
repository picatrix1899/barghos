...
public interface Consumer4SA extends Consumer4<short[],short[],short[],short[]>
{
	 ...
	 */
	void accept4SA(short[] a, short[] b, short[] c, short[] d);
	 ...
	 * operation after.
	 */
	default Consumer4SA then4SA(Consumer4SA after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4SA before4SA(Consumer4SA before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4SA of4SA(Consumer4SA... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4SA consumer : consumers) consumer.accept4SA(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer4SA of(Consumer4<short[],short[],short[],short[]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
