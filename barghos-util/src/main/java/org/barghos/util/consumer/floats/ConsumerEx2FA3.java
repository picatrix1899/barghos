...
public interface ConsumerEx2FA3 extends ConsumerEx2<float[][][],float[][][]>
{
     ...
     */
    void acceptFloat3DArray(float[][][] a, float[][][] b) throws Exception;
     ...
     * operation after.
     */
    default ConsumerEx2FA3 thenFloat3DArray(ConsumerEx2FA3 after)
    {
     ...
     * this operation.
     */
    default ConsumerEx2FA3 beforeFloat3DArray(ConsumerEx2FA3 before)
    {
    ...
    static ConsumerEx2FA3 of(ConsumerEx2FA3... consumers)
    {
    	...
    	return (a, b) -> {
    		for(ConsumerEx2FA3 consumer : consumers)
    		{
	...
	static ConsumerEx2FA3 of(ConsumerEx2<float[][][],float[][][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (ConsumerEx2FA3) consumers[0]::accept;
    	}
