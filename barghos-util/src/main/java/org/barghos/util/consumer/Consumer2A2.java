...
/**
 * Represents an operation that accepts two 2-dimensional array input arguments
 * and returns no result. {@link Consumer2A2} is expected to operate via
 * side-effects.
 *
 * <p>
...
public interface Consumer2A2<A,B> extends Consumer2<A[][],B[][]>
{
     ...
     * 
     * @return A new {@link Consumer2A2} performing this operation and the
     * operation after.
     */
    default Consumer2A2<A,B> thenArray(Consumer2A2<A,B> after)
    {
     ...
     * operations after.
     */
	default Consumer2A2<A,B> thenArray(java.util.List<Consumer2A2<A,B>> after)
    {
		Validation.validateNotNull("after", after);
		Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer2A2<A,B> thenArray(Iterable<Consumer2A2<A,B>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * 
     * @return A new {@link Consumer2A2} performing the operation before and
     * this operation.
     */
    default Consumer2A2<A,B> beforeArray(Consumer2A2<A,B> before)
    {
     ...
     * 
     * @return A new {@link Consumer2A2} performing the operations before and
     * this operation.
     */
    @SuppressWarnings("unchecked")
	default Consumer2A2<A,B> beforeArray(Consumer2A2<A,B>... before)
     ...
     * this operation.
     */
	default Consumer2A2<A,B> beforeArray(java.util.List<Consumer2A2<A,B>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer2A2<A,B> beforeArray(Iterable<Consumer2A2<A,B>> before)
    {
    	Validation.validateNotNull("before", before);
    ...
    /**
     * Composes a new {@link Consumer2A2} performing the given operations in
     * sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B> Consumer2A2<A,B> sequenceArray(Consumer2A2<A,B>... consumers)
    {
     ...
     * @return A new {@link Consumer2A2} performing the operations.
     */
	static <A,B> Consumer2A2<A,B> sequenceArray(java.util.List<Consumer2A2<A,B>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer2A2} performing the operations.
     */
    static <A,B> Consumer2A2<A,B> sequenceArray(Iterable<Consumer2A2<A,B>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default Consumer2A2<A,B> then(Consumer2<A[][],B[][]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer2A2<A,B> then(java.util.List<Consumer2<A[][],B[][]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(first instanceof Consumer2A2<A,B>)
        	{
        		final Consumer2A2<A,B> originalAfter = (Consumer2A2<A,B>)first;
     ...
     * operations after.
     */
	default Consumer2A2<A,B> then(Iterable<Consumer2<A[][],B[][]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * this operation.
     */
    default Consumer2A2<A,B> before(Consumer2<A[][],B[][]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer2A2<A,B> before(java.util.List<Consumer2<A[][],B[][]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer2A2<A,B>)
        	{
        		final Consumer2A2<A,B> originalBefore = (Consumer2A2<A,B>)first;
     ...
     * this operation.
     */
    default Consumer2A2<A,B> before(Iterable<Consumer2<A[][],B[][]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B> Consumer2A2<A,B> sequence(Consumer2<A[][],B[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer2A2} performing the operations.
     */
	static <A,B> Consumer2A2<A,B> sequence(java.util.List<Consumer2<A[][],B[][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer2A2<A,B>)
    			return (Consumer2A2<A,B>) first;
    		else
    			return (Consumer2A2<A,B>) first::accept;
    	}
     ...
     * @return A new {@link Consumer2A2} performing the operations.
     */
    static <A,B> Consumer2A2<A,B> sequence(Iterable<Consumer2<A[][],B[][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
