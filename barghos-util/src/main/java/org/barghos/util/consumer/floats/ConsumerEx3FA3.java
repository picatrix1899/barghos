...
public interface ConsumerEx3FA3 extends ConsumerEx3<float[][][],float[][][],float[][][]>
{
     ...
     */
    void acceptFloat3DArray(float[][][] a, float[][][] b, float[][][] c) throws Exception;
     ...
     * operation after.
     */
    default ConsumerEx3FA3 thenFloat3DArray(ConsumerEx3FA3 after)
    {
     ...
     * this operation.
     */
    default ConsumerEx3FA3 beforeFloat3DArray(ConsumerEx3FA3 before)
    {
    ...
    static ConsumerEx3FA3 of(ConsumerEx3FA3... consumers)
    {
    	...
    	return (a, b, c) -> {
    		for(ConsumerEx3FA3 consumer : consumers)
    		{
	...
	static ConsumerEx3FA3 of(ConsumerEx3<float[][][],float[][][],float[][][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (ConsumerEx3FA3) consumers[0]::accept;
    	}
