...
//	 */
//	void accept3FA3(float[][][] a, float[][][] b, float[][][] c) throws Exception;
//	
//	/**
...
//	 * operation after.
//	 */
//	default ConsumerEx3FA3 then3FA3(ConsumerEx3FA3 after)
//	{
...
//	 * this operation.
//	 */
//	default ConsumerEx3FA3 before3FA3(ConsumerEx3FA3 before)
//	{
...
//	 */
//	@SafeVarargs
//	static ConsumerEx3FA3 of3FA3(ConsumerEx3FA3... consumers)
//	{
...
//		
//		return (a, b, c) -> { for(ConsumerEx3FA3 consumer : consumers) consumer.accept3FA3(a, b, c); };
//	}
//	
//	/**
//	 * @deprecated Use
...
//	 */
//	@Override
//	default ConsumerEx3FA3 then(ConsumerEx3<float[][][],float[][][],float[][][]> after)
//	{
//		ParameterValidation.pvNotNull("after", after);
//
...
//	 */
//	@Override
//	default ConsumerEx3FA3 before(ConsumerEx3<float[][][],float[][][],float[][][]> before)
//	{
//		ParameterValidation.pvNotNull("before", before);
//
...
//	 */
//	@SafeVarargs
//	static ConsumerEx3FA3 of(ConsumerEx3<float[][][],float[][][],float[][][]>... consumers)
//	{
//		ParameterValidation.pvNotNull("consumers", consumers);
//		ParameterValidation.pvEntriesNotNull("consumers", consumers);
//		
