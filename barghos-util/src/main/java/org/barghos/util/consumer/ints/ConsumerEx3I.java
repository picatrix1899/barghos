 ...
 * returns no result. Unlike {@link Consumer3I} this may throw exceptions.
...
public interface ConsumerEx3I extends ConsumerEx3<Integer,Integer,Integer>
{
     ...
     * operation after.
     */
    default ConsumerEx3I thenInt(ConsumerEx3I after)
    {
     ...
     * this operation.
     */
    default ConsumerEx3I beforeInt(ConsumerEx3I before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3I} performing the operations before and
     * this operation.
     */
    default ConsumerEx3I beforeInt(ConsumerEx3I... before)
    {
     ...
     */
	static ConsumerEx3I sequenceInt(ConsumerEx3I... consumers)
    {
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3I sequence(ConsumerEx3<Integer,Integer,Integer>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
