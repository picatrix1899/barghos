...
public interface Consumer3C extends Consumer3<Character,Character,Character>
{
     ...
     * operation after.
     */
    default Consumer3C thenChar(Consumer3C after)
    {
     ...
     * operation.
     */
    default Consumer3C beforeChar(Consumer3C before)
    {
     ...
     * 
     * @return A new {@link Consumer3C} performing the operations before and
     * this operation.
     */
    default Consumer3C beforeChar(Consumer3C... before)
    {
     ...
     */
	static Consumer3C sequenceChar(Consumer3C... consumers)
    {
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3C sequence(Consumer3<Character,Character,Character>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
