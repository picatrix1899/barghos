...
public interface Consumer4BigdA2 extends Consumer4<BigDecimal[][],BigDecimal[][],BigDecimal[][],BigDecimal[][]>
{
	 ...
	 */
	void accept4BigdA2(BigDecimal[][] a, BigDecimal[][] b, BigDecimal[][] c, BigDecimal[][] d);
	 ...
	 * operation after.
	 */
	default Consumer4BigdA2 then4BigdA2(Consumer4BigdA2 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4BigdA2 before4BigdA2(Consumer4BigdA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4BigdA2 of4BigdA2(Consumer4BigdA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4BigdA2 consumer : consumers) consumer.accept4BigdA2(a, b, c, d); };
	}
	 ...
	 */
	@Override
	default Consumer4BigdA2 then(Consumer4<BigDecimal[][],BigDecimal[][],BigDecimal[][],BigDecimal[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default Consumer4BigdA2 before(Consumer4<BigDecimal[][],BigDecimal[][],BigDecimal[][],BigDecimal[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer4BigdA2 of(Consumer4<BigDecimal[][],BigDecimal[][],BigDecimal[][],BigDecimal[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
