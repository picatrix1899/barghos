...
public interface Consumer4LA extends Consumer4<long[],long[],long[],long[]>
{
     ...
     * operation after.
     */
    default Consumer4LA thenLong(Consumer4LA after)
    {
	...
	default Consumer4LA thenLong(Consumer4LA... after)
    {
    	...
    	return (a, b, c, d) -> {acceptLongArray(a, b, c, d); for(Consumer4LA consumer : after) consumer.acceptLongArray(a, b, c, d);};
    }
     ...
     * 
     * @return A new {@link Consumer4LA} performing the operation before and this
     * operation.
     */
    default Consumer4LA beforeLong(Consumer4LA before)
    {
     ...
     * 
     * @return A new {@link Consumer4LA} performing the operations before and
     * this operation.
     */
    default Consumer4LA beforeLong(Consumer4LA... before)
    {
    	...
    	return (a, b, c, d) -> {for(Consumer4LA consumer : before) consumer.acceptLongArray(a, b, c, d); acceptLongArray(a, b, c, d);};
    }
     ...
     */
	static Consumer4LA sequenceLong(Consumer4LA... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(Consumer4LA consumer : consumers) consumer.acceptLongArray(a, b, c, d);};
    }
    ...
    default Consumer4LA then(Consumer4<long[],long[],long[],long[]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer4LA)
    	{
    		final Consumer4LA originalAfter = (Consumer4LA)after;
	...
	default Consumer4LA then(Consumer4<long[],long[],long[],long[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer4LA)
        	{
        		final Consumer4LA originalAfter = (Consumer4LA)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof Consumer4LA)
    				((Consumer4LA)consumer).acceptLongArray(a, b, c, d);
    			else
    ...
    default Consumer4LA before(Consumer4<long[],long[],long[],long[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer4LA)
    	{
    		final Consumer4LA originalBefore = (Consumer4LA)before;
    ...
    default Consumer4LA before(Consumer4<long[],long[],long[],long[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer4LA)
        	{
        		final Consumer4LA originalBefore = (Consumer4LA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer4LA sequence(Consumer4<long[],long[],long[],long[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer4LA)
    			return (Consumer4LA) consumers[0];
    		else
    			return (Consumer4LA) consumers[0]::accept;
    	}
