 ...
 * result. Unlike {@link Consumer4L} this may throw exceptions.
...
public interface ConsumerEx4L extends ConsumerEx4<Long,Long,Long,Long>
{
     ...
     * operation after.
     */
    default ConsumerEx4L thenLong(ConsumerEx4L after)
    {
     ...
     * this operation.
     */
    default ConsumerEx4L beforeLong(ConsumerEx4L before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4L} performing the operations before and
     * this operation.
     */
    default ConsumerEx4L beforeLong(ConsumerEx4L... before)
    {
     ...
     */
	static ConsumerEx4L sequenceLong(ConsumerEx4L... consumers)
    {
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4L sequence(ConsumerEx4<Long,Long,Long,Long>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
