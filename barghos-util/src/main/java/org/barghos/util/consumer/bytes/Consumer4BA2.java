...
public interface Consumer4BA2 extends Consumer4<byte[][],byte[][],byte[][],byte[][]>
{
	 ...
	 */
	void accept4BA2(byte[][] a, byte[][] b, byte[][] c, byte[][] d);
	 ...
	 * operation after.
	 */
	default Consumer4BA2 then4BA2(Consumer4BA2 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4BA2 before4BA2(Consumer4BA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4BA2 of4BA2(Consumer4BA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4BA2 consumer : consumers) consumer.accept4BA2(a, b, c, d); };
	}
	
	/**
	 * @deprecated Use
	 * {@link #accept4BA2(byte[][], byte[][], byte[][], byte[][])} instead.
	 */
	@Override
	 ...
	 */
	@Override
	default Consumer4BA2 then(Consumer4<byte[][],byte[][],byte[][],byte[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default Consumer4BA2 before(Consumer4<byte[][],byte[][],byte[][],byte[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer4BA2 of(Consumer4<byte[][],byte[][],byte[][],byte[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
