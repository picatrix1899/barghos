...
//	 */
//	void accept3DA2(double[][] a, double[][] b, double[][] c) throws Exception;
//	
//	/**
...
//	 * operation after.
//	 */
//	default ConsumerEx3DA2 then3DA2(ConsumerEx3DA2 after)
//	{
...
//	 * this operation.
//	 */
//	default ConsumerEx3DA2 before2FA2(ConsumerEx3DA2 before)
//	{
...
//	 */
//	@SafeVarargs
//	static ConsumerEx3DA2 of3DA2(ConsumerEx3DA2... consumers)
//	{
...
//		
//		return (a, b, c) -> { for(ConsumerEx3DA2 consumer : consumers) consumer.accept3DA2(a, b, c); };
//	}
//	
//	/**
...
//	 */
//	@Override
//	default ConsumerEx3DA2 then(ConsumerEx3<double[][],double[][],double[][]> after)
//	{
//		ParameterValidation.pvNotNull("after", after);
//
...
//	 */
//	@Override
//	default ConsumerEx3DA2 before(ConsumerEx3<double[][],double[][],double[][]> before)
//	{
//		ParameterValidation.pvNotNull("before", before);
//
...
//	 */
//	@SafeVarargs
//	static ConsumerEx3DA2 of(ConsumerEx3<double[][],double[][],double[][]>... consumers)
//	{
//		ParameterValidation.pvNotNull("consumers", consumers);
//		ParameterValidation.pvEntriesNotNull("consumers", consumers);
//		
