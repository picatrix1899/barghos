...
public interface ConsumerEx4LA extends ConsumerEx4<long[],long[],long[],long[]>
{
     ...
     * operation after.
     */
    default ConsumerEx4LA thenLong(ConsumerEx4LA after)
    {
	...
	default ConsumerEx4LA thenLong(ConsumerEx4LA... after)
    {
    	...
    	return (a, b, c, d) -> {acceptLongArray(a, b, c, d); for(ConsumerEx4LA consumer : after) consumer.acceptLongArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4LA beforeLong(ConsumerEx4LA before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4LA} performing the operations before and
     * this operation.
     */
    default ConsumerEx4LA beforeLong(ConsumerEx4LA... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4LA consumer : before) consumer.acceptLongArray(a, b, c, d); acceptLongArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4LA sequenceLong(ConsumerEx4LA... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4LA consumer : consumers) consumer.acceptLongArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4LA then(ConsumerEx4<long[],long[],long[],long[]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4LA)
    	{
    		final ConsumerEx4LA originalAfter = (ConsumerEx4LA)after;
	...
	default ConsumerEx4LA then(ConsumerEx4<long[],long[],long[],long[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4LA)
        	{
        		final ConsumerEx4LA originalAfter = (ConsumerEx4LA)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4LA)
    				((ConsumerEx4LA)consumer).acceptLongArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4LA before(ConsumerEx4<long[],long[],long[],long[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4LA)
    	{
    		final ConsumerEx4LA originalBefore = (ConsumerEx4LA)before;
    ...
    default ConsumerEx4LA before(ConsumerEx4<long[],long[],long[],long[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4LA)
        	{
        		final ConsumerEx4LA originalBefore = (ConsumerEx4LA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4LA sequence(ConsumerEx4<long[],long[],long[],long[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4LA)
    			return (ConsumerEx4LA) consumers[0];
    		else
    			return (ConsumerEx4LA) consumers[0]::accept;
    	}
