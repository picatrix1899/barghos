...
public interface ConsumerStrA2 extends Consumer<String[][]>
{
     ...
     * operation after.
     */
    default ConsumerStrA2 thenString(ConsumerStrA2 after)
    {
	...
	default ConsumerStrA2 thenString(ConsumerStrA2... after)
    {
    	...
    	return (a) -> {acceptStringArray(a); for(ConsumerStrA2 consumer : after) consumer.acceptStringArray(a);};
    }
     ...
     * this operation.
     */
    default ConsumerStrA2 beforeString(ConsumerStrA2 before)
    {
     ...
     * 
     * @return A new {@link ConsumerStrA2} performing the operations before and
     * this operation.
     */
    default ConsumerStrA2 beforeString(ConsumerStrA2... before)
    {
    	...
    	return (a) -> {for(ConsumerStrA2 consumer : before) consumer.acceptStringArray(a); acceptStringArray(a);};
    }
     ...
     */
	static ConsumerStrA2 sequenceString(ConsumerStrA2... consumers)
    {
    	...
    	return (a) -> {for(ConsumerStrA2 consumer : consumers) consumer.acceptStringArray(a);};
    }
    ...
    default ConsumerStrA2 then(Consumer<String[][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerStrA2)
    	{
    		final ConsumerStrA2 originalAfter = (ConsumerStrA2)after;
	...
	default ConsumerStrA2 then(Consumer<String[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerStrA2)
        	{
        		final ConsumerStrA2 originalAfter = (ConsumerStrA2)after[0];
    	...
    	return (a) -> {
    		...
    		{
    			if(consumer instanceof ConsumerStrA2)
    				((ConsumerStrA2)consumer).acceptStringArray(a);
    			else
    				consumer.accept(a);
    		}
    	};
    ...
    default ConsumerStrA2 before(Consumer<String[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerStrA2)
    	{
    		final ConsumerStrA2 originalBefore = (ConsumerStrA2)before;
    ...
    default ConsumerStrA2 before(Consumer<String[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerStrA2)
        	{
        		final ConsumerStrA2 originalBefore = (ConsumerStrA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerStrA2 sequence(Consumer<String[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerStrA2)
    			return (ConsumerStrA2) consumers[0];
    		else
    			return (ConsumerStrA2) consumers[0]::accept;
    	}
