...
public interface ConsumerEx3BA3 extends ConsumerEx3<byte[][][],byte[][][],byte[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx3BA3 then3BA3(ConsumerEx3BA3 after)
	{
	 ...
	 * this operation.
	 */
	default ConsumerEx3BA3 before3BA3(ConsumerEx3BA3 before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3BA3 of3BA3(ConsumerEx3BA3... consumers)
	{
	 ...
	 */
	@Override
	default ConsumerEx3BA3 then(ConsumerEx3<byte[][][],byte[][][],byte[][][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx3BA3 before(ConsumerEx3<byte[][][],byte[][][],byte[][][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3BA3 of(ConsumerEx3<byte[][][],byte[][][],byte[][][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
