...
public interface ConsumerEx4StrA extends ConsumerEx4<String[],String[],String[],String[]>
{
     ...
     * operation after.
     */
    default ConsumerEx4StrA thenString(ConsumerEx4StrA after)
    {
	...
	default ConsumerEx4StrA thenString(ConsumerEx4StrA... after)
    {
    	...
    	return (a, b, c, d) -> {acceptStringArray(a, b, c, d); for(ConsumerEx4StrA consumer : after) consumer.acceptStringArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4StrA beforeString(ConsumerEx4StrA before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4StrA} performing the operations before and
     * this operation.
     */
    default ConsumerEx4StrA beforeString(ConsumerEx4StrA... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4StrA consumer : before) consumer.acceptStringArray(a, b, c, d); acceptStringArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4StrA sequenceString(ConsumerEx4StrA... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4StrA consumer : consumers) consumer.acceptStringArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4StrA then(ConsumerEx4<String[],String[],String[],String[]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4StrA)
    	{
    		final ConsumerEx4StrA originalAfter = (ConsumerEx4StrA)after;
	...
	default ConsumerEx4StrA then(ConsumerEx4<String[],String[],String[],String[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 * use it as the desired type to avoid boxing.
    		 */
    		if(after[0] instanceof ConsumerEx4StrA)
        	{
        		final ConsumerEx4StrA originalAfter = (ConsumerEx4StrA)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4StrA)
    				((ConsumerEx4StrA)consumer).acceptStringArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4StrA before(ConsumerEx4<String[],String[],String[],String[]> before)
    {
		 ...
		 * use it as the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4StrA)
    	{
    		final ConsumerEx4StrA originalBefore = (ConsumerEx4StrA)before;
    ...
    default ConsumerEx4StrA before(ConsumerEx4<String[],String[],String[],String[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * use it as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4StrA)
        	{
        		final ConsumerEx4StrA originalBefore = (ConsumerEx4StrA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4StrA sequence(ConsumerEx4<String[],String[],String[],String[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4StrA)
    			return (ConsumerEx4StrA) consumers[0];
    		else
    			return (ConsumerEx4StrA) consumers[0]::accept;
    	}
     ...
     * 
     * @return A new {@link Consumer4StrA} performing the operations and
     * exception handling.
     */
    default Consumer4StrA handled(ExceptionHandler handler)
    {
     ...
     * again a {@link ConsumerEx4StrA} relaying the exceptions of the passed
     * consumer.
     * 
     ...
     * @return A new {@link ConsumerEx4StrA} performing the operations.
     */
    default ConsumerEx4StrA onException(ConsumerEx4StrA consumer)
    {
     ...
     * is a {@link Consumer4StrA}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
     * @return A new {@link Consumer4StrA} performing the operations.
     */
    default Consumer4StrA onException(Consumer4StrA consumer)
    {
    	Validation.validateNotNull("consumer", consumer);
