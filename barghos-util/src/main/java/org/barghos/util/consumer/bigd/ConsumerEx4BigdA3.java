...
public interface ConsumerEx4BigdA3 extends ConsumerEx4<BigDecimal[][][],BigDecimal[][][],BigDecimal[][][],BigDecimal[][][]>
{
	 ...
	 */
	void accept4BigdA3(BigDecimal[][][] a, BigDecimal[][][] b, BigDecimal[][][] c, BigDecimal[][][] d) throws Exception;
	 ...
	 * operation after.
	 */
	default ConsumerEx4BigdA3 then4BigdA3(ConsumerEx4BigdA3 after)
	{
	 ...
	 * and this operation.
	 */
	default ConsumerEx4BigdA3 before4BigdA3(ConsumerEx4BigdA3 before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4BigdA3 of4BigdA3(ConsumerEx4BigdA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4BigdA3 consumer : consumers) consumer.accept4BigdA3(a, b, c, d); };
	}
	 ...
	 */
	@Override
	default ConsumerEx4BigdA3 then(ConsumerEx4<BigDecimal[][][],BigDecimal[][][],BigDecimal[][][],BigDecimal[][][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx4BigdA3 before(ConsumerEx4<BigDecimal[][][],BigDecimal[][][],BigDecimal[][][],BigDecimal[][][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4BigdA3 of(ConsumerEx4<BigDecimal[][][],BigDecimal[][][],BigDecimal[][][],BigDecimal[][][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
