...
/**
 * Represents an operation that accepts three 3-dimensional array input argument
...
public interface ConsumerEx3A3<A,B,C> extends ConsumerEx3<A[][][],B[][][],C[][][]>
{
     ...
     * 
     * @return A new {@link ConsumerEx3A3} performing this operation and the
     * operation after.
     */
    default ConsumerEx3A3<A,B,C> thenArray(ConsumerEx3A3<A,B,C> after)
    {
     ...
     * operations after.
     */
	default ConsumerEx3A3<A,B,C> thenArray(java.util.List<ConsumerEx3A3<A,B,C>> after)
    {
		Validation.validateNotNull("after", after);
		Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default ConsumerEx3A3<A,B,C> thenArray(Iterable<ConsumerEx3A3<A,B,C>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * 
     * @return A new {@link ConsumerEx3A3} performing the operation before and
     * this operation.
     */
    default ConsumerEx3A3<A,B,C> beforeArray(ConsumerEx3A3<A,B,C> before)
    {
     ...
     * this operation.
     */
	default ConsumerEx3A3<A,B,C> beforeArray(java.util.List<ConsumerEx3A3<A,B,C>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * @param before The operations to perform before this operation.
     * 
     * @return A new {@link ConsumerEx3A3} performing the operations before and
     * this operation.
     */
    default ConsumerEx3A3<A,B,C> beforeArray(Iterable<ConsumerEx3A3<A,B,C>> before)
    {
    	Validation.validateNotNull("before", before);
    ...
    /**
     * Composes a new {@link ConsumerEx3A3} performing the given operations in
     * sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B,C> ConsumerEx3A3<A,B,C> sequenceArray(ConsumerEx3A3<A,B,C>... consumers)
    {
     ...
     * @return A new {@link ConsumerEx3A3} performing the operations.
     */
	static <A,B,C> ConsumerEx3A3<A,B,C> sequenceArray(java.util.List<ConsumerEx3A3<A,B,C>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link ConsumerEx3A3} performing the operations.
     */
    static <A,B,C> ConsumerEx3A3<A,B,C> sequenceArray(Iterable<ConsumerEx3A3<A,B,C>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default ConsumerEx3A3<A,B,C> then(ConsumerEx3<A[][][],B[][][],C[][][]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default ConsumerEx3A3<A,B,C> then(java.util.List<ConsumerEx3<A[][][],B[][][],C[][][]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(first instanceof ConsumerEx3A3<A,B,C>)
        	{
        		final ConsumerEx3A3<A,B,C> originalAfter = (ConsumerEx3A3<A,B,C>)first;
     ...
     * operations after.
     */
	default ConsumerEx3A3<A,B,C> then(Iterable<ConsumerEx3<A[][][],B[][][],C[][][]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * this operation.
     */
    default ConsumerEx3A3<A,B,C> before(ConsumerEx3<A[][][],B[][][],C[][][]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default ConsumerEx3A3<A,B,C> before(java.util.List<ConsumerEx3<A[][][],B[][][],C[][][]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof ConsumerEx3A3<A,B,C>)
        	{
        		final ConsumerEx3A3<A,B,C> originalBefore = (ConsumerEx3A3<A,B,C>)first;
     ...
     * this operation.
     */
    default ConsumerEx3A3<A,B,C> before(Iterable<ConsumerEx3<A[][][],B[][][],C[][][]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B,C> ConsumerEx3A3<A,B,C> sequence(ConsumerEx3<A[][][],B[][][],C[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link ConsumerEx3A3} performing the operations.
     */
	static <A,B,C> ConsumerEx3A3<A,B,C> sequence(java.util.List<ConsumerEx3<A[][][],B[][][],C[][][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof ConsumerEx3A3<A,B,C>)
    			return (ConsumerEx3A3<A,B,C>) first;
    		else
    			return (ConsumerEx3A3<A,B,C>) first::accept;
    	}
     ...
     * @return A new {@link ConsumerEx3A3} performing the operations.
     */
    static <A,B,C> ConsumerEx3A3<A,B,C> sequence(Iterable<ConsumerEx3<A[][][],B[][][],C[][][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * 
     * @return A new {@link Consumer3A3} performing the operations and exception
     * handling.
     */
     ...
     * again a {@link ConsumerEx3A3} relaying the exceptions of the passed
     * consumer.
     * 
