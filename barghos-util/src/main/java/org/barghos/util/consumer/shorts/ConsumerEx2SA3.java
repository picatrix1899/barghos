...
public interface ConsumerEx2SA3 extends ConsumerEx2<short[][][],short[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx2SA3 thenShort(ConsumerEx2SA3 after)
    {
	...
	default ConsumerEx2SA3 thenShort(ConsumerEx2SA3... after)
    {
    	...
    	return (a, b) -> {acceptShortArray(a, b); for(ConsumerEx2SA3 consumer : after) consumer.acceptShortArray(a, b);};
    }
     ...
     * this operation.
     */
    default ConsumerEx2SA3 beforeShort(ConsumerEx2SA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx2SA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx2SA3 beforeShort(ConsumerEx2SA3... before)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2SA3 consumer : before) consumer.acceptShortArray(a, b); acceptShortArray(a, b);};
    }
     ...
     */
	static ConsumerEx2SA3 sequenceShort(ConsumerEx2SA3... consumers)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2SA3 consumer : consumers) consumer.acceptShortArray(a, b);};
    }
    ...
    default ConsumerEx2SA3 then(ConsumerEx2<short[][][],short[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx2SA3)
    	{
    		final ConsumerEx2SA3 originalAfter = (ConsumerEx2SA3)after;
	...
	default ConsumerEx2SA3 then(ConsumerEx2<short[][][],short[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx2SA3)
        	{
        		final ConsumerEx2SA3 originalAfter = (ConsumerEx2SA3)after[0];
    	...
    	return (a, b) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx2SA3)
    				((ConsumerEx2SA3)consumer).acceptShortArray(a, b);
    			else
    				consumer.accept(a, b);
    		}
    	};
    ...
    default ConsumerEx2SA3 before(ConsumerEx2<short[][][],short[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx2SA3)
    	{
    		final ConsumerEx2SA3 originalBefore = (ConsumerEx2SA3)before;
    ...
    default ConsumerEx2SA3 before(ConsumerEx2<short[][][],short[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx2SA3)
        	{
        		final ConsumerEx2SA3 originalBefore = (ConsumerEx2SA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx2SA3 sequence(ConsumerEx2<short[][][],short[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx2SA3)
    			return (ConsumerEx2SA3) consumers[0];
    		else
    			return (ConsumerEx2SA3) consumers[0]::accept;
    	}
