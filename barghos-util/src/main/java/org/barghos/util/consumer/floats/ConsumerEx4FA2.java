...
public interface ConsumerEx4FA2 extends ConsumerEx4<float[][],float[][],float[][],float[][]>
{
     ...
     */
    void acceptFloat2DArray(float[][] a, float[][] b, float[][] c, float[][] d) throws Exception;
     ...
     * operation after.
     */
    default ConsumerEx4FA2 thenFloat2DArray(ConsumerEx4FA2 after)
    {
     ...
     * this operation.
     */
    default ConsumerEx4FA2 beforeFloat2DArray(ConsumerEx4FA2 before)
    {
    ...
    static ConsumerEx4FA2 of(ConsumerEx4FA2... consumers)
    {
    	...
    	return (a, b, c, d) -> {
    		for(ConsumerEx4FA2 consumer : consumers)
    		{
	...
	static ConsumerEx4FA2 of(ConsumerEx4<float[][],float[][],float[][],float[][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (ConsumerEx4FA2) consumers[0]::accept;
    	}
