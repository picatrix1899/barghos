 ...
 * {@link #acceptFloat2DArray(float[][], float[][])}.
 * 
 * @see ConsumerFA2
 * @see ConsumerExFA2
 * @see Consumer2FA2
...
public interface ConsumerEx2FA2 extends ConsumerEx2<float[][],float[][]>
{
     ...
     */
    void acceptFloat2DArray(float[][] a, float[][] b) throws Exception;
     ...
     * operation after.
     */
    default ConsumerEx2FA2 thenFloat2DArray(ConsumerEx2FA2 after)
    {
    	ParameterValidation.pvNotNull("after", after);
    	
    	return (a, b) -> {
    		acceptFloat2DArray(a, b);
    		
    		after.acceptFloat2DArray(a, b);
    	};
    }
     ...
     * this operation.
     */
    default ConsumerEx2FA2 beforeFloat2DArray(ConsumerEx2FA2 before)
    {
    	ParameterValidation.pvNotNull("before", before);
    	
    	return (a, b) -> {
    		before.acceptFloat2DArray(a, b);
    ...
    static ConsumerEx2FA2 of(ConsumerEx2FA2... consumers)
    {
    	...
    	return (a, b) -> {
    		for(ConsumerEx2FA2 consumer : consumers)
    		{
    			consumer.acceptFloat2DArray(a, b);
    		}
    	};
    }
    ...
    /**
     * @deprecated
     * Use {@link #acceptFloat2DArray(float[][], float[][])} instead.
     */
    @Override
	...
	static ConsumerEx2FA2 of(ConsumerEx2<float[][],float[][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (ConsumerEx2FA2) consumers[0]::accept;
    	}
