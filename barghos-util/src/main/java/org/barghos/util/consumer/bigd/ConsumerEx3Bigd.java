...
public interface ConsumerEx3Bigd extends ConsumerEx3<BigDecimal,BigDecimal,BigDecimal>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx3Bigd then(Consumer3Bigd after)
	{
		Validate.Arg.checkNotNull("after", after);
	...
	@Override
	default ConsumerEx3Bigd then(Consumer3<? super BigDecimal,? super BigDecimal,? super BigDecimal> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx3Bigd before(Consumer3Bigd before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	@Override
	default ConsumerEx3Bigd before(Consumer3<? super BigDecimal,? super BigDecimal,? super BigDecimal> before)
	{
		Validate.Arg.checkNotNull("before", before);
