 ...
 * {@link #acceptFloat3DArray(float[][][], float[][][])}.
 * 
 * @see ConsumerFA3
 * @see ConsumerExFA3
 * @see Consumer2FA3
...
public interface Consumer2FA3 extends Consumer2<float[][][],float[][][]>
{
     ...
     */
    void acceptFloat3DArray(float[][][] a, float[][][] b);
     ...
     * operation after.
     */
    default Consumer2FA3 thenFloat3DArray(Consumer2FA3 after)
    {
    	ParameterValidation.pvNotNull("after", after);
    	
    	return (a, b) -> {
    		acceptFloat3DArray(a, b);
    		
    		after.acceptFloat3DArray(a, b);
    	};
    }
     ...
     * 
     * @return A new {@link Consumer2FA3} performing the operation before and this
     * operation.
     */
    default Consumer2FA3 beforeFloat3DArray(Consumer2FA3 before)
    {
    	ParameterValidation.pvNotNull("before", before);
    	
    	return (a, b) -> {
    		before.acceptFloat3DArray(a, b);
    ...
    static Consumer2FA3 of(Consumer2FA3... consumers)
    {
    	...
    	return (a, b) -> {
    		for(Consumer2FA3 consumer : consumers)
    		{
    			consumer.acceptFloat3DArray(a, b);
    		}
    	};
    }
    ...
    default Consumer2FA3 then(Consumer2<float[][][],float[][][]> after)
    {
    	...
    	return (a, b) -> {acceptFloat3DArray(a, b); after.accept(a, b);};
    }
    ...
    static Consumer2FA3 of(Consumer2<float[][][],float[][][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (Consumer2FA3) consumers[0]::accept;
    	}
	...
	/**
     * @deprecated
     * Use {@link #acceptFloat3DArray(float[][][], float[][][])} instead.
     */
    @Override
