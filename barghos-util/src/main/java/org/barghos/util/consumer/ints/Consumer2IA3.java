...
public interface Consumer2IA3 extends Consumer2<int[][][],int[][][]>
{
     ...
     * operation after.
     */
    default Consumer2IA3 thenInt(Consumer2IA3 after)
    {
	...
	default Consumer2IA3 thenInt(Consumer2IA3... after)
    {
    	...
    	return (a, b) -> {acceptIntArray(a, b); for(Consumer2IA3 consumer : after) consumer.acceptIntArray(a, b);};
    }
     ...
     * 
     * @return A new {@link Consumer2IA3} performing the operation before and this
     * operation.
     */
    default Consumer2IA3 beforeInt(Consumer2IA3 before)
    {
     ...
     * 
     * @return A new {@link Consumer2IA3} performing the operations before and
     * this operation.
     */
    default Consumer2IA3 beforeInt(Consumer2IA3... before)
    {
    	...
    	return (a, b) -> {for(Consumer2IA3 consumer : before) consumer.acceptIntArray(a, b); acceptIntArray(a, b);};
    }
     ...
     */
	static Consumer2IA3 sequenceInt(Consumer2IA3... consumers)
    {
    	...
    	return (a, b) -> {for(Consumer2IA3 consumer : consumers) consumer.acceptIntArray(a, b);};
    }
    ...
    default Consumer2IA3 then(Consumer2<int[][][],int[][][]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer2IA3)
    	{
    		final Consumer2IA3 originalAfter = (Consumer2IA3)after;
	...
	default Consumer2IA3 then(Consumer2<int[][][],int[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer2IA3)
        	{
        		final Consumer2IA3 originalAfter = (Consumer2IA3)after[0];
    	...
    	return (a, b) -> {
    		...
    		{
    			if(consumer instanceof Consumer2IA3)
    				((Consumer2IA3)consumer).acceptIntArray(a, b);
    			else
    				consumer.accept(a, b);
    		}
    	};
    ...
    default Consumer2IA3 before(Consumer2<int[][][],int[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer2IA3)
    	{
    		final Consumer2IA3 originalBefore = (Consumer2IA3)before;
    ...
    default Consumer2IA3 before(Consumer2<int[][][],int[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer2IA3)
        	{
        		final Consumer2IA3 originalBefore = (Consumer2IA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer2IA3 sequence(Consumer2<int[][][],int[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer2IA3)
    			return (Consumer2IA3) consumers[0];
    		else
    			return (Consumer2IA3) consumers[0]::accept;
    	}
