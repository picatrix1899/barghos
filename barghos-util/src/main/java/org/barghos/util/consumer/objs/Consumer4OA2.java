...
public interface Consumer4OA2 extends Consumer4<Object[][],Object[][],Object[][],Object[][]>
{
	 ...
	 */
	void accept4OA2(Object[][] a, Object[][] b, Object[][] c, Object[][] d);
	 ...
	 * operation after.
	 */
	default Consumer4OA2 then4OA2(Consumer4OA2 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4OA2 before4OA2(Consumer4OA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4OA2 of4OA2(Consumer4OA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4OA2 consumer : consumers) consumer.accept4OA2(a, b, c, d); };
	}
	
	/**
	 * @deprecated Use
	 * {@link #accept4OA2(Object[][], Object[][], Object[][], Object[][])} instead.
	 */
	@Override
	 ...
	 */
	@SafeVarargs
	static Consumer4OA2 of(Consumer4<Object[][],Object[][],Object[][],Object[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
