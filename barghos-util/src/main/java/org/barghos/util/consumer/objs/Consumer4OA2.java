...
public interface Consumer4OA2 extends Consumer4<Object[][],Object[][],Object[][],Object[][]>
{
     ...
     * operation after.
     */
    default Consumer4OA2 thenObject(Consumer4OA2 after)
    {
	...
	default Consumer4OA2 thenObject(Consumer4OA2... after)
    {
    	...
    	return (a, b, c, d) -> {acceptObjectArray(a, b, c, d); for(Consumer4OA2 consumer : after) consumer.acceptObjectArray(a, b, c, d);};
    }
     ...
     * 
     * @return A new {@link Consumer4OA2} performing the operation before and this
     * operation.
     */
    default Consumer4OA2 beforeObject(Consumer4OA2 before)
    {
     ...
     * 
     * @return A new {@link Consumer4OA2} performing the operations before and
     * this operation.
     */
    default Consumer4OA2 beforeObject(Consumer4OA2... before)
    {
    	...
    	return (a, b, c, d) -> {for(Consumer4OA2 consumer : before) consumer.acceptObjectArray(a, b, c, d); acceptObjectArray(a, b, c, d);};
    }
     ...
     */
	static Consumer4OA2 sequenceObject(Consumer4OA2... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(Consumer4OA2 consumer : consumers) consumer.acceptObjectArray(a, b, c, d);};
    }
     ...
     * operation after.
     */
    default Consumer4OA2 then(Consumer4<Object[][],Object[][],Object[][],Object[][]> after)
    {
    	Validation.validateNotNull("after", after);
		 ...
		 */
    	if(after instanceof Consumer4OA2)
    	{
    		final Consumer4OA2 originalAfter = (Consumer4OA2)after;
	...
	default Consumer4OA2 then(Consumer4<Object[][],Object[][],Object[][],Object[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer4OA2)
        	{
        		final Consumer4OA2 originalAfter = (Consumer4OA2)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof Consumer4OA2)
    				((Consumer4OA2)consumer).acceptObjectArray(a, b, c, d);
    			else
     ...
     * operation.
     */
    default Consumer4OA2 before(Consumer4<Object[][],Object[][],Object[][],Object[][]> before)
    {
    	Validation.validateNotNull("before", before);
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer4OA2)
    	{
    		final Consumer4OA2 originalBefore = (Consumer4OA2)before;
    ...
    default Consumer4OA2 before(Consumer4<Object[][],Object[][],Object[][],Object[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer4OA2)
        	{
        		final Consumer4OA2 originalBefore = (Consumer4OA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer4OA2 sequence(Consumer4<Object[][],Object[][],Object[][],Object[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer4OA2)
    			return (Consumer4OA2) consumers[0];
    		else
    			return (Consumer4OA2) consumers[0]::accept;
    	}
