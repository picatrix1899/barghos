...
/**
 * Represents an operation that accepts three 3-dimensional array input
 * arguments and returns no result. {@link Consumer3A3} is expected to operate
 * via side-effects.
 *
 * <p>
...
public interface Consumer3A3<A,B,C> extends Consumer3<A[][][],B[][][],C[][][]>
{
     ...
     * 
     * @return A new {@link Consumer3A3} performing this operation and the
     * operation after.
     */
    default Consumer3A3<A,B,C> thenArray(Consumer3A3<A,B,C> after)
    {
     ...
     * operations after.
     */
	default Consumer3A3<A,B,C> thenArray(java.util.List<Consumer3A3<A,B,C>> after)
    {
		Validation.validateNotNull("after", after);
		Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer3A3<A,B,C> thenArray(Iterable<Consumer3A3<A,B,C>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * 
     * @return A new {@link Consumer3A3} performing the operation before and
     * this operation.
     */
    default Consumer3A3<A,B,C> beforeArray(Consumer3A3<A,B,C> before)
    {
     ...
     * 
     * @return A new {@link Consumer3A3} performing the operations before and
     * this operation.
     */
    @SuppressWarnings("unchecked")
	default Consumer3A3<A,B,C> beforeArray(Consumer3A3<A,B,C>... before)
     ...
     * this operation.
     */
	default Consumer3A3<A,B,C> beforeArray(java.util.List<Consumer3A3<A,B,C>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer3A3<A,B,C> beforeArray(Iterable<Consumer3A3<A,B,C>> before)
    {
    	Validation.validateNotNull("before", before);
    ...
    /**
     * Composes a new {@link Consumer3A3} performing the given operations in
     * sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B,C> Consumer3A3<A,B,C> sequenceArray(Consumer3A3<A,B,C>... consumers)
    {
     ...
     * @return A new {@link Consumer3A3} performing the operations.
     */
	static <A,B,C> Consumer3A3<A,B,C> sequenceArray(java.util.List<Consumer3A3<A,B,C>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer3A3} performing the operations.
     */
    static <A,B,C> Consumer3A3<A,B,C> sequenceArray(Iterable<Consumer3A3<A,B,C>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default Consumer3A3<A,B,C> then(Consumer3<A[][][],B[][][],C[][][]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer3A3<A,B,C> then(java.util.List<Consumer3<A[][][],B[][][],C[][][]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(first instanceof Consumer3A3<A,B,C>)
        	{
        		final Consumer3A3<A,B,C> originalAfter = (Consumer3A3<A,B,C>)first;
     ...
     * operations after.
     */
	default Consumer3A3<A,B,C> then(Iterable<Consumer3<A[][][],B[][][],C[][][]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * this operation.
     */
    default Consumer3A3<A,B,C> before(Consumer3<A[][][],B[][][],C[][][]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer3A3<A,B,C> before(java.util.List<Consumer3<A[][][],B[][][],C[][][]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer3A3<A,B,C>)
        	{
        		final Consumer3A3<A,B,C> originalBefore = (Consumer3A3<A,B,C>)first;
     ...
     * this operation.
     */
    default Consumer3A3<A,B,C> before(Iterable<Consumer3<A[][][],B[][][],C[][][]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B,C> Consumer3A3<A,B,C> sequence(Consumer3<A[][][],B[][][],C[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer3A3} performing the operations.
     */
	static <A,B,C> Consumer3A3<A,B,C> sequence(java.util.List<Consumer3<A[][][],B[][][],C[][][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer3A3<A,B,C>)
    			return (Consumer3A3<A,B,C>) first;
    		else
    			return (Consumer3A3<A,B,C>) first::accept;
    	}
     ...
     * @return A new {@link Consumer3A3} performing the operations.
     */
    static <A,B,C> Consumer3A3<A,B,C> sequence(Iterable<Consumer3<A[][][],B[][][],C[][][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
