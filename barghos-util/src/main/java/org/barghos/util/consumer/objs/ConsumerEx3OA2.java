...
public interface ConsumerEx3OA2 extends ConsumerEx3<Object[][],Object[][],Object[][]>
{
     ...
     * operation after.
     */
    default ConsumerEx3OA2 thenObject(ConsumerEx3OA2 after)
    {
	...
	default ConsumerEx3OA2 thenObject(ConsumerEx3OA2... after)
    {
    	...
    	return (a, b, c) -> {acceptObjectArray(a, b, c); for(ConsumerEx3OA2 consumer : after) consumer.acceptObjectArray(a, b, c);};
    }
     ...
     * this operation.
     */
    default ConsumerEx3OA2 beforeObject(ConsumerEx3OA2 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3OA2} performing the operations before and
     * this operation.
     */
    default ConsumerEx3OA2 beforeObject(ConsumerEx3OA2... before)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3OA2 consumer : before) consumer.acceptObjectArray(a, b, c); acceptObjectArray(a, b, c);};
    }
     ...
     */
	static ConsumerEx3OA2 sequenceObject(ConsumerEx3OA2... consumers)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3OA2 consumer : consumers) consumer.acceptObjectArray(a, b, c);};
    }
    ...
    default ConsumerEx3OA2 then(ConsumerEx3<Object[][],Object[][],Object[][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx3OA2)
    	{
    		final ConsumerEx3OA2 originalAfter = (ConsumerEx3OA2)after;
	...
	default ConsumerEx3OA2 then(ConsumerEx3<Object[][],Object[][],Object[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx3OA2)
        	{
        		final ConsumerEx3OA2 originalAfter = (ConsumerEx3OA2)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx3OA2)
    				((ConsumerEx3OA2)consumer).acceptObjectArray(a, b, c);
    			else
    ...
    default ConsumerEx3OA2 before(ConsumerEx3<Object[][],Object[][],Object[][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx3OA2)
    	{
    		final ConsumerEx3OA2 originalBefore = (ConsumerEx3OA2)before;
    ...
    default ConsumerEx3OA2 before(ConsumerEx3<Object[][],Object[][],Object[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx3OA2)
        	{
        		final ConsumerEx3OA2 originalBefore = (ConsumerEx3OA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3OA2 sequence(ConsumerEx3<Object[][],Object[][],Object[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx3OA2)
    			return (ConsumerEx3OA2) consumers[0];
    		else
    			return (ConsumerEx3OA2) consumers[0]::accept;
    	}
