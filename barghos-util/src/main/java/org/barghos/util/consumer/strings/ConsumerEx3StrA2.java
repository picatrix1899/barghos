...
public interface ConsumerEx3StrA2 extends ConsumerEx3<String[][],String[][],String[][]>
{
     ...
     * operation after.
     */
    default ConsumerEx3StrA2 thenString(ConsumerEx3StrA2 after)
    {
	...
	default ConsumerEx3StrA2 thenString(ConsumerEx3StrA2... after)
    {
    	...
    	return (a, b, c) -> {acceptStringArray(a, b, c); for(ConsumerEx3StrA2 consumer : after) consumer.acceptStringArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link ConsumerEx3StrA2} performing the operation before and
     * this operation.
     */
    default ConsumerEx3StrA2 beforeString(ConsumerEx3StrA2 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3StrA2} performing the operations before and
     * this operation.
     */
    default ConsumerEx3StrA2 beforeString(ConsumerEx3StrA2... before)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3StrA2 consumer : before) consumer.acceptStringArray(a, b, c); acceptStringArray(a, b, c);};
    }
    
    /**
     * Composes a new {@link ConsumerEx3StrA2} performing the given operations in
     * sequence.
     * 
     ...
     */
	static ConsumerEx3StrA2 sequenceString(ConsumerEx3StrA2... consumers)
    {
    	...
    	return (a, b, c) -> {for(ConsumerEx3StrA2 consumer : consumers) consumer.acceptStringArray(a, b, c);};
    }
    ...
    default ConsumerEx3StrA2 then(ConsumerEx3<String[][],String[][],String[][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx3StrA2)
    	{
    		final ConsumerEx3StrA2 originalAfter = (ConsumerEx3StrA2)after;
	...
	default ConsumerEx3StrA2 then(ConsumerEx3<String[][],String[][],String[][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 * use it as the desired type to avoid boxing.
    		 */
    		if(after[0] instanceof ConsumerEx3StrA2)
        	{
        		final ConsumerEx3StrA2 originalAfter = (ConsumerEx3StrA2)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx3StrA2)
    				((ConsumerEx3StrA2)consumer).acceptStringArray(a, b, c);
    			else
    ...
    default ConsumerEx3StrA2 before(ConsumerEx3<String[][],String[][],String[][]> before)
    {
		 ...
		 * use it as the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx3StrA2)
    	{
    		final ConsumerEx3StrA2 originalBefore = (ConsumerEx3StrA2)before;
    ...
    default ConsumerEx3StrA2 before(ConsumerEx3<String[][],String[][],String[][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * use it as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx3StrA2)
        	{
        		final ConsumerEx3StrA2 originalBefore = (ConsumerEx3StrA2)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3StrA2 sequence(ConsumerEx3<String[][],String[][],String[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx3StrA2)
    			return (ConsumerEx3StrA2) consumers[0];
    		else
    			return (ConsumerEx3StrA2) consumers[0]::accept;
    	}
     ...
     * 
     * @return A new {@link Consumer3StrA2} performing the operations and
     * exception handling.
     */
    default Consumer3StrA2 handled(ExceptionHandler handler)
    {
     ...
     * again a {@link ConsumerEx3StrA2} relaying the exceptions of the passed
     * consumer.
     * 
     ...
     * @return A new {@link ConsumerEx3StrA2} performing the operations.
     */
    default ConsumerEx3StrA2 onException(ConsumerEx3StrA2 consumer)
    {
     ...
     * is a {@link Consumer3StrA2}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
     * @return A new {@link Consumer3StrA2} performing the operations.
     */
    default Consumer3StrA2 onException(Consumer3StrA2 consumer)
    {
    	Validation.validateNotNull("consumer", consumer);
