...
public interface Consumer2OA3 extends Consumer2<Object[][][],Object[][][]>
{
     ...
     * operation after.
     */
    default Consumer2OA3 thenObject(Consumer2OA3 after)
    {
	...
	default Consumer2OA3 thenObject(Consumer2OA3... after)
    {
    	...
    	return (a, b) -> {acceptObjectArray(a, b); for(Consumer2OA3 consumer : after) consumer.acceptObjectArray(a, b);};
    }
     ...
     * 
     * @return A new {@link Consumer2OA3} performing the operation before and this
     * operation.
     */
    default Consumer2OA3 beforeObject(Consumer2OA3 before)
    {
     ...
     * 
     * @return A new {@link Consumer2OA3} performing the operations before and
     * this operation.
     */
    default Consumer2OA3 beforeObject(Consumer2OA3... before)
    {
    	...
    	return (a, b) -> {for(Consumer2OA3 consumer : before) consumer.acceptObjectArray(a, b); acceptObjectArray(a, b);};
    }
     ...
     */
	static Consumer2OA3 sequenceObject(Consumer2OA3... consumers)
    {
    	...
    	return (a, b) -> {for(Consumer2OA3 consumer : consumers) consumer.acceptObjectArray(a, b);};
    }
     ...
     * operation after.
     */
    default Consumer2OA3 then(Consumer2<Object[][][],Object[][][]> after)
    {
    	Validation.validateNotNull("after", after);
		 ...
		 */
    	if(after instanceof Consumer2OA3)
    	{
    		final Consumer2OA3 originalAfter = (Consumer2OA3)after;
	...
	default Consumer2OA3 then(Consumer2<Object[][][],Object[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer2OA3)
        	{
        		final Consumer2OA3 originalAfter = (Consumer2OA3)after[0];
    	...
    	return (a, b) -> {
    		...
    		{
    			if(consumer instanceof Consumer2OA3)
    				((Consumer2OA3)consumer).acceptObjectArray(a, b);
    			else
    				consumer.accept(a, b);
    		}
    	};
     ...
     * operation.
     */
    default Consumer2OA3 before(Consumer2<Object[][][],Object[][][]> before)
    {
    	Validation.validateNotNull("before", before);
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer2OA3)
    	{
    		final Consumer2OA3 originalBefore = (Consumer2OA3)before;
    ...
    default Consumer2OA3 before(Consumer2<Object[][][],Object[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer2OA3)
        	{
        		final Consumer2OA3 originalBefore = (Consumer2OA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer2OA3 sequence(Consumer2<Object[][][],Object[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer2OA3)
    			return (Consumer2OA3) consumers[0];
    		else
    			return (Consumer2OA3) consumers[0]::accept;
    	}
