...
public interface Consumer4StrA2 extends Consumer4<String[][],String[][],String[][],String[][]>
{
	 ...
	 */
	void accept4StrA2(String[][] a, String[][] b, String[][] c, String[][] d);
	 ...
	 * operation after.
	 */
	default Consumer4StrA2 then4StrA2(Consumer4StrA2 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4StrA2 before4StrA2(Consumer4StrA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4StrA2 of4StrA2(Consumer4StrA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4StrA2 consumer : consumers) consumer.accept4StrA2(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer4StrA2 of(Consumer4<String[][],String[][],String[][],String[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
