...
public interface Consumer4Str extends Consumer4<String,String,String,String>
{
     ...
     * operation after.
     */
    default Consumer4Str thenString(Consumer4Str after)
    {
     ...
     * this operation.
     */
    default Consumer4Str beforeString(Consumer4Str before)
    {
     ...
     * 
     * @return A new {@link Consumer4Str} performing the operations before and
     * this operation.
     */
    default Consumer4Str beforeString(Consumer4Str... before)
    {
     ...
     */
	static Consumer4Str sequenceString(Consumer4Str... consumers)
    {
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer4Str sequence(Consumer4<String,String,String,String>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
