...
public interface ConsumerEx4OA extends ConsumerEx4<Object[],Object[],Object[],Object[]>
{
     ...
     * operation after.
     */
    default ConsumerEx4OA thenObject(ConsumerEx4OA after)
    {
	...
	default ConsumerEx4OA thenObject(ConsumerEx4OA... after)
    {
    	...
    	return (a, b, c, d) -> {acceptObjectArray(a, b, c, d); for(ConsumerEx4OA consumer : after) consumer.acceptObjectArray(a, b, c, d);};
    }
     ...
     * this operation.
     */
    default ConsumerEx4OA beforeObject(ConsumerEx4OA before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx4OA} performing the operations before and
     * this operation.
     */
    default ConsumerEx4OA beforeObject(ConsumerEx4OA... before)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4OA consumer : before) consumer.acceptObjectArray(a, b, c, d); acceptObjectArray(a, b, c, d);};
    }
     ...
     */
	static ConsumerEx4OA sequenceObject(ConsumerEx4OA... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(ConsumerEx4OA consumer : consumers) consumer.acceptObjectArray(a, b, c, d);};
    }
    ...
    default ConsumerEx4OA then(ConsumerEx4<Object[],Object[],Object[],Object[]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx4OA)
    	{
    		final ConsumerEx4OA originalAfter = (ConsumerEx4OA)after;
	...
	default ConsumerEx4OA then(ConsumerEx4<Object[],Object[],Object[],Object[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx4OA)
        	{
        		final ConsumerEx4OA originalAfter = (ConsumerEx4OA)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx4OA)
    				((ConsumerEx4OA)consumer).acceptObjectArray(a, b, c, d);
    			else
    ...
    default ConsumerEx4OA before(ConsumerEx4<Object[],Object[],Object[],Object[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx4OA)
    	{
    		final ConsumerEx4OA originalBefore = (ConsumerEx4OA)before;
    ...
    default ConsumerEx4OA before(ConsumerEx4<Object[],Object[],Object[],Object[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx4OA)
        	{
        		final ConsumerEx4OA originalBefore = (ConsumerEx4OA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4OA sequence(ConsumerEx4<Object[],Object[],Object[],Object[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx4OA)
    			return (ConsumerEx4OA) consumers[0];
    		else
    			return (ConsumerEx4OA) consumers[0]::accept;
    	}
