...
public interface Consumer4BoA2 extends Consumer4<boolean[][],boolean[][],boolean[][],boolean[][]>
{
	 ...
	 */
	void accept4BoA2(boolean[][] a, boolean[][] b, boolean[][] c, boolean[][] d);
	 ...
	 * operation after.
	 */
	default Consumer4BoA2 then4BoA2(Consumer4BoA2 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4BoA2 before4BoA2(Consumer4BoA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4BoA2 of4BoA2(Consumer4BoA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4BoA2 consumer : consumers) consumer.accept4BoA2(a, b, c, d); };
	}
	 ...
	 */
	@Override
	default Consumer4BoA2 then(Consumer4<boolean[][],boolean[][],boolean[][],boolean[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default Consumer4BoA2 before(Consumer4<boolean[][],boolean[][],boolean[][],boolean[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer4BoA2 of(Consumer4<boolean[][],boolean[][],boolean[][],boolean[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
