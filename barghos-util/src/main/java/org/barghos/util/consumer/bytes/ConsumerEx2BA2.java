...
public interface ConsumerEx2BA2 extends ConsumerEx2<byte[][],byte[][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2BA2 then2BA2(ConsumerEx2BA2 after)
	{
	 ...
	 * this operation.
	 */
	default ConsumerEx2BA2 before2BA2(ConsumerEx2BA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2BA2 of2BA2(ConsumerEx2BA2... consumers)
	{
	 ...
	 */
	@Override
	default ConsumerEx2BA2 then(ConsumerEx2<byte[][],byte[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx2BA2 before(ConsumerEx2<byte[][],byte[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2BA2 of(ConsumerEx2<byte[][],byte[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
