...
public interface Consumer4IA3 extends Consumer4<int[][][],int[][][],int[][][],int[][][]>
{
	 ...
	 */
	void accept4IA3(int[][][] a, int[][][] b, int[][][] c, int[][][] d);
	 ...
	 * operation after.
	 */
	default Consumer4IA3 then4IA3(Consumer4IA3 after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4IA3 before4IA3(Consumer4IA3 before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4IA3 of4IA3(Consumer4IA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4IA3 consumer : consumers) consumer.accept4IA3(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer4IA3 of(Consumer4<int[][][],int[][][],int[][][],int[][][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
