...
public interface Consumer4IA3 extends Consumer4<int[][][],int[][][],int[][][],int[][][]>
{
     ...
     * operation after.
     */
    default Consumer4IA3 thenInt(Consumer4IA3 after)
    {
	...
	default Consumer4IA3 thenInt(Consumer4IA3... after)
    {
    	...
    	return (a, b, c, d) -> {acceptIntArray(a, b, c, d); for(Consumer4IA3 consumer : after) consumer.acceptIntArray(a, b, c, d);};
    }
     ...
     * 
     * @return A new {@link Consumer4IA3} performing the operation before and this
     * operation.
     */
    default Consumer4IA3 beforeInt(Consumer4IA3 before)
    {
     ...
     * 
     * @return A new {@link Consumer4IA3} performing the operations before and
     * this operation.
     */
    default Consumer4IA3 beforeInt(Consumer4IA3... before)
    {
    	...
    	return (a, b, c, d) -> {for(Consumer4IA3 consumer : before) consumer.acceptIntArray(a, b, c, d); acceptIntArray(a, b, c, d);};
    }
     ...
     */
	static Consumer4IA3 sequenceInt(Consumer4IA3... consumers)
    {
    	...
    	return (a, b, c, d) -> {for(Consumer4IA3 consumer : consumers) consumer.acceptIntArray(a, b, c, d);};
    }
     ...
     * operation after.
     */
    default Consumer4IA3 then(Consumer4<int[][][],int[][][],int[][][],int[][][]> after)
    {
    	Validation.validateNotNull("after", after);
		 ...
		 */
    	if(after instanceof Consumer4IA3)
    	{
    		final Consumer4IA3 originalAfter = (Consumer4IA3)after;
	...
	default Consumer4IA3 then(Consumer4<int[][][],int[][][],int[][][],int[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer4IA3)
        	{
        		final Consumer4IA3 originalAfter = (Consumer4IA3)after[0];
    	...
    	return (a, b, c, d) -> {
    		...
    		{
    			if(consumer instanceof Consumer4IA3)
    				((Consumer4IA3)consumer).acceptIntArray(a, b, c, d);
    			else
     ...
     * operation.
     */
    default Consumer4IA3 before(Consumer4<int[][][],int[][][],int[][][],int[][][]> before)
    {
    	Validation.validateNotNull("before", before);
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer4IA3)
    	{
    		final Consumer4IA3 originalBefore = (Consumer4IA3)before;
    ...
    default Consumer4IA3 before(Consumer4<int[][][],int[][][],int[][][],int[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer4IA3)
        	{
        		final Consumer4IA3 originalBefore = (Consumer4IA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer4IA3 sequence(Consumer4<int[][][],int[][][],int[][][],int[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer4IA3)
    			return (Consumer4IA3) consumers[0];
    		else
    			return (Consumer4IA3) consumers[0]::accept;
    	}
