...
/**
 * Represents an operation that accepts two 1-dimensional array input argument and returns no
 * result.
 * Unlike {@link Consumer2A} this may throw Exceptions.
...
public interface ConsumerEx2A<A,B> extends ConsumerEx2<A[],B[]>
{
     ...
     * 
     * @return A new {@link ConsumerEx2A} performing this operation and the operation after.
     */
    default ConsumerEx2A<A,B> andThenArray(ConsumerEx2A<A,B> after)
    {
    	/*
     ...
     * 
     * @return A new {@link ConsumerEx2A} performing this operation and the operations after.
     */
     ...
     * @return A new {@link ConsumerEx2A} performing this operation and the operations after.
     */
	default ConsumerEx2A<A,B> andThenArray(Iterable<ConsumerEx2A<A,B>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx2A} performing the operation before and this operation.
     */
    default ConsumerEx2A<A,B> beforeThatArray(ConsumerEx2A<A,B> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx2A} performing the operations before and this operation.
     */
    @SuppressWarnings("unchecked")
	default ConsumerEx2A<A,B> beforeThatArray(ConsumerEx2A<A,B>... before)
    {
     ...
     * @return A new {@link ConsumerEx2A} performing the operations before and this operation.
     */
    default ConsumerEx2A<A,B> beforeThatArray(Iterable<ConsumerEx2A<A,B>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link ConsumerEx2A} performing the given operations in sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     * 
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B> ConsumerEx2A<A,B> inSequenceArray(ConsumerEx2A<A,B>... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2A} performing the operations.
     */
    static <A,B> ConsumerEx2A<A,B> inSequenceArray(Iterable<ConsumerEx2A<A,B>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2A} performing this operation and the operation after.
     */
    default ConsumerEx2A<A,B> andThen(ConsumerEx2<A[],B[]> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2A} performing this operation and the operations after.
     */
	default ConsumerEx2A<A,B> andThen(Iterable<ConsumerEx2<A[],B[]>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2A} performing the operation before and this operation.
     */
    default ConsumerEx2A<A,B> beforeThat(ConsumerEx2<A[],B[]> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2A} performing the operations before and this operation.
     */
    default ConsumerEx2A<A,B> beforeThat(Iterable<ConsumerEx2<A[],B[]>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B> ConsumerEx2A<A,B> inSequence(ConsumerEx2<A[],B[]>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link ConsumerEx2A} performing the operations.
     */
    static <A,B> ConsumerEx2A<A,B> inSequence(Iterable<ConsumerEx2<A[],B[]>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Adds exception handling to the consumer and thus converts it into a {@link Consumer2A}.
     * 
     * @param handler The exception handler called in case of an exception.
     * 
     * @return A new {@link Consumer2A} performing the operations and exception handling.
     */
     ...
     * consumer may throw an exception the returned consumer is again a {@link ConsumerEx2A}
    ...
    /**
     * Performs the passed operation in case of an exception in this consumer. As the passed
     * consumer can not throw an exception the returned consumer is a {@link Consumer2A}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
