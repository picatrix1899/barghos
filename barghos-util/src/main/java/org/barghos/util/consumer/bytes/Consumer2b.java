...
/**
 * Represents an operation that accepts two byte input arguments and returns no result.
 * {@link Consumer2b} is expected to operate via side-effects.
 *
 * <p>
...
public interface Consumer2b extends Consumer2<Byte,Byte>
{
     ...
     * 
     * @return A new {@link Consumer2b} performing this operation and the operation after.
     */
    default Consumer2b andThenByte(Consumer2b after)
    {
    	/*
     ...
     * 
     * @return A new {@link Consumer2b} performing this operation and the operations after.
     */
	default Consumer2b andThenByte(Consumer2b... after)
    {
		/*
     ...
     * @return A new {@link Consumer2b} performing this operation and the operations after.
     */
	default Consumer2b andThenByte(Iterable<Consumer2b> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link Consumer2b} performing the operation before and this operation.
     */
    default Consumer2b beforeThatByte(Consumer2b before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer2b} performing the operations before and this operation.
     */
    default Consumer2b beforeThatByte(Iterable<Consumer2b> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link Consumer2b} performing the given operations in sequence.
     * 
     * @param consumers The operations to perform.
     * 
     * @return A new {@link Consumer2b} performing the operations.
     */
	static Consumer2b inSequenceByte(Consumer2b... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null.
    	 * Also no entry must be null.
     ...
     * @return A new {@link Consumer2b} performing the operations.
     */
    static Consumer2b inSequenceByte(Iterable<Consumer2b> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer2b} performing this operation and the operation after.
     */
    default Consumer2b andThen(Consumer2<Byte,Byte> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer2b} performing this operation and the operations after.
     */
	default Consumer2b andThen(Iterable<Consumer2<Byte,Byte>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer2b} performing the operation before and this operation.
     */
    default Consumer2b beforeThat(Consumer2<Byte,Byte> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer2b} performing the operations before and this operation.
     */
    default Consumer2b beforeThat(Iterable<Consumer2<Byte,Byte>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer2b inSequence(Consumer2<Byte,Byte>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null.
    	 * Also no entry must be null.
    	...
    	if(consumers.length == 1)
    	{
    		if(consumers[0] instanceof Consumer2b)
    			...
    			return (Consumer2b) consumers[0]::accept;
    	}
     ...
     * @return A new {@link Consumer2b} performing the operations.
     */
    static Consumer2b inSequence(Iterable<Consumer2<Byte,Byte>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
