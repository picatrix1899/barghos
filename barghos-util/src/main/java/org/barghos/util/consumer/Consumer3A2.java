...
/**
 * Represents an operation that accepts three 2-dimensional array input arguments and returns no
 * result.
 * {@link Consumer3A2} is expected to operate via side-effects.
 *
 * <p>
...
public interface Consumer3A2<A,B,C> extends Consumer3<A[][],B[][],C[][]>
{
     ...
     * 
     * @return A new {@link Consumer3A2} performing this operation and the operation after.
     */
    default Consumer3A2<A,B,C> andThenArray(Consumer3A2<A,B,C> after)
    {
    	/*
     ...
     * 
     * @return A new {@link Consumer3A2} performing this operation and the operations after.
     */
     ...
     * @return A new {@link Consumer3A2} performing this operation and the operations after.
     */
	default Consumer3A2<A,B,C> andThenArray(Iterable<Consumer3A2<A,B,C>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link Consumer3A2} performing the operation before and this operation.
     */
    default Consumer3A2<A,B,C> beforeThatArray(Consumer3A2<A,B,C> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link Consumer3A2} performing the operations before and this operation.
     */
    @SuppressWarnings("unchecked")
	default Consumer3A2<A,B,C> beforeThatArray(Consumer3A2<A,B,C>... before)
    {
     ...
     * @return A new {@link Consumer3A2} performing the operations before and this operation.
     */
    default Consumer3A2<A,B,C> beforeThatArray(Iterable<Consumer3A2<A,B,C>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link Consumer3A2} performing the given operations in sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     * @param <C> The type of the third argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B,C> Consumer3A2<A,B,C> inSequenceArray(Consumer3A2<A,B,C>... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link Consumer3A2} performing the operations.
     */
    static <A,B,C> Consumer3A2<A,B,C> inSequenceArray(Iterable<Consumer3A2<A,B,C>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer3A2} performing this operation and the operation after.
     */
    default Consumer3A2<A,B,C> andThen(Consumer3<A[][],B[][],C[][]> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer3A2} performing this operation and the operations after.
     */
	default Consumer3A2<A,B,C> andThen(Iterable<Consumer3<A[][],B[][],C[][]>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer3A2} performing the operation before and this operation.
     */
    default Consumer3A2<A,B,C> beforeThat(Consumer3<A[][],B[][],C[][]> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link Consumer3A2} performing the operations before and this operation.
     */
    default Consumer3A2<A,B,C> beforeThat(Iterable<Consumer3<A[][],B[][],C[][]>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B,C> Consumer3A2<A,B,C> inSequence(Consumer3<A[][],B[][],C[][]>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link Consumer3A2} performing the operations.
     */
    static <A,B,C> Consumer3A2<A,B,C> inSequence(Iterable<Consumer3<A[][],B[][],C[][]>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
