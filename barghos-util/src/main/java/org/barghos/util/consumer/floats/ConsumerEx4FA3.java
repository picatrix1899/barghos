...
public interface ConsumerEx4FA3 extends ConsumerEx4<float[][][],float[][][],float[][][],float[][][]>
{
     ...
     */
    void acceptFloat3DArray(float[][][] a, float[][][] b, float[][][] c, float[][][] d) throws Exception;
     ...
     * operation after.
     */
    default ConsumerEx4FA3 thenFloat3DArray(ConsumerEx4FA3 after)
    {
     ...
     * this operation.
     */
    default ConsumerEx4FA3 beforeFloat3DArray(ConsumerEx4FA3 before)
    {
    ...
    static ConsumerEx4FA3 of(ConsumerEx4FA3... consumers)
    {
    	...
    	return (a, b, c, d) -> {
    		for(ConsumerEx4FA3 consumer : consumers)
    		{
	...
	static ConsumerEx4FA3 of(ConsumerEx4<float[][][],float[][][],float[][][],float[][][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (ConsumerEx4FA3) consumers[0]::accept;
    	}
