 ...
 * argument and returns no result. Unlike {@link ConsumerStrA} this may throw
...
public interface ConsumerExStrA extends ConsumerEx<String[]>
{
     ...
     * operation after.
     */
    default ConsumerExStrA thenString(ConsumerExStrA after)
    {
	...
	default ConsumerExStrA thenString(ConsumerExStrA... after)
    {
    	...
    	return (a) -> {acceptStringArray(a); for(ConsumerExStrA consumer : after) consumer.acceptStringArray(a);};
    }
     ...
     * this operation.
     */
    default ConsumerExStrA beforeString(ConsumerExStrA before)
    {
     ...
     * 
     * @return A new {@link ConsumerExStrA} performing the operations before and
     * this operation.
     */
    default ConsumerExStrA beforeString(ConsumerExStrA... before)
    {
    	...
    	return (a) -> {for(ConsumerExStrA consumer : before) consumer.acceptStringArray(a); acceptStringArray(a);};
    }
     ...
     */
	static ConsumerExStrA sequenceString(ConsumerExStrA... consumers)
    {
    	...
    	return (a) -> {for(ConsumerExStrA consumer : consumers) consumer.acceptStringArray(a);};
    }
    ...
    default ConsumerExStrA then(ConsumerEx<String[]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerExStrA)
    	{
    		final ConsumerExStrA originalAfter = (ConsumerExStrA)after;
	...
	default ConsumerExStrA then(ConsumerEx<String[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerExStrA)
        	{
        		final ConsumerExStrA originalAfter = (ConsumerExStrA)after[0];
    	...
    	return (a) -> {
    		...
    		{
    			if(consumer instanceof ConsumerExStrA)
    				((ConsumerExStrA)consumer).acceptStringArray(a);
    			else
    				consumer.accept(a);
    		}
    	};
    ...
    default ConsumerExStrA before(ConsumerEx<String[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerExStrA)
    	{
    		final ConsumerExStrA originalBefore = (ConsumerExStrA)before;
    ...
    default ConsumerExStrA before(ConsumerEx<String[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerExStrA)
        	{
        		final ConsumerExStrA originalBefore = (ConsumerExStrA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerExStrA sequence(ConsumerEx<String[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerExStrA)
    			return (ConsumerExStrA) consumers[0];
    		else
    			return (ConsumerExStrA) consumers[0]::accept;
    	}
     ...
     * 
     * @return A new {@link ConsumerStrA} performing the operations and
     * exception handling.
     */
    default ConsumerStrA handled(ExceptionHandler handler)
    {
     ...
     * again a {@link ConsumerExStrA} relaying the exceptions of the passed
     * consumer.
     * 
     ...
     * @return A new {@link ConsumerExStrA} performing the operations.
     */
    default ConsumerExStrA onException(ConsumerExStrA consumer)
    {
     ...
     * is a {@link ConsumerStrA}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
     * @return A new {@link ConsumerStrA} performing the operations.
     */
    default ConsumerStrA onException(ConsumerStrA consumer)
    {
    	Validation.validateNotNull("consumer", consumer);
