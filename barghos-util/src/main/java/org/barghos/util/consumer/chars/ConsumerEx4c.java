...
/**
 * Represents an operation that accepts four char input argument and returns no result.
 * Unlike {@link Consumer4c} this may throw Exceptions.
...
public interface ConsumerEx4c extends ConsumerEx4<Character,Character,Character,Character>
{
     ...
     * 
     * @return A new {@link ConsumerEx4c} performing this operation and the operation after.
     */
    default ConsumerEx4c andThenChar(ConsumerEx4c after)
    {
    	/*
     ...
     * 
     * @return A new {@link ConsumerEx4c} performing this operation and the operations after.
     */
	default ConsumerEx4c andThenChar(ConsumerEx4c... after)
    {
		/*
     ...
     * @return A new {@link ConsumerEx4c} performing this operation and the operations after.
     */
	default ConsumerEx4c andThenChar(Iterable<ConsumerEx4c> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx4c} performing the operation before and this operation.
     */
    default ConsumerEx4c beforeThatChar(ConsumerEx4c before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx4c} performing the operations before and this operation.
     */
    default ConsumerEx4c beforeThatChar(ConsumerEx4c... before)
    {
    	/*
     ...
     * @return A new {@link ConsumerEx4c} performing the operations before and this operation.
     */
    default ConsumerEx4c beforeThatChar(Iterable<ConsumerEx4c> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link ConsumerEx4c} performing the given operations in sequence.
     * 
     * @param consumers The operations to perform.
     * 
     * @return A new {@link ConsumerEx4c} performing the operations.
     */
	static ConsumerEx4c inSequenceChar(ConsumerEx4c... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null.
    	 * Also no entry must be null.
     ...
     * @return A new {@link ConsumerEx4c} performing the operations.
     */
    static ConsumerEx4c inSequenceChar(Iterable<ConsumerEx4c> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx4c} performing this operation and the operation after.
     */
    default ConsumerEx4c andThen(ConsumerEx4<Character,Character,Character,Character> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx4c} performing this operation and the operations after.
     */
	default ConsumerEx4c andThen(Iterable<ConsumerEx4<Character,Character,Character,Character>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx4c} performing the operation before and this operation.
     */
    default ConsumerEx4c beforeThat(ConsumerEx4<Character,Character,Character,Character> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx4c} performing the operations before and this operation.
     */
    default ConsumerEx4c beforeThat(Iterable<ConsumerEx4<Character,Character,Character,Character>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx4c inSequence(ConsumerEx4<Character,Character,Character,Character>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null.
    	 * Also no entry must be null.
     ...
     * @return A new {@link ConsumerEx4c} performing the operations.
     */
    static ConsumerEx4c inSequence(Iterable<ConsumerEx4<Character,Character,Character,Character>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
