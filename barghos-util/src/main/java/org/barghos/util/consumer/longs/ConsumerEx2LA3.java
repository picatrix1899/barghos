...
public interface ConsumerEx2LA3 extends ConsumerEx2<long[][][],long[][][]>
{
     ...
     * operation after.
     */
    default ConsumerEx2LA3 thenLong(ConsumerEx2LA3 after)
    {
	...
	default ConsumerEx2LA3 thenLong(ConsumerEx2LA3... after)
    {
    	...
    	return (a, b) -> {acceptLongArray(a, b); for(ConsumerEx2LA3 consumer : after) consumer.acceptLongArray(a, b);};
    }
     ...
     * this operation.
     */
    default ConsumerEx2LA3 beforeLong(ConsumerEx2LA3 before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx2LA3} performing the operations before and
     * this operation.
     */
    default ConsumerEx2LA3 beforeLong(ConsumerEx2LA3... before)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2LA3 consumer : before) consumer.acceptLongArray(a, b); acceptLongArray(a, b);};
    }
     ...
     */
	static ConsumerEx2LA3 sequenceLong(ConsumerEx2LA3... consumers)
    {
    	...
    	return (a, b) -> {for(ConsumerEx2LA3 consumer : consumers) consumer.acceptLongArray(a, b);};
    }
    ...
    default ConsumerEx2LA3 then(ConsumerEx2<long[][][],long[][][]> after)
    {
		 ...
		 */
    	if(after instanceof ConsumerEx2LA3)
    	{
    		final ConsumerEx2LA3 originalAfter = (ConsumerEx2LA3)after;
	...
	default ConsumerEx2LA3 then(ConsumerEx2<long[][][],long[][][]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof ConsumerEx2LA3)
        	{
        		final ConsumerEx2LA3 originalAfter = (ConsumerEx2LA3)after[0];
    	...
    	return (a, b) -> {
    		...
    		{
    			if(consumer instanceof ConsumerEx2LA3)
    				((ConsumerEx2LA3)consumer).acceptLongArray(a, b);
    			else
    				consumer.accept(a, b);
    		}
    	};
    ...
    default ConsumerEx2LA3 before(ConsumerEx2<long[][][],long[][][]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof ConsumerEx2LA3)
    	{
    		final ConsumerEx2LA3 originalBefore = (ConsumerEx2LA3)before;
    ...
    default ConsumerEx2LA3 before(ConsumerEx2<long[][][],long[][][]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof ConsumerEx2LA3)
        	{
        		final ConsumerEx2LA3 originalBefore = (ConsumerEx2LA3)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx2LA3 sequence(ConsumerEx2<long[][][],long[][][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof ConsumerEx2LA3)
    			return (ConsumerEx2LA3) consumers[0];
    		else
    			return (ConsumerEx2LA3) consumers[0]::accept;
    	}
