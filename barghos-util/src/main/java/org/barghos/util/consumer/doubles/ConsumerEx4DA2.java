...
public interface ConsumerEx4DA2 extends ConsumerEx4<double[][],double[][],double[][],double[][]>
{
	 ...
	 */
	void accept4DA2(double[][] a, double[][] b, double[][] c, double[][] d) throws Exception;
	 ...
	 * operation after.
	 */
	default ConsumerEx4DA2 then4DA2(ConsumerEx4DA2 after)
	{
	 ...
	 * this operation.
	 */
	default ConsumerEx4DA2 before4DA2(ConsumerEx4DA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4DA2 of4DA2(ConsumerEx4DA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4DA2 consumer : consumers) consumer.accept4DA2(a, b, c, d); };
	}
	 ...
	 */
	@Override
	default ConsumerEx4DA2 then(ConsumerEx4<double[][],double[][],double[][],double[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx4DA2 before(ConsumerEx4<double[][],double[][],double[][],double[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4DA2 of(ConsumerEx4<double[][],double[][],double[][],double[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
