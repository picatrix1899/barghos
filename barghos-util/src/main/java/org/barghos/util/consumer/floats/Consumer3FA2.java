...
public interface Consumer3FA2 extends Consumer3<float[][],float[][],float[][]>
{
     ...
     */
    void acceptFloat2DArray(float[][] a, float[][] b, float[][] c);
     ...
     * operation after.
     */
    default Consumer3FA2 thenFloat2DArray(Consumer3FA2 after)
    {
     ...
     * 
     * @return A new {@link Consumer3FA2} performing the operation before and this
     * operation.
     */
    default Consumer3FA2 beforeFloat2DArray(Consumer3FA2 before)
    {
    ...
    static Consumer3FA2 of(Consumer3FA2... consumers)
    {
    	...
    	return (a, b, c) -> {
    		for(Consumer3FA2 consumer : consumers)
    		{
	...
	static Consumer3FA2 of(Consumer3<float[][],float[][],float[][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (Consumer3FA2) consumers[0]::accept;
    	}
