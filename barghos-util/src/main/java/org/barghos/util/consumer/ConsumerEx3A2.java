...
/**
 * Represents an operation that accepts three 2-dimensional array input argument and returns no
 * result.
 * Unlike {@link Consumer3A2} this may throw Exceptions.
...
public interface ConsumerEx3A2<A,B,C> extends ConsumerEx3<A[][],B[][],C[][]>
{
     ...
     * 
     * @return A new {@link ConsumerEx3A2} performing this operation and the operation after.
     */
    default ConsumerEx3A2<A,B,C> andThenArray(ConsumerEx3A2<A,B,C> after)
    {
    	/*
     ...
     * 
     * @return A new {@link ConsumerEx3A2} performing this operation and the operations after.
     */
     ...
     * @return A new {@link ConsumerEx3A2} performing this operation and the operations after.
     */
	default ConsumerEx3A2<A,B,C> andThenArray(Iterable<ConsumerEx3A2<A,B,C>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerEx3A2} performing the operation before and this operation.
     */
    default ConsumerEx3A2<A,B,C> beforeThatArray(ConsumerEx3A2<A,B,C> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @param before The operations to perform before this operation.
     * 
     * @return A new {@link ConsumerEx3A2} performing the operations before and this operation.
     */
    default ConsumerEx3A2<A,B,C> beforeThatArray(Iterable<ConsumerEx3A2<A,B,C>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link ConsumerEx3A2} performing the given operations in sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     * @param <C> The type of the third argument to the operation.
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B,C> ConsumerEx3A2<A,B,C> inSequenceArray(ConsumerEx3A2<A,B,C>... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link ConsumerEx3A2} performing the operations.
     */
    static <A,B,C> ConsumerEx3A2<A,B,C> inSequenceArray(Iterable<ConsumerEx3A2<A,B,C>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx3A2} performing this operation and the operation after.
     */
    default ConsumerEx3A2<A,B,C> andThen(ConsumerEx3<A[][],B[][],C[][]> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx3A2} performing this operation and the operations after.
     */
	default ConsumerEx3A2<A,B,C> andThen(Iterable<ConsumerEx3<A[][],B[][],C[][]>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx3A2} performing the operation before and this operation.
     */
    default ConsumerEx3A2<A,B,C> beforeThat(ConsumerEx3<A[][],B[][],C[][]> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerEx3A2} performing the operations before and this operation.
     */
    default ConsumerEx3A2<A,B,C> beforeThat(Iterable<ConsumerEx3<A[][],B[][],C[][]>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B,C> ConsumerEx3A2<A,B,C> inSequence(ConsumerEx3<A[][],B[][],C[][]>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link ConsumerEx3A2} performing the operations.
     */
    static <A,B,C> ConsumerEx3A2<A,B,C> inSequence(Iterable<ConsumerEx3<A[][],B[][],C[][]>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Adds exception handling to the consumer and thus converts it into a {@link Consumer3A2}.
     * 
     * @param handler The exception handler called in case of an exception.
     * 
     * @return A new {@link Consumer3A2} performing the operations and exception handling.
     */
     ...
     * consumer may throw an exception the returned consumer is again a {@link ConsumerEx3A2}
    ...
    /**
     * Performs the passed operation in case of an exception in this consumer. As the passed
     * consumer can not throw an exception the returned consumer is a {@link Consumer3A2}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
