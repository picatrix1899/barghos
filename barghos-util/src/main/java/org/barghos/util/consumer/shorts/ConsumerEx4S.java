...
public interface ConsumerEx4S extends ConsumerEx4<Short,Short,Short,Short>
{
	 ...
	 */
	void accept4S(short a, short b, short c, short d) throws Exception;
	 ...
	 * operation after.
	 */
	default ConsumerEx4S then4S(ConsumerEx4S after)
	{
	 ...
	 * this operation.
	 */
	default ConsumerEx4S before4S(ConsumerEx4S before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4S of4S(ConsumerEx4S... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4S consumer : consumers) consumer.accept4S(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4S of(ConsumerEx4<Short,Short,Short,Short>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
