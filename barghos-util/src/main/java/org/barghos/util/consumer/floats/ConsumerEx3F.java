 ...
 * no result. Unlike {@link Consumer3F} this may throw exceptions.
...
public interface ConsumerEx3F extends ConsumerEx3<Float,Float,Float>
{
     ...
     * operation after.
     */
    default ConsumerEx3F thenFloat(ConsumerEx3F after)
    {
     ...
     * this operation.
     */
    default ConsumerEx3F beforeFloat(ConsumerEx3F before)
    {
    	ParameterValidation.pvNotNull("before", before);
    	
    	return (a, b, c) -> {
    		before.acceptFloat(a, b, c);
    ...
    static ConsumerEx3F of(ConsumerEx3F... consumers)
    {
    	...
    	return (a, b, c) -> {
    		for(ConsumerEx3F consumer : consumers)
    		{
    			consumer.acceptFloat(a, b, c);
    		}
    	};
    }
    ...
    /**
     * @deprecated
     * Use {@link #acceptFloat(float, float, float)} instead.
     */
    @Override
