 ...
 * and returns no result. {@link ConsumerA2} is expected to operate via
 * side-effects.
 *
 * <p>
...
public interface ConsumerA2<A> extends Consumer<A[][]>
{
     ...
     * 
     * @return A new {@link ConsumerA2} performing this operation and the
     * operation after.
     */
    default ConsumerA2<A> thenArray(ConsumerA2<A> after)
    {
     ...
     * operations after.
     */
	default ConsumerA2<A> thenArray(java.util.List<ConsumerA2<A>> after)
    {
		Validation.validateNotNull("after", after);
		Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default ConsumerA2<A> thenArray(Iterable<ConsumerA2<A>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * 
     * @return A new {@link ConsumerA2} performing the operation before and this
     * operation.
     */
    default ConsumerA2<A> beforeArray(ConsumerA2<A> before)
    {
     ...
     * 
     * @return A new {@link ConsumerA2} performing the operations before and
     * this operation.
     */
    @SuppressWarnings("unchecked")
	default ConsumerA2<A> beforeArray(ConsumerA2<A>... before)
     ...
     * this operation.
     */
	default ConsumerA2<A> beforeArray(java.util.List<ConsumerA2<A>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * this operation.
     */
    default ConsumerA2<A> beforeArray(Iterable<ConsumerA2<A>> before)
    {
    	Validation.validateNotNull("before", before);
    ...
    /**
     * Composes a new {@link ConsumerA2} performing the given operations in
     * sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * 
     ...
     */
	@SuppressWarnings("unchecked")
	static <A> ConsumerA2<A> sequenceArray(ConsumerA2<A>... consumers)
    {
     ...
     * @return A new {@link ConsumerA2} performing the operations.
     */
	static <A> ConsumerA2<A> sequenceArray(java.util.List<ConsumerA2<A>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link ConsumerA2} performing the operations.
     */
    static <A> ConsumerA2<A> sequenceArray(Iterable<ConsumerA2<A>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default ConsumerA2<A> then(Consumer<A[][]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default ConsumerA2<A> then(java.util.List<Consumer<A[][]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(first instanceof ConsumerA2<A>)
        	{
        		final ConsumerA2<A> originalAfter = (ConsumerA2<A>)first;
     ...
     * operations after.
     */
	default ConsumerA2<A> then(Iterable<Consumer<A[][]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * operation.
     */
    default ConsumerA2<A> before(Consumer<A[][]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default ConsumerA2<A> before(java.util.List<Consumer<A[][]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof ConsumerA2<A>)
        	{
        		final ConsumerA2<A> originalBefore = (ConsumerA2<A>)first;
     ...
     * this operation.
     */
    default ConsumerA2<A> before(Iterable<Consumer<A[][]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A> ConsumerA2<A> sequence(Consumer<A[][]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link ConsumerA2} performing the operations.
     */
	static <A> ConsumerA2<A> sequence(java.util.List<Consumer<A[][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof ConsumerA2<A>)
    			return (ConsumerA2<A>) first;
    		else
    			return (ConsumerA2<A>) first::accept;
    	}
     ...
     * @return A new {@link ConsumerA2} performing the operations.
     */
    static <A> ConsumerA2<A> sequence(Iterable<Consumer<A[][]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
