...
public interface Consumer3IA extends Consumer3<int[],int[],int[]>
{
     ...
     * operation after.
     */
    default Consumer3IA thenInt(Consumer3IA after)
    {
	...
	default Consumer3IA thenInt(Consumer3IA... after)
    {
    	...
    	return (a, b, c) -> {acceptIntArray(a, b, c); for(Consumer3IA consumer : after) consumer.acceptIntArray(a, b, c);};
    }
     ...
     * 
     * @return A new {@link Consumer3IA} performing the operation before and this
     * operation.
     */
    default Consumer3IA beforeInt(Consumer3IA before)
    {
     ...
     * 
     * @return A new {@link Consumer3IA} performing the operations before and
     * this operation.
     */
    default Consumer3IA beforeInt(Consumer3IA... before)
    {
    	...
    	return (a, b, c) -> {for(Consumer3IA consumer : before) consumer.acceptIntArray(a, b, c); acceptIntArray(a, b, c);};
    }
     ...
     */
	static Consumer3IA sequenceInt(Consumer3IA... consumers)
    {
    	...
    	return (a, b, c) -> {for(Consumer3IA consumer : consumers) consumer.acceptIntArray(a, b, c);};
    }
    ...
    default Consumer3IA then(Consumer3<int[],int[],int[]> after)
    {
		 ...
		 */
    	if(after instanceof Consumer3IA)
    	{
    		final Consumer3IA originalAfter = (Consumer3IA)after;
	...
	default Consumer3IA then(Consumer3<int[],int[],int[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
    		 ...
    		 */
    		if(after[0] instanceof Consumer3IA)
        	{
        		final Consumer3IA originalAfter = (Consumer3IA)after[0];
    	...
    	return (a, b, c) -> {
    		...
    		{
    			if(consumer instanceof Consumer3IA)
    				((Consumer3IA)consumer).acceptIntArray(a, b, c);
    			else
    ...
    default Consumer3IA before(Consumer3<int[],int[],int[]> before)
    {
		 ...
		 * the desired type to avoid boxing.
		 */
    	if(before instanceof Consumer3IA)
    	{
    		final Consumer3IA originalBefore = (Consumer3IA)before;
    ...
    default Consumer3IA before(Consumer3<int[],int[],int[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
    		 ...
    		 * as the desired type to avoid boxing.
    		 */
    		if(before[0] instanceof Consumer3IA)
        	{
        		final Consumer3IA originalBefore = (Consumer3IA)before[0];
     ...
     */
    @SuppressWarnings("unchecked")
	static Consumer3IA sequence(Consumer3<int[],int[],int[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	{
    		if(consumers[0] instanceof Consumer3IA)
    			return (Consumer3IA) consumers[0];
    		else
    			return (Consumer3IA) consumers[0]::accept;
    	}
