...
public interface Consumer4Bigi extends Consumer4<BigInteger,BigInteger,BigInteger,BigInteger>
{
	 ...
	 */
	void accept4Bigi(BigInteger a, BigInteger b, BigInteger c, BigInteger d);
	 ...
	 * operation after.
	 */
	default Consumer4Bigi then4Bigi(Consumer4Bigi after)
	{
	 ...
	 * this operation.
	 */
	default Consumer4Bigi before4Bigi(Consumer4Bigi before)
	{
	 ...
	 */
	@SafeVarargs
	static Consumer4Bigi of4Bigi(Consumer4Bigi... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4Bigi consumer : consumers) consumer.accept4Bigi(a, b, c, d); };
	}
	
	/**
	 * @deprecated Use {@link #accept4Bigi(BigInteger, BigInteger, BigInteger, BigInteger)}
	 * instead.
	 */
	@Override
	 ...
	 */
	@Override
	default Consumer4Bigi then(Consumer4<BigInteger,BigInteger,BigInteger,BigInteger> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default Consumer4Bigi before(Consumer4<BigInteger,BigInteger,BigInteger,BigInteger> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer4Bigi of(Consumer4<BigInteger,BigInteger,BigInteger,BigInteger>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
