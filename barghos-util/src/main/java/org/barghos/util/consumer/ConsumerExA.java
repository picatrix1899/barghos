 ...
 * result.
 * Unlike {@link ConsumerA} this may throw Exceptions.
...
public interface ConsumerExA<A> extends ConsumerEx<A[]>
{
     ...
     * 
     * @return A new {@link ConsumerExA} performing this operation and the operation after.
     */
    default ConsumerExA<A> andThenArray(ConsumerExA<A> after)
    {
    	/*
     ...
     * 
     * @return A new {@link ConsumerExA} performing this operation and the operations after.
     */
     ...
     * @return A new {@link ConsumerExA} performing this operation and the operations after.
     */
	default ConsumerExA<A> andThenArray(Iterable<ConsumerExA<A>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerExA} performing the operation before and this operation.
     */
    default ConsumerExA<A> beforeThatArray(ConsumerExA<A> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * 
     * @return A new {@link ConsumerExA} performing the operations before and this operation.
     */
    @SuppressWarnings("unchecked")
	default ConsumerExA<A> beforeThatArray(ConsumerExA<A>... before)
    {
     ...
     * @return A new {@link ConsumerExA} performing the operations before and this operation.
     */
    default ConsumerExA<A> beforeThatArray(Iterable<ConsumerExA<A>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Composes a new {@link ConsumerExA} performing the given operations in sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * 
     ...
     */
	@SuppressWarnings("unchecked")
	static <A> ConsumerExA<A> inSequenceArray(ConsumerExA<A>... consumers)
    {
		/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link ConsumerExA} performing the operations.
     */
    static <A> ConsumerExA<A> inSequenceArray(Iterable<ConsumerExA<A>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerExA} performing this operation and the operation after.
     */
    default ConsumerExA<A> andThen(ConsumerEx<A[]> after)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerExA} performing this operation and the operations after.
     */
	default ConsumerExA<A> andThen(Iterable<ConsumerEx<A[]>> after)
    {
		/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerExA} performing the operation before and this operation.
     */
    default ConsumerExA<A> beforeThat(ConsumerEx<A[]> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     * @return A new {@link ConsumerExA} performing the operations before and this operation.
     */
    default ConsumerExA<A> beforeThat(Iterable<ConsumerEx<A[]>> before)
    {
    	/*
    	 * The argument must not be null.
    	 */
     ...
     */
    @SuppressWarnings("unchecked")
	static <A> ConsumerExA<A> inSequence(ConsumerEx<A[]>... consumers)
    {
    	/*
    	 * The argument array can be empty but must not be null. Also no entry must be null.
    	 */
     ...
     * @return A new {@link ConsumerExA} performing the operations.
     */
    static <A> ConsumerExA<A> inSequence(Iterable<ConsumerEx<A[]>> consumers)
    {
    	/*
    	 * The argument must not be null.
    	 */
    ...
    /**
     * Adds exception handling to the consumer and thus converts it into a {@link ConsumerA}.
     * 
     * @param handler The exception handler called in case of an exception.
     * 
     * @return A new {@link ConsumerA} performing the operations and exception handling.
     */
     ...
     * consumer may throw an exception the returned consumer is again a {@link ConsumerExA} relaying
    ...
    /**
     * Performs the passed operation in case of an exception in this consumer. As the passed
     * consumer can not throw an exception the returned consumer is a {@link ConsumerA}.
     * 
     * @param consumer The consumer called in case of an exception.
     * 
