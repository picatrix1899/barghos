...
public interface ConsumerEx4BigdA2 extends ConsumerEx4<BigDecimal[][],BigDecimal[][],BigDecimal[][],BigDecimal[][]>
{
	...
	@Override
	default ConsumerEx4BigdA2 then(Consumer4<? super BigDecimal[][],? super BigDecimal[][],? super BigDecimal[][],? super BigDecimal[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	...
	@Override
	default ConsumerEx4BigdA2 before(Consumer4<? super BigDecimal[][],? super BigDecimal[][],? super BigDecimal[][],? super BigDecimal[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
