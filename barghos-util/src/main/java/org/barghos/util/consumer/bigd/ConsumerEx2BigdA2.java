...
public interface ConsumerEx2BigdA2 extends ConsumerEx2<BigDecimal[][],BigDecimal[][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2BigdA2 then(Consumer2BigdA2 after)
	{
		Validate.Arg.checkNotNull("after", after);
	...
	@Override
	default ConsumerEx2BigdA2 then(Consumer2<? super BigDecimal[][],? super BigDecimal[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * and this operation.
	 */
	default ConsumerEx2BigdA2 before(Consumer2BigdA2 before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	@Override
	default ConsumerEx2BigdA2 before(Consumer2<? super BigDecimal[][],? super BigDecimal[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
