...
public interface ConsumerEx4BigiA2 extends ConsumerEx4<BigInteger[][],BigInteger[][],BigInteger[][],BigInteger[][]>
{
	 ...
	 */
	void accept4BigiA2(BigInteger[][] a, BigInteger[][] b, BigInteger[][] c, BigInteger[][] d) throws Exception;
	 ...
	 * operation after.
	 */
	default ConsumerEx4BigiA2 then4BigiA2(ConsumerEx4BigiA2 after)
	{
	 ...
	 * and this operation.
	 */
	default ConsumerEx4BigiA2 before4BigiA2(ConsumerEx4BigiA2 before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4BigiA2 of4BigiA2(ConsumerEx4BigiA2... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4BigiA2 consumer : consumers) consumer.accept4BigiA2(a, b, c, d); };
	}
	 ...
	 */
	@Override
	default ConsumerEx4BigiA2 then(ConsumerEx4<BigInteger[][],BigInteger[][],BigInteger[][],BigInteger[][]> after)
	{
		ParameterValidation.pvNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx4BigiA2 before(ConsumerEx4<BigInteger[][],BigInteger[][],BigInteger[][],BigInteger[][]> before)
	{
		ParameterValidation.pvNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4BigiA2 of(ConsumerEx4<BigInteger[][],BigInteger[][],BigInteger[][],BigInteger[][]>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
