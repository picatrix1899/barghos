 ...
 * no result. Unlike {@link Consumer3S} this may throw exceptions.
...
public interface ConsumerEx3S extends ConsumerEx3<Short,Short,Short>
{
     ...
     * operation after.
     */
    default ConsumerEx3S thenShort(ConsumerEx3S after)
    {
     ...
     * this operation.
     */
    default ConsumerEx3S beforeShort(ConsumerEx3S before)
    {
     ...
     * 
     * @return A new {@link ConsumerEx3S} performing the operations before and
     * this operation.
     */
    default ConsumerEx3S beforeShort(ConsumerEx3S... before)
    {
     ...
     */
	static ConsumerEx3S sequenceShort(ConsumerEx3S... consumers)
    {
     ...
     * operation after.
     */
    default ConsumerEx3S then(ConsumerEx3<Short,Short,Short> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * this operation.
     */
    default ConsumerEx3S before(ConsumerEx3<Short,Short,Short> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerEx3S sequence(ConsumerEx3<Short,Short,Short>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
