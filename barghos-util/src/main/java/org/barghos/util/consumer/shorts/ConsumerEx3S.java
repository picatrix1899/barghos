...
public interface ConsumerEx3S extends ConsumerEx3<Short,Short,Short>
{
	 ...
	 */
	void accept3S(short a, short b, short c) throws Exception;
	 ...
	 * operation after.
	 */
	default ConsumerEx3S then3S(ConsumerEx3S after)
	{
	 ...
	 * this operation.
	 */
	default ConsumerEx3S before3S(ConsumerEx3S before)
	{
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3S of3S(ConsumerEx3S... consumers)
	{
		...
		return (a, b, c) -> { for(ConsumerEx3S consumer : consumers) consumer.accept3S(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3S of(ConsumerEx3<Short,Short,Short>... consumers)
	{
		ParameterValidation.pvNotNull("consumers", consumers);
		ParameterValidation.pvEntriesNotNull("consumers", consumers);
