 ...
 * {@link #acceptFloat3DArray(float[][][], float[][][], float[][][], float[][][])}.
 * 
 * @see ConsumerFA3
 * @see ConsumerExFA3
 * @see Consumer2FA3
...
public interface Consumer4FA3 extends Consumer4<float[][][],float[][][],float[][][],float[][][]>
{
     ...
     */
    void acceptFloat3DArray(float[][][] a, float[][][] b, float[][][] c, float[][][] d);
     ...
     * operation after.
     */
    default Consumer4FA3 thenFloat3DArray(Consumer4FA3 after)
    {
    	ParameterValidation.pvNotNull("after", after);
    	
    	return (a, b, c, d) -> {
    		acceptFloat3DArray(a, b, c, d);
    		
    		after.acceptFloat3DArray(a, b, c, d);
    	};
    }
     ...
     * 
     * @return A new {@link Consumer4FA3} performing the operation before and this
     * operation.
     */
    default Consumer4FA3 beforeFloat3DArray(Consumer4FA3 before)
    {
    	ParameterValidation.pvNotNull("before", before);
    	
    	return (a, b, c, d) -> {
    		before.acceptFloat3DArray(a, b, c, d);
    ...
    static Consumer4FA3 of(Consumer4FA3... consumers)
    {
    	...
    	return (a, b, c, d) -> {
    		for(Consumer4FA3 consumer : consumers)
    		{
    			consumer.acceptFloat3DArray(a, b, c, d);
    		}
    	};
    }
	...
	static Consumer4FA3 of(Consumer4<float[][][],float[][][],float[][][],float[][][]>... consumers)
    {
    	...
    	if(consumers.length == 1)
    	{
    		return (Consumer4FA3) consumers[0]::accept;
    	}
