 ...
 * result. Unlike {@link ConsumerL} this may throw exceptions.
...
public interface ConsumerExL extends ConsumerEx<Long>
{
     ...
     * operation after.
     */
    default ConsumerExL thenLong(ConsumerExL after)
    {
     ...
     * this operation.
     */
    default ConsumerExL beforeLong(ConsumerExL before)
    {
     ...
     * 
     * @return A new {@link ConsumerExL} performing the operations before and
     * this operation.
     */
    default ConsumerExL beforeLong(ConsumerExL... before)
    {
     ...
     */
	static ConsumerExL sequenceLong(ConsumerExL... consumers)
    {
     ...
     */
    @SuppressWarnings("unchecked")
	static ConsumerExL sequence(ConsumerEx<Long>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
