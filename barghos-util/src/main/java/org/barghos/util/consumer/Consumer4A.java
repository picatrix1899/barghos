 ...
 */
@FunctionalInterface
public interface Consumer4A<A,B,C,D>extends Consumer4<A[],B[],C[],D[]>
{
	/**
    ...
    default Consumer4A<A,B,C,D> andThen(Consumer4<A[],B[],C[],D[]> after)
    {
    	...
    	{
    		final Consumer4A<A,B,C,D> originalAfter = (Consumer4A<A,B,C,D>)after;
	...
	default Consumer4A<A,B,C,D> andThen(Consumer4<A[],B[],C[],D[]>... after)
    {
    	...
    	if(after.length == 1)
    	{
        	...
        	{
        		final Consumer4A<A,B,C,D> originalAfter = (Consumer4A<A,B,C,D>)after[0];
    ...
    default Consumer4A<A,B,C,D> beforeThat(Consumer4<A[],B[],C[],D[]> before)
    {
    	...
    	{
    		final Consumer4A<A,B,C,D> originalBefore = (Consumer4A<A,B,C,D>)before;
    ...
    default Consumer4A<A,B,C,D> beforeThat(Consumer4<A[],B[],C[],D[]>... before)
    {
    	...
    	if(before.length == 1)
    	{
        	...
        	{
        		final Consumer4A<A,B,C,D> originalBefore = (Consumer4A<A,B,C,D>)before[0];
	...
	static <A,B,C,D> Consumer4A<A,B,C,D> inSequence(Consumer4<A[],B[],C[],D[]>... consumers)
    {
    	...
    	{
    		if(consumers[0] instanceof Consumer4A<A,B,C,D>)
    			return (Consumer4A<A,B,C,D>) consumers[0];
    		else
    			return (Consumer4A<A,B,C,D>) consumers[0]::accept;
    	}
