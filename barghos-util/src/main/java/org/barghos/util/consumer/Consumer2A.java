...
public interface Consumer2A<A,B> extends Consumer2<A[],B[]>
{
     ...
     * operation after.
     */
    default Consumer2A<A,B> thenArray(Consumer2A<A,B> after)
    {
     ...
     * operations after.
     */
	default Consumer2A<A,B> thenArray(java.util.List<Consumer2A<A,B>> after)
    {
		Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer2A<A,B> thenArray(Iterable<Consumer2A<A,B>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * operation.
     */
    default Consumer2A<A,B> beforeArray(Consumer2A<A,B> before)
    {
     ...
     * this operation.
     */
	default Consumer2A<A,B> beforeArray(java.util.List<Consumer2A<A,B>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer2A<A,B> beforeArray(Iterable<Consumer2A<A,B>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
	@SuppressWarnings("unchecked")
	static <A,B> Consumer2A<A,B> sequenceArray(Consumer2A<A,B>... consumers)
    {
     ...
     * @return A new {@link Consumer2A} performing the operations.
     */
	static <A,B> Consumer2A<A,B> sequenceArray(java.util.List<Consumer2A<A,B>> consumers)
    {
		Validation.validateNotNull("consumers", consumers);
		Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer2A} performing the operations.
     */
    static <A,B> Consumer2A<A,B> sequenceArray(Iterable<Consumer2A<A,B>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
     ...
     * operation after.
     */
    default Consumer2A<A,B> then(Consumer2<A[],B[]> after)
    {
    	Validation.validateNotNull("after", after);
     ...
     * operations after.
     */
	default Consumer2A<A,B> then(java.util.List<Consumer2<A[],B[]>> after)
    {
    	Validation.validateNotNull("after", after);
    	Validation.validateEntriesNotNull("after", after);
    	...
    	if(size == 1)
    	{
    		 ...
    		 * to avoid boxing.
    		 */
    		if(first instanceof Consumer2A<A,B>)
        	{
        		final Consumer2A<A,B> originalAfter = (Consumer2A<A,B>)first;
     ...
     * operations after.
     */
	default Consumer2A<A,B> then(Iterable<Consumer2<A[],B[]>> after)
    {
		Validation.validateNotNull("after", after);
     ...
     * operation.
     */
    default Consumer2A<A,B> before(Consumer2<A[],B[]> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     * this operation.
     */
    default Consumer2A<A,B> before(java.util.List<Consumer2<A[],B[]>> before)
    {
    	Validation.validateNotNull("before", before);
    	Validation.validateEntriesNotNull("before", before);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer2A<A,B>)
        	{
        		final Consumer2A<A,B> originalBefore = (Consumer2A<A,B>)first;
     ...
     * this operation.
     */
    default Consumer2A<A,B> before(Iterable<Consumer2<A[],B[]>> before)
    {
    	Validation.validateNotNull("before", before);
     ...
     */
    @SuppressWarnings("unchecked")
	static <A,B> Consumer2A<A,B> sequence(Consumer2<A[],B[]>... consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
     ...
     * @return A new {@link Consumer2A} performing the operations.
     */
	static <A,B> Consumer2A<A,B> sequence(java.util.List<Consumer2<A[],B[]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
    	Validation.validateEntriesNotNull("consumers", consumers);
    	...
    	if(size == 1)
    	{
    		...
    		if(first instanceof Consumer2A<A,B>)
    			return (Consumer2A<A,B>) first;
    		else
    			return (Consumer2A<A,B>) first::accept;
    	}
     ...
     * @return A new {@link Consumer2A} performing the operations.
     */
    static <A,B> Consumer2A<A,B> sequence(Iterable<Consumer2<A[],B[]>> consumers)
    {
    	Validation.validateNotNull("consumers", consumers);
