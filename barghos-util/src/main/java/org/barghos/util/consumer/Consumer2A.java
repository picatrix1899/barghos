...
/**
 * Represents an operation that accepts two 1-dimensional array input arguments and returns no
 * result.
 * {@link Consumer2A} is expected to operate via side-effects.
 *
 * <p>
...
public interface Consumer2A<A,B> extends Consumer2<A[],B[]>
{
     ...
     * 
     * @return A new {@link Consumer2A} performing this operation and the operation after.
     */
     ...
     * 
     * @return A new {@link Consumer2A} performing this operation and the operations after.
     */
     ...
     * 
     * @return A new {@link Consumer2A} performing the operation before and this operation.
     */
     ...
     * 
     * @return A new {@link Consumer2A} performing the operations before and this operation.
     */
    @SuppressWarnings("unchecked")
	default Consumer2A<A,B> beforeThatArray(Consumer2A<A,B>... before)
    {
    ...
    /**
     * Composes a new {@link Consumer2A} performing the given operations in sequence.
     * 
     * @param <A> The type of the first argument to the operation.
     * @param <B> The type of the second argument to the operation.
     * 
