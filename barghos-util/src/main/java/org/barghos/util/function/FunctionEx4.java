 ...
 * Unlike {@link Function4} this may throw Exceptions.
 * 
 * <p>
 ...
 */
@FunctionalInterface
public interface FunctionEx4<A,B,C,D,T>
{
	/**
	 ...
	 */
	T apply(A a, B b, C c, D d) throws Exception;
     ...
     */
    default <V> FunctionEx4<A,B,C,D,V> andThen(Function<T,V> after)
    {
