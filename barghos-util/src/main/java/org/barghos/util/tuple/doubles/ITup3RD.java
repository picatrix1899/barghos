 ...
 */
public interface ITup3RD extends ITupRD
{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link ITup3RD} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double tolerance, @AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(double tolerance, int index, @AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(double tolerance, @AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(double tolerance, @AllowNull ITup3RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(double tolerance, @AllowNull ITup3RD t);
