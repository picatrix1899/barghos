...
/**
 * This interface provides common operations for short tuples with a
 ...
 */
public interface WTupleBaseS extends RTupleBaseS
{
	/**
	 ...
	 * this tuple.
	 */
	WTupleBaseS createNew();
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseS createNew(RTupleBaseS t);
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseS createNew(short... t);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseS setAt(@IntMinValue(0) int index, short value);
	...
	/** {@inheritDoc}} */
	@Override
	WTupleBaseS arrangeN(@IntMinValue(0) int... indices);
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseS swizzleN(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseS arrange(@IntMinValue(0) int... indices);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseS swizzle(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
}
