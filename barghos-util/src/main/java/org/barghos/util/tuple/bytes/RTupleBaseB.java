...
/**
 * This interface provides non-modifying operations for byte tuples with an
...
public interface RTupleBaseB
{
	 ...
	 * component values.
	 */
	RTupleBaseB createNew(RTupleBaseB t);
	 ...
	 */
	byte getAt(@IntMinValue(0) int index);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean zero(@ByteMinValue(0) byte tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean zeroAt(@ByteMinValue(0) byte tolerance, @IntMinValue(0) int index);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable RTupleBaseB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@ByteMinValue(0) byte tolerance, @Nullable RTupleBaseB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@ByteMinValue(0) byte tolerance, @Nullable byte... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@ByteMinValue(0) byte tolerance, byte value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, @Nullable RTupleBaseB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, @Nullable byte... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, byte value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@ByteMinValue(0) byte tolerance, @IntMinValue(0) int index, @Nullable RTupleBaseB t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0. A tolerance of 0 behaves like
	 * {@link #equalsAt(int, byte[]) equalsAt(int, byte...)}.
	 * 
	 * <p>
	 * The valid index range is from 0 to {@link #size()} - 1.
	 * 
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@ByteMinValue(0) byte tolerance, @IntMinValue(0) int index, @Nullable byte... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@ByteMinValue(0) byte tolerance, @IntMinValue(0) int index, byte value);
	 ...
	 */
	RTupleBaseB arrangeN(@IntMinValue(0) int... indices);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	RTupleBaseB swizzleN(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, RTupleBaseB t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0. A tolerance of 0 behaves like
	 * {@link #compareAt(int, RTupleBaseB) compareAt(int, RTupleBaseB)}.
	 * 
     * <p>
	 * The valid index range is from 0 to {@link #size()} - 1.
     *
     ...
     * the given tuple.
     */
	int compareAt(@ByteMinValue(0) byte tolerance, int index, @Nullable RTupleBaseB t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0. A tolerance of 0 behaves like
	 * {@link #compareAt(int, byte[]) compareAt(int, byte...)}.
	 * 
     * <p>
	 * The valid index range is from 0 to {@link #size()} - 1.
     *
     ...
     * the given tuple.
     */
	int compareAt(@ByteMinValue(0) byte tolerance, int index, @Nullable byte... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAt(@ByteMinValue(0) byte tolerance, int index, byte value);
}
