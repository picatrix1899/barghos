...
public interface Tup4sC extends Tup4sR, TupsC
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC createNew(TupsR t)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC createNew(Tup4sR t)
	{
		Validation.validateNotNull("t", t);
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC createNew(@MinLength(4) short[] t)
	{
		Validation.validateNotNull("t", t);
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC createNew(short value)
	{
	...
	/** {@inheritDoc}} */
	@Override
	Tup4sC createNew(short v0, short v1, short v2, short v3);
	 ...
	 * @return The current tuple.
	 */
	default Tup4sC set(short v0, short v1, short v2, short v3)
	{
		v0(v0);
		v1(v1);
		v2(v2);
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC setArray(@MinLength(4) short... t)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC rearrangeN(int[] indices)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sC swapByIndexN(int indexA, int indexB)
	{
