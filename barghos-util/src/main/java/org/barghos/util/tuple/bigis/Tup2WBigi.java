 ...
 * two components.
 */
public interface Tup2WBigi extends Tup2RBigi, FixTupWBigi
{
	/** {@inheritDoc} */
	@Override
	Tup2WBigi createNew(Tup2RBigi t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi createNew(TupRBigi t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi createNew(BigInteger... t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi createNew(BigInteger value);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi createNew(BigInteger v0, BigInteger v1);
	 ...
	 */
	@Override
	Tup2WBigi setAt(int index, BigInteger value);
	 ...
	 */
	@Override
	Tup2WBigi set(BigInteger... t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi set(BigInteger value);
	 ...
	 * @return This tuple.
	 */
	Tup2WBigi set(BigInteger v0, BigInteger v1);
	...
	/** {@inheritDoc} */
	@Override
	Tup2WBigi arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi arrangeN(int iV0, int iV1);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBigi swizzleV0V1N();
	 ...
	 * @return This tuple.
	 */
	Tup2WBigi arrange(int iV0, int iV1);
	 ...
	 */
	@Override
	Tup2WBigi swizzle(int indexA, int indexB);
