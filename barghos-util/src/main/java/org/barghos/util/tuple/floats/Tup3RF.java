...
public interface Tup3RF extends FixTupRF
{
	 ...
	 * component values.
	 */
	Tup3RF createNew(float v0, float v1, float v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RF} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(float tolerance, @Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(float tolerance, int index, @Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(float tolerance, @Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(float tolerance, @Nullable Tup3RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(float tolerance, @Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAt(float tolerance, int index, @Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAtV0(float tolerance, @Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAtV1(float tolerance, @Nullable Tup3RF t);
     ...
     * the given tuple.
     */
	int compareAtV2(float tolerance, @Nullable Tup3RF t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(float[]) compareAtV1(float...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
