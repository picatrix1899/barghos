...
import org.barghos.util.tuple.bools.Tup3boR;

/**
 * This interface provides non-invasive (read only) functions and methods for boolean tuples with three dimensions.
 */
