...
/**
 * This interface provides non-modifying operations for double tuples with a
 ...
 * tuple.
 */
public interface VarTupRD extends TupRD
{
	/**
	 ...
	 */
	VarTupRD arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRD swizzleN(int indexA, int indexB);
}
