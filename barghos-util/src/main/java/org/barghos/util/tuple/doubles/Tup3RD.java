 ...
 */
public interface Tup3RD extends FixTupRD
{
	/**
	 ...
	 * component values.
	 */
	Tup3RD createNew(double v0, double v1, double v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RD} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double v0, double v1, double v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double tolerance, double v0, double v1, double v2);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RD arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RD swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup3RD t);
     ...
     */
	@Override
	int compareAt(int index, TupRD t);
     ...
     */
	@Override
	int compareAt(int index, double... t);
     ...
     * the given tuple.
     */
	int compareAt(double tolerance, int index, Tup3RD t);
     ...
     */
	@Override
	int compareAt(double tolerance, int index, TupRD t);
     ...
     */
	@Override
	int compareAt(double tolerance, int index, double... t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, Tup3RD t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, double... t);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, Tup3RD t);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, double... t);
     ...
     * the given tuple.
     */
	int compareAtV2(double tolerance, Tup3RD t);
     ...
     * the given tuple.
     */
	int compareAtV2(double tolerance, TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV2(double tolerance, double... t);
