 ...
 * tuples with an implicitly fixed number of components. Therefore the
 * operations of this interface will not alter the component values of this
 * tuple, not the size of this tuple and will not create new tuple instances
 * with different sizes than the size of this tuple.
 */
public interface FixTupRBigi extends TupRBigi
{
	/**
	 ...
	 * component values.
	 */
	FixTupRBigi createNew(TupRBigi t);
	 ...
	 * values.
	 */
	FixTupRBigi createNew(BigInteger... t);
	 ...
	 */
	FixTupRBigi arrangeN(int... indices);
}
