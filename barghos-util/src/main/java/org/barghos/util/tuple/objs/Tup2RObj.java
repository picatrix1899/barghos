 ...
 */
public interface Tup2RObj extends FixTupRObj
{
	/**
	 ...
	 */
	Tup2RObj createNew(Object value);
	 ...
	 * component values.
	 */
	Tup2RObj createNew(Object v0, Object v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RObj} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@Nullable Tup2RObj t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(Object v0, Object v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup2RObj t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RObj t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup2RObj t);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup2RObj arrangeN(int i0, int i1);
	 ...
	 */
	@Override
	Tup2RObj swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup2RObj t);
     ...
     */
	@Override
	int compareAt(int index, TupRObj t);
     ...
     */
	@Override
	int compareAt(int index, Object... t);
