 ...
 * components.
 */
public interface Tup4WB extends Tup4RB, FixTupWB
{
	/** {@inheritDoc} */
	@Override
	Tup4WB createNew(Tup4RB t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WB createNew(TupRB t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WB createNew(byte... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WB createNew(byte value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WB createNew(byte v0, byte v1, byte v2, byte v3);
	 ...
	 */
	@Override
	Tup4WB setAt(int index, byte value);
	 ...
	 * @return This tuple.
	 */
	Tup4WB set(byte v0, byte v1, byte v2, byte v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WB arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WB arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WB swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup4WB arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WB swizzle(int indexA, int indexB);
