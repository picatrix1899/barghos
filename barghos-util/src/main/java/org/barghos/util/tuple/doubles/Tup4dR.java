...
import org.barghos.util.consumer.doubles.Consumer4d;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for
 * double tuples with four dimensions.
 */
public interface Tup4dR extends TupdR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4dR createNew(TupdR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4dR} this will be four.
	 * 
	...
	@Deprecated
	@Override
	default Tup4dR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4dR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup4dR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4dR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer4d consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptDouble(v0(), v1(), v2(), v3());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer4<Double,Double,Double,Double> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
