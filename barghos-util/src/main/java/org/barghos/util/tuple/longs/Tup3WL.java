 ...
 * components.
 */
public interface Tup3WL extends Tup3RL, FixTupWL
{
	/** {@inheritDoc} */
	@Override
	Tup3WL createNew(Tup3RL t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WL createNew(TupRL t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WL createNew(long... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WL createNew(long value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WL createNew(long v0, long v1, long v2);
	 ...
	 */
	@Override
	Tup3WL setAt(int index, long value);
	 ...
	 * @return This tuple.
	 */
	Tup3WL set(long v0, long v1, long v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WL arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WL arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WL swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup3WL arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WL swizzle(int indexA, int indexB);
