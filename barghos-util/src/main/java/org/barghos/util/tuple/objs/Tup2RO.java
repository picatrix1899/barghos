 ...
 */
public interface Tup2RO extends FixTupRO
{
	/**
	 ...
	 * component values.
	 */
	Tup2RO createNew(Object v0, Object v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RO} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 */
	@Override
	Tup2RO swizzleN(int indexA, int indexB);
