...
/**
 * This interface provides common operations for boolean tuples with two
 * components.
 */
public interface Tup2WBo extends Tup2RBo, FixTupWBo
{
	/** {@inheritDoc} */
	@Override
	Tup2WBo createNew(Tup2RBo t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo createNew(TupRBo t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo createNew(boolean... t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo createNew(boolean value);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo createNew(boolean v0, boolean v1);
	 ...
	 */
	@Override
	Tup2WBo setAt(int index, boolean value);
	 ...
	 */
	@Override
	Tup2WBo set(boolean... t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo set(boolean value);
	 ...
	 * @return This tuple.
	 */
	Tup2WBo set(boolean v0, boolean v1);
	...
	/** {@inheritDoc} */
	@Override
	Tup2WBo arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo arrangeN(int iV0, int iV1);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup2WBo swizzleV0V1N();
	 ...
	 * @return This tuple.
	 */
	Tup2WBo arrange(int iV0, int iV1);
	 ...
	 */
	@Override
	Tup2WBo swizzle(int indexA, int indexB);
