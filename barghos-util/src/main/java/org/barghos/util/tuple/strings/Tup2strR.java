...
import org.barghos.util.consumer.strings.Consumer2str;
import org.barghos.util.tuple.strings.Tup2strR;
...
public interface Tup2strR extends TupstrR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2strR createNew(TupstrR t)
	{
	 ...
	 */
	default Tup2strR createNew(Tup2strR t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 */
	@Override
	default Tup2strR createNew(@MinLength(2) String[] t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup2strR createNew(String value)
	{
	 ...
	 * @return A new instance.
	 */
	Tup2strR createNew(String v0, String v1);
	 ...
	 */
	default boolean equals(@Nullable Tup2strR other)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2strR rearrangeN(int[] indices)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2strR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer2str consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptString(v0(), v1());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer2<String,String> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
