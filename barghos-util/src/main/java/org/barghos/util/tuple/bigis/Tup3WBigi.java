 ...
 * three components.
 */
public interface Tup3WBigi extends Tup3RBigi, FixTupWBigi
{
	/** {@inheritDoc} */
	@Override
	Tup3WBigi createNew(Tup3RBigi t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi createNew(TupRBigi t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi createNew(BigInteger... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi createNew(BigInteger value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi createNew(BigInteger v0, BigInteger v1, BigInteger v2);
	 ...
	 */
	@Override
	Tup3WBigi setAt(int index, BigInteger value);
	 ...
	 */
	@Override
	Tup3WBigi set(BigInteger... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi set(BigInteger value);
	 ...
	 * @return This tuple.
	 */
	Tup3WBigi set(BigInteger v0, BigInteger v1, BigInteger v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WBigi arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi swizzleV0V1N();
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi swizzleV0V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup3WBigi swizzleV1V2N();
	 ...
	 * @return This tuple.
	 */
	Tup3WBigi arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WBigi swizzle(int indexA, int indexB);
