...
/**
 * This interface provides non-modifying operations for long tuples with an
...
public interface RTupleBaseL
{
	 ...
	 * component values.
	 */
	RTupleBaseL createNew(RTupleBaseL t);
	 ...
	 */
	long getAt(@IntMinValue(0) int index);
	 ...
	 * 
	 * <p>
	 * The minimum allowed tolerance is 0l. A tolerance of 0l behaves like
	 * {@link #zero()}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean zero(@LongMinValue(0l) long tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean zeroAt(@LongMinValue(0l) long tolerance, @IntMinValue(0) int index);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable RTupleBaseL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@LongMinValue(0l) long tolerance, @Nullable RTupleBaseL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@LongMinValue(0l) long tolerance, @Nullable long... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@LongMinValue(0l) long tolerance, long value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, @Nullable RTupleBaseL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, @Nullable long... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, long value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@LongMinValue(0l) long tolerance, @IntMinValue(0) int index, @Nullable RTupleBaseL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@LongMinValue(0l) long tolerance, @IntMinValue(0) int index, @Nullable long... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@LongMinValue(0l) long tolerance, @IntMinValue(0) int index, long value);
	 ...
	 */
	RTupleBaseL arrangeN(@IntMinValue(0) int... indices);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	RTupleBaseL swizzleN(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, RTupleBaseL t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0l. A tolerance of 0l behaves like
	 * {@link #compareAt(int, RTupleBaseL) compareAt(int, RTupleBaseL)}.
	 * 
     * <p>
	 * The valid index range is from 0 to {@link #size()} - 1.
     *
     ...
     * the given tuple.
     */
	int compareAt(@LongMinValue(0l) long tolerance, int index, @Nullable RTupleBaseL t);
     ...
     * the given tuple.
     */
	int compareAt(@LongMinValue(0l) long tolerance, int index, @Nullable long... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAt(@LongMinValue(0l) long tolerance, int index, long value);
}
