 ...
 * double tuples with flexible dimension counts.
 */
public interface TupdR
{
	 ...
	 * @return A new instance.
	 */
	default TupdR createNew(TupdR t)
	{
	...
	/**
	 * Returns true if all component values are finite as defined by
	 * {@link Double#isFinite(double)} and are therefore neither NaN or
	 * Infinity.
	 *
	 ...
	 */
	default TupdR resizeN(int size)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupdR rearrangeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupdR rearrangeResizeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupdR swapByIndexN(int indexA, int indexB)
	{
		if(Validation.argumentValidation())
		{
