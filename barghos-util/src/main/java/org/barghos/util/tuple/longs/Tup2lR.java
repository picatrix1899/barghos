...
import org.barghos.util.consumer.longs.Consumer2l;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for long tuples with two
 * dimensions.
 */
public interface Tup2lR extends TuplR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2lR createNew(TuplR t)
	{
	 ...
	 */
	default Tup2lR createNew(Tup2lR t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup2lR createNew(@MinLength(2) long[] t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup2lR createNew(long value)
	{
	 ...
	 * @return A new instance.
	 */
	Tup2lR createNew(long v0, long v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2lR} this will be two.
	 * 
	 ...
	 */
	default boolean equals(@Nullable Tup2lR other)
	{
	 ...
	 * @return True if this tuple is component-wise equal to the other tuple.
	 */
	default boolean equals(@Nullable Tup2lR other, @LongMinValue(0l) long tolerance)
	{
		Validation.validateMin("tolerance", tolerance, 0);
	 ...
	 */
	@Deprecated
	default Tup2lR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2lR rearrangeN(int[] indices)
	{
	 ...
	 */
	@Deprecated
	default Tup2lR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2lR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer2l consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptLong(v0(), v1());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer2<Long,Long> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
