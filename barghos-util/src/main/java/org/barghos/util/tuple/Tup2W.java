 ...
 */
public interface Tup2W<V0,V1> extends Tup2R<V0,V1>
{
	/**
	 ...
	 * values.
	 */
	Tup2W<V0,V1> createNew();
	
	/** {@inheritDoc} */
	@Override
	Tup2W<V0,V1> createNew(Tup2R<V0,V1> t);
	
	/** {@inheritDoc} */
	@Override
	Tup2W<V0,V1> createNew(V0 v0, V1 v1);
