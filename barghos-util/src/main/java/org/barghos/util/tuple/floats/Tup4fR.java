...
import org.barghos.util.consumer.floats.Consumer4f;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for
 * float tuples with four dimensions.
 */
public interface Tup4fR extends TupfR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4fR createNew(TupfR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4fR} this will be four.
	 * 
	...
	@Deprecated
	@Override
	default Tup4fR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4fR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup4fR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4fR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer4f consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptFloat(v0(), v1(), v2(), v3());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer4<Float,Float,Float,Float> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
