 ...
 * components.
 */
public interface Tup4WC extends Tup4RC, FixTupWC
{
	/** {@inheritDoc} */
	@Override
	Tup4WC createNew(Tup4RC t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WC createNew(TupRC t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WC createNew(char... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WC createNew(char value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WC createNew(char v0, char v1, char v2, char v3);
	 ...
	 */
	@Override
	Tup4WC setAt(int index, char value);
	 ...
	 * @return This tuple.
	 */
	Tup4WC set(char v0, char v1, char v2, char v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WC arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WC arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WC swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup4WC arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WC swizzle(int indexA, int indexB);
