...
public interface ITupRF
{
	 ...
	 */
	ITupRF swizzleN(int indexA, int indexB);
	
	float[] swizzleT(int indexA, int indexB, @ExtractionParam float[] res);
	
	<T extends ITupWF> T swizzleT(int indexA, int indexB, @ExtractionParam T res);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	ITupRF arrangeN(int[] indices);
	
	float[] arrangeT(int[] indices, @ExtractionParam float[] res);
	
	<T extends ITupWF> T arrangeT(int[] indices, @ExtractionParam T res);

	ITupRF minComponentsN(ITupRF t);
	
	float[] minComponentsT(ITupRF t, @ExtractionParam float[] res);
	
	<T extends ITupWF> T minComponentsT(ITupRF t, @ExtractionParam T res);
	
	ITupRF maxComponentsN(ITupRF t);
	
	float[] maxComponentsT(ITupRF t, @ExtractionParam float[] res);
	
	<T extends ITupWF> T maxComponentsT(ITupRF t, @ExtractionParam T res);
