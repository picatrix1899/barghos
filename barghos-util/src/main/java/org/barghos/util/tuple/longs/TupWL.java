...
/**
 * This interface provides common operations for long tuples.
 * 
 * <p>
 ...
 */
public interface TupWL extends TupRL
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWL setAt(int index, long value);
	...
	/** {@inheritDoc} */
	@Override
	TupWL swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWL swizzle(int indexA, int indexB);
}
