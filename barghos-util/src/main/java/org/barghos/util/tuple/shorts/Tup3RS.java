 ...
 */
public interface Tup3RS extends FixTupRS
{
	/**
	 ...
	 * component values.
	 */
	Tup3RS createNew(short v0, short v1, short v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RS} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short v0, short v1, short v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short tolerance, @Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short tolerance, short v0, short v1, short v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(short tolerance, int index, @Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(short tolerance, @Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(short tolerance, @Nullable Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(short tolerance, @Nullable Tup3RS t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equalsAtV2(short[]) equalsAtV1(short...)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RS arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RS swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup3RS t);
     ...
     */
	@Override
	int compareAt(int index, TupRS t);
     ...
     */
	@Override
	int compareAt(int index, short... t);
     ...
     * the given tuple.
     */
	int compareAt(short tolerance, int index, Tup3RS t);
     ...
     */
	@Override
	int compareAt(short tolerance, int index, TupRS t);
     ...
     */
	@Override
	int compareAt(short tolerance, int index, short... t);
     ...
     * the given tuple.
     */
	int compareAtV0(short tolerance, Tup3RS t);
     ...
     * the given tuple.
     */
	int compareAtV0(short tolerance, TupRS t);
     ...
     * the given tuple.
     */
	int compareAtV0(short tolerance, short... t);
     ...
     * the given tuple.
     */
	int compareAtV1(short tolerance, Tup3RS t);
     ...
     * the given tuple.
     */
	int compareAtV1(short tolerance, TupRS t);
     ...
     * the given tuple.
     */
	int compareAtV1(short tolerance, short... t);
     ...
     * the given tuple.
     */
	int compareAtV2(short tolerance, Tup3RS t);
     ...
     * the given tuple.
     */
	int compareAtV2(short tolerance, TupRS t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(short[]) compareAtV1(short...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(short tolerance, short... t);
