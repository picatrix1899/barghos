 ...
 */
public interface ITup4R<V0,V1,V2,V3>
{
	 ...
	 * values.
	 */
	ITup4R<V0,V1,V2,V3> createNew(ITup4R<V0,V1,V2,V3> t);
	 ...
	 * values.
	 */
	ITup4R<V0,V1,V2,V3> createNew(V0 v0, V1 v1, V2 v2, V3 v3);
	 ...
	 */
	boolean equals(@AllowNull ITup4R<V0,V1,V2,V3> t);
