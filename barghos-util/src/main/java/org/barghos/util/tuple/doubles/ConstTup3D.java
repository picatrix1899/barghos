...
public class ConstTup3D implements ITup3RD
{
	...
	public ConstTup3D(ITup3RD t)
	{
		t.toArray(this.v);
	}
	
	public ConstTup3D(ITupRD t)
	{
		t.toArray(this.v);
	}
	
	public ConstTup3D(double[] t)
	{
		System.arraycopy(t, 0, this.v, 0, 3);
	}
	
	public ConstTup3D(double v0, double v1, double v2)
	{
		this.v[0] = v0;
		this.v[1] = v1;
		this.v[2] = v2;
	...
	{
		return "constTup3d(" + this.v[0] + ", " + this.v[1] + ", " + this.v[2] + ")";
	}
	...
	{
		return TupUtils3D.isZeroAtV2(this.v);
	}
