...
import org.barghos.util.consumer.shorts.Consumer3s;

import org.barghos.util.tuple.shorts.Tup3sR;
import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for short tuples with
 * three dimensions.
 */
public interface Tup3sR extends TupsR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup3sR createNew(TupsR t)
	{
	 ...
	 */
	default Tup3sR createNew(Tup3sR t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 */
	@Override
	default Tup3sR createNew(@MinLength(3) short[] t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup3sR createNew(short value)
	{
	 ...
	 * @return A new instance.
	 */
	Tup3sR createNew(short v0, short v1, short v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3sR} this will be two.
	 * 
	 ...
	 */
	default boolean equals(@Nullable Tup3sR other)
	{
	 ...
	 * @return True if this tuple is component-wise equal to the other tuple.
	 */
	default boolean equals(@Nullable Tup3sR other, @ShortMinValue(0) short tolerance)
	{
		Validation.validateMin("tolerance", tolerance, 0);
	...
	@Deprecated
	@Override
	default Tup3sR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup3sR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup3sR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup3sR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer3s consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptShort(v0(), v1(), v2());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer3<Short,Short,Short> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
