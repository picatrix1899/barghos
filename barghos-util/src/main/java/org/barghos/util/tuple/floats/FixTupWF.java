 ...
 */
public interface FixTupWF extends TupWF, FixTupRF
{
	/**
	...
	/** {@inheritDoc} */
	@Override
	FixTupWF createNew(TupRF t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWF createNew(float... t);
	 ...
	 */
	@Override
	FixTupWF setAt(int index, float value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWF arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWF swizzleN(int indexA, int indexB);
	 ...
	 */
	@Override
	FixTupWF swizzle(int indexA, int indexB);
}
