...
public interface ITup4RF extends ITupRF
{
	 ...
	 * component values.
	 */
	ITup4RF createNew(float v0, float v1, float v2, float v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link ITup4RF} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(float tolerance, @AllowNull ITup4RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(float tolerance, int index, @AllowNull ITup4RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(float tolerance, @AllowNull ITup4RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(float tolerance, @AllowNull ITup4RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(float tolerance, @AllowNull ITup4RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(float tolerance, @AllowNull ITup4RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(float tolerance, @AllowNull ITupRF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(float tolerance, @AllowNull float[] t);
	 ...
	 */
	ITup4RF arrangeN(int[] indices);
	
	<T extends ITup4WF> T arrangeT(int[] indices, T res);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	ITup4RF arrangeN(int i0, int i1, int i2, int i3);
	
	<T extends ITup4WF> T arrangeT(int i0, int i1, int i2, int i3, T res);
	 ...
	 */
	@Override
	ITup4RF swizzleN(int indexA, int indexB);
	
	<T extends ITup4WF> T swizzleT(int indexA, int indexB, T res);
	 ...
	 */
	ITup4RF swizzleV0V1N();
	
	<T extends ITup4WF> T swizzleV0V1T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup4RF swizzleV0V2N();
	
	<T extends ITup4WF> T swizzleV0V2T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup4RF swizzleV0V3N();
	
	<T extends ITup4WF> T swizzleV0V3T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup4RF swizzleV1V2N();
	
	<T extends ITup4WF> T swizzleV1V2T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup4RF swizzleV1V3N();
	
	<T extends ITup4WF> T swizzleV1V3T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup4RF swizzleV2V3N();
	
	<T extends ITup4WF> T swizzleV2V3T(T res);

	float[] swizzleV2V3T(float[] res);
	
	ITup4RF minComponentsN();
	
	<T extends ITup4WF> T minComponentsT(T res);

	ITup4RF maxComponentsN();
	
	<T extends ITup4WF> T maxComponentsT(T res);
	
	ITup4RF ceilN();
	
	<T extends ITup4WF> T ceilT(T res);
	
	ITup4RF floorN();
	
	<T extends ITup4WF> T floorT(T res);
	
	ITup4RF roundN();
	
	<T extends ITup4WF> T roundT(T res);
	
	ITup4RF truncN();
	
	<T extends ITup4WF> T truncT(T res);
	
	ITup4RF roundN(IRoundMethodF method);
	
	<T extends ITup4WF> T roundT(IRoundMethodF method, T res);
	
	ITup4RF absN();
	
	<T extends ITup4WF> T absT(T res);
}