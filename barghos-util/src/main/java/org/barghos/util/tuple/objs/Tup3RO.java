 ...
 */
public interface Tup3RO extends FixTupRO
{
	/**
	 ...
	 * component values.
	 */
	Tup3RO createNew(Object v0, Object v1, Object v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RO} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@AllowNull Tup3RO t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup3RO t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup3RO t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup3RO t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull Tup3RO t);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RO arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RO swizzleN(int indexA, int indexB);
