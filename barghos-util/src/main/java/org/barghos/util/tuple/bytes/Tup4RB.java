 ...
 */
public interface Tup4RB extends FixTupRB
{
	/**
	 ...
	 * component values.
	 */
	Tup4RB createNew(byte v0, byte v1, byte v2, byte v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4RB} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtV3(byte tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(byte v0, byte v1, byte v2, byte v3);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(byte tolerance, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(byte tolerance, byte v0, byte v1, byte v2, byte v3);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(byte tolerance, int index, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable TupRB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable byte... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(byte tolerance, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(byte tolerance, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(byte tolerance, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(byte tolerance, @Nullable Tup4RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(byte tolerance, @Nullable TupRB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(byte tolerance, @Nullable byte... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(byte tolerance, byte value);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup4RB arrangeN(int i0, int i1, int i2, int i3);
	 ...
	 */
	@Override
	Tup4RB swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup4RB t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable TupRB t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAt(byte tolerance, int index, @Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV0(byte tolerance, @Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV0(byte tolerance, @Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV0(byte tolerance, @Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV1(byte tolerance, @Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV1(byte tolerance, @Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV1(byte tolerance, @Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV2(byte tolerance, @Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV2(byte tolerance, @Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV2(byte tolerance, @Nullable byte... t);
     ...
     * the given tuple.
     */
	int compareAtV3(byte tolerance, @Nullable Tup4RB t);
     ...
     * the given tuple.
     */
	int compareAtV3(byte tolerance, @Nullable TupRB t);
     ...
     * the given tuple.
     */
	int compareAtV3(byte tolerance, @Nullable byte... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV3(byte tolerance, byte value);
}