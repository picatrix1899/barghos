 ...
 */
public interface TupWObj extends TupRObj
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWObj setAt(int index, Object value);
	...
	/** {@inheritDoc} */
	@Override
	TupWObj swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWObj swizzle(int indexA, int indexB);
}
