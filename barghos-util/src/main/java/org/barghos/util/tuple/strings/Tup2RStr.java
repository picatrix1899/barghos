 ...
 */
public interface Tup2RStr extends FixTupRStr
{
	/**
	 ...
	 */
	Tup2RStr createNew(String value);
	 ...
	 * component values.
	 */
	Tup2RStr createNew(String v0, String v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RStr} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@Nullable Tup2RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(String v0, String v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup2RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup2RStr t);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup2RStr arrangeN(int i0, int i1);
	 ...
	 */
	@Override
	Tup2RStr swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup2RStr t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup2RStr t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup2RStr t);
