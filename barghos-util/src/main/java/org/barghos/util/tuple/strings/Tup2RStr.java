...
public interface Tup2RStr extends FixTupRStr
{
	 ...
	 */
	boolean equals(@AllowNull Tup2RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup2RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup2RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup2RStr t);
