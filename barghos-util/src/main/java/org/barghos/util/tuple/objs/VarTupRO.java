 ...
 * tuple.
 */
public interface VarTupRO extends TupRO
{
	/**
	 ...
	 */
	VarTupRO arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRO swizzleN(int indexA, int indexB);
}
