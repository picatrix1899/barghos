 ...
 */
public interface WTupleBaseI extends RTupleBaseI
{
	/**
	 ...
	 * this tuple.
	 */
	WTupleBaseI createNew();
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseI createNew(RTupleBaseI t);
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseI createNew(int... t);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseI setAt(@IntMinValue(0) int index, int value);
	...
	/** {@inheritDoc}} */
	@Override
	WTupleBaseI arrangeN(@IntMinValue(0) int... indices);
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseI swizzleN(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseI arrange(@IntMinValue(0) int... indices);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseI swizzle(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
}
