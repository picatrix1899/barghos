 ...
 */
public interface Tup2RI extends FixTupRI
{
	/**
	 ...
	 * component values.
	 */
	Tup2RI createNew(int v0, int v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RI} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(int tolerance, @Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(int tolerance, int v0, int v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int tolerance, int index, @Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(int tolerance, @Nullable Tup2RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(int tolerance, @Nullable Tup2RI t);
	 ...
	 */
	@Override
	Tup2RI swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup2RI t);
     ...
     * the given tuple.
     */
	int compareAt(int tolerance, int index, Tup2RI t);
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, Tup2RI t);
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, Tup2RI t);
