 ...
 */
public interface FixTupWC extends TupWC, FixTupRC
{
	/**
	...
	/** {@inheritDoc} */
	@Override
	FixTupWC createNew(TupRC t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWC createNew(char... t);
	 ...
	 */
	@Override
	FixTupWC setAt(int index, char value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWC arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWC swizzleN(int indexA, int indexB);
	 ...
	 */
	@Override
	FixTupWC swizzle(int indexA, int indexB);
}
