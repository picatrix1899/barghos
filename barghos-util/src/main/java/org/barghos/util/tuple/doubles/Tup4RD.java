 ...
 */
public interface Tup4RD extends FixTupRD
{
	/**
	 ...
	 * component values.
	 */
	Tup4RD createNew(double v0, double v1, double v2, double v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4RD} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtV2(double tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean isZeroAtV3(double tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double v0, double v1, double v2, double v3);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double tolerance, @Nullable Tup4RD t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equals(double, double, double, double)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double tolerance, double v0, double v1, double v2, double v3);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(double tolerance, int index, @Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(double value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable TupRD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable double... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(double tolerance, @Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(double tolerance, @Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(double tolerance, @Nullable Tup4RD t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equalsAtV2(double[]) equalsAtV2(double...)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(double tolerance, double value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double tolerance, @Nullable Tup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double tolerance, @Nullable TupRD t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equalsAtV3(double[]) equalsAtV3(double...)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double tolerance, @Nullable double... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double tolerance, double value);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup4RD arrangeN(int i0, int i1, int i2, int i3);
	 ...
	 */
	@Override
	Tup4RD swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup4RD t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable TupRD t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable double... t);
     ...
     */
	@Override
	int compareAt(int index, double value);
     ...
     * the given tuple.
     */
	int compareAt(double tolerance, int index, @Nullable Tup4RD t);
     ...
     */
	@Override
	int compareAt(double tolerance, int index, @Nullable TupRD t);
     ...
     */
	@Override
	int compareAt(double tolerance, int index, @Nullable double... t);
     ...
     */
	@Override
	int compareAt(double tolerance, int index, double value);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable double... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable double... t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable double... t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable double... t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, @Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, @Nullable TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, @Nullable double... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV0(double tolerance, double value);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, @Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, @Nullable TupRD t);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, @Nullable double... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV1(double tolerance, double value);
     ...
     * the given tuple.
     */
	int compareAtV2(double tolerance, @Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV2(double tolerance, @Nullable TupRD t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(double[]) compareAtV2(double...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(double tolerance, @Nullable double... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV2(double tolerance, double value);
     ...
     * the given tuple.
     */
	int compareAtV3(double tolerance, @Nullable Tup4RD t);
     ...
     * the given tuple.
     */
	int compareAtV3(double tolerance, @Nullable TupRD t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV3(double[]) compareAtV3(double...)}.
	 * 
     * <p>
	 * The fourth component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV3(double tolerance, @Nullable double... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV3(double tolerance, double value);
}