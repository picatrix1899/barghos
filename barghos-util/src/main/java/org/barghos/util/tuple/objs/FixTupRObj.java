...
/**
 * This interface provides non-modifying operations for Object tuples with an
 ...
 */
public interface FixTupRObj extends TupRObj
{
	/**
	 ...
	 * component values.
	 */
	FixTupRObj createNew(TupRObj t);
	 ...
	 */
	FixTupRObj arrangeN(int... indices);
}
