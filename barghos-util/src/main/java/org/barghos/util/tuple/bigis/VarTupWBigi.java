 ...
 */
public interface VarTupWBigi extends TupWBigi, VarTupRBigi
{
	/**
	 ...
	 */
	@Override
	VarTupWBigi createNew(TupRBigi t);
	 ...
	 */
	@Override
	VarTupWBigi createNew(BigInteger... t);
	
	/** {@inheritDoc} */
	@Override
	VarTupWBigi setAt(int index, BigInteger value);
	 ...
	 */
	@Override
	VarTupWBigi arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWBigi swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	VarTupWBigi arrange(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWBigi swizzle(int indexA, int indexB);
}
