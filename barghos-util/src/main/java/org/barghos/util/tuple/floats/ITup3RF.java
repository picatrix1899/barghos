...
public interface ITup3RF extends ITupRF
{
	 ...
	 * component values.
	 */
	ITup3RF createNew(float v0, float v1, float v2);
	 ...
	 */
	ITup3RF arrangeN(int[] indices);
	
	<T extends ITup3WF> T arrangeT(int[] indices, T res);
	
	float[] arrangeT(int[] indices, float[] res);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	ITup3RF arrangeN(int i0, int i1, int i2);
	
	<T extends ITup3WF> T arrangeT(int i0, int i1, int i2, T res);
	
	float[] arrangeT(int i0, int i1, int i2, float[] res);
	 ...
	 */
	@Override
	ITup3RF swizzleN(int indexA, int indexB);
	
	<T extends ITup3WF> T swizzleT(int indexA, int indexB, T res);
	
	float[] swizzleT(int indexA, int indexB, float[] res);
	 ...
	 */
	ITup3RF swizzleV0V1N();
	
	<T extends ITup3WF> T swizzleV0V1T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup3RF swizzleV0V2N();
	
	<T extends ITup3WF> T swizzleV0V2T(T res);
	 ...
	 * @return A new instance of the type of this tuple with the result.
	 */
	ITup3RF swizzleV1V2N();
	
	<T extends ITup3WF> T swizzleV1V2T(T res);
	
	float[] swizzleV1V2T(float[] res);
	
	ITup3RF minComponentsN(ITup3RF t);
	
	ITup3RF minComponentsN(ITupRF t);
	
	ITup3RF minComponentsN(float[] t);
	
	ITup3RF minComponentsN(float tv0, float tv1, float tv2);
	...
	ITup3RF maxComponentsN(ITup3RF t);
	
	ITup3RF maxComponentsN(ITupRF t);
	
	ITup3RF maxComponentsN(float[] t);
	
	ITup3RF maxComponentsN(float tv0, float tv1, float tv2);
