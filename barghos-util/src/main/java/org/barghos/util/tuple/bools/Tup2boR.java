...
import org.barghos.util.consumer.bools.Consumer2bo;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for
 * boolean tuples with two dimensions.
 */
public interface Tup2boR extends TupboR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2boR createNew(TupboR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2boR} this will be two.
	 * 
	...
	@Deprecated
	@Override
	default Tup2boR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2boR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup2boR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2boR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer2bo consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptBool(v0(), v1());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer2<Boolean,Boolean> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
