...
public interface Tup3RBo extends FixTupRBo
{
	 ...
	 */
	boolean equals(@Nullable Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup3RBo t);
