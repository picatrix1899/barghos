...
public interface TupRStr
{
	 ...
	 */
	String getAt(@IntMinValue(0) int index);
	 ...
	 */
	TupRStr swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, TupRStr t);
     ...
     * the given tuple.
     */
	int compareAt(int index, String... t);
