...
public interface Tup4RBigi extends FixTupRBigi
{
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup4RBigi t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable TupRBigi t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAt(BigInteger tolerance, int index, @Nullable Tup4RBigi t);
     ...
     */
	@Override
	int compareAt(BigInteger tolerance, int index, @Nullable TupRBigi t);
     ...
     */
	@Override
	int compareAt(BigInteger tolerance, int index, @Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable TupRBigi t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable TupRBigi t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable TupRBigi t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable TupRBigi t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable BigInteger... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV3(BigInteger value);
     ...
     * the given tuple.
     */
	int compareAtV0(BigInteger tolerance, @Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV0(BigInteger tolerance, @Nullable TupRBigi t);
     ...
     * the given tuple.
     */
	int compareAtV0(BigInteger tolerance, @Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV1(BigInteger tolerance, @Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV1(BigInteger tolerance, @Nullable TupRBigi t);
     ...
     * the given tuple.
     */
	int compareAtV1(BigInteger tolerance, @Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV2(BigInteger tolerance, @Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV2(BigInteger tolerance, @Nullable TupRBigi t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(BigInteger[]) compareAtV2(BigInteger...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(BigInteger tolerance, @Nullable BigInteger... t);
     ...
     * the given tuple.
     */
	int compareAtV3(BigInteger tolerance, @Nullable Tup4RBigi t);
     ...
     * the given tuple.
     */
	int compareAtV3(BigInteger tolerance, @Nullable TupRBigi t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV3(BigInteger[]) compareAtV3(BigInteger...)}.
	 * 
     * <p>
	 * The fourth component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV3(BigInteger tolerance, @Nullable BigInteger... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV3(BigInteger tolerance, BigInteger value);
}