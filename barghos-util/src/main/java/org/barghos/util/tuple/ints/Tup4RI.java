...
public interface Tup4RI extends FixTupRI
{
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup4RI t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable TupRI t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAt(int tolerance, int index, @Nullable Tup4RI t);
     ...
     */
	@Override
	int compareAt(int tolerance, int index, @Nullable TupRI t);
     ...
     */
	@Override
	int compareAt(int tolerance, int index, @Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable TupRI t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable TupRI t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable TupRI t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable TupRI t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, @Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, @Nullable TupRI t);
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, @Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, @Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, @Nullable TupRI t);
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, @Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV2(int tolerance, @Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV2(int tolerance, @Nullable TupRI t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(int[]) compareAtV2(int...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(int tolerance, @Nullable int... t);
     ...
     * the given tuple.
     */
	int compareAtV3(int tolerance, @Nullable Tup4RI t);
     ...
     * the given tuple.
     */
	int compareAtV3(int tolerance, @Nullable TupRI t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV3(int[]) compareAtV3(int...)}.
	 * 
     * <p>
	 * The fourth component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV3(int tolerance, @Nullable int... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV3(int tolerance, int value);
}