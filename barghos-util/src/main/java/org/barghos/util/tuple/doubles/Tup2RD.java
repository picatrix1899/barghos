 ...
 */
public interface Tup2RD extends FixTupRD
{
	/**
	 ...
	 * component values.
	 */
	Tup2RD createNew(double v0, double v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RD} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double tolerance, @Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(double tolerance, int index, @Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(double tolerance, @Nullable Tup2RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(double tolerance, @Nullable Tup2RD t);
	 ...
	 */
	@Override
	Tup2RD swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup2RD t);
     ...
     * the given tuple.
     */
	int compareAt(double tolerance, int index, Tup2RD t);
     ...
     * the given tuple.
     */
	int compareAtV0(double tolerance, Tup2RD t);
     ...
     * the given tuple.
     */
	int compareAtV1(double tolerance, Tup2RD t);
