 ...
 */
public interface Tup3RStr extends FixTupRStr
{
	/**
	 ...
	 */
	Tup3RStr createNew(String value);
	 ...
	 * component values.
	 */
	Tup3RStr createNew(String v0, String v1, String v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RStr} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@Nullable Tup3RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(String v0, String v1, String v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup3RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup3RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup3RStr t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup3RStr t);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RStr arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RStr swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup3RStr t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup3RStr t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup3RStr t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup3RStr t);
