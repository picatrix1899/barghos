...
import org.barghos.util.consumer.bigis.Consumer2bigi;
...
public interface Tup2bigiR extends TupbigiR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigiR createNew(TupbigiR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2bigiR} this will be
	 * two.
	 * 
	...
	@Deprecated
	@Override
	default Tup2bigiR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigiR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup2bigiR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	 ...
	 */
	default Tup2bigiR swapV0AndV1N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigiR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer2bigi consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptBigInt(v0(), v1());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer2<BigInteger,BigInteger> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
