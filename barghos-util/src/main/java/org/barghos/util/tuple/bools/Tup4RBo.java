...
public interface Tup4RBo extends FixTupRBo
{
	 ...
	 */
	boolean equals(@Nullable Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable TupRBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable boolean... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable TupRBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable boolean... t);
