 ...
 */
public interface Tup3RI extends FixTupRI
{
	/**
	 ...
	 * component values.
	 */
	Tup3RI createNew(int v0, int v1, int v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RI} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(int v0, int v1, int v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(int tolerance, @Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(int tolerance, int v0, int v1, int v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int tolerance, int index, @Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(int tolerance, @Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(int tolerance, @Nullable Tup3RI t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(int tolerance, @Nullable Tup3RI t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equalsAtV2(int[]) equalsAtV1(int...)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RI arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RI swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup3RI t);
     ...
     */
	@Override
	int compareAt(int index, TupRI t);
     ...
     * the given tuple.
     */
	int compareAt(int tolerance, int index, Tup3RI t);
     ...
     */
	@Override
	int compareAt(int tolerance, int index, TupRI t);
     ...
     */
	@Override
	int compareAt(int tolerance, int index, int... t);
     ...
     */
	@Override
	int compareAt(int tolerance, int index, int value);
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, Tup3RI t);
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, TupRI t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV0(int[]) compareAtV0(int...)}.
	 * 
     * <p>
	 * The first component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV0(int tolerance, int... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV0(int tolerance, int value);
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, Tup3RI t);
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, TupRI t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV1(int[]) compareAtV1(int...)}.
	 * 
     * <p>
	 * The second component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV1(int tolerance, int... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV1(int tolerance, int value);
     ...
     * the given tuple.
     */
	int compareAtV2(int tolerance, Tup3RI t);
     ...
     * the given tuple.
     */
	int compareAtV2(int tolerance, TupRI t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(int[]) compareAtV1(int...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(int tolerance, int... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAtV2(int tolerance, int value);
}