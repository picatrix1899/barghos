 ...
 * char tuples with flexible dimension counts.
 */
public interface TupcR
{
	 ...
	 * @return A new instance.
	 */
	default TupcR createNew(TupcR t)
	{
	 ...
	 */
	default TupcR resizeN(int size)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupcR rearrangeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupcR rearrangeResizeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupcR swapByIndexN(int indexA, int indexB)
	{
		if(Validation.argumentValidation())
		{
