 ...
 */
public interface Tup2RS extends FixTupRS
{
	/**
	 ...
	 * component values.
	 */
	Tup2RS createNew(short v0, short v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RS} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short v0, short v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short tolerance, @Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short tolerance, short v0, short v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(short tolerance, int index, @Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(short tolerance, @Nullable Tup2RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(short tolerance, @Nullable Tup2RS t);
	 ...
	 */
	@Override
	Tup2RS swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup2RS t);
     ...
     * the given tuple.
     */
	int compareAt(short tolerance, int index, Tup2RS t);
     ...
     * the given tuple.
     */
	int compareAtV0(short tolerance, Tup2RS t);
     ...
     * the given tuple.
     */
	int compareAtV1(short tolerance, Tup2RS t);
