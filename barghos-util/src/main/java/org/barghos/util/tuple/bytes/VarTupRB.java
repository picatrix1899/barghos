...
/**
 * This interface provides non-modifying operations for byte tuples with a
 ...
 * tuple.
 */
public interface VarTupRB extends TupRB
{
	/**
	 ...
	 */
	VarTupRB arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRB swizzleN(int indexA, int indexB);
}
