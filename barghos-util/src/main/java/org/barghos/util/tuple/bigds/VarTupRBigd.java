 ...
 * size of this tuple.
 */
public interface VarTupRBigd extends TupRBigd
{
	/**
	 ...
	 * component values.
	 */
	VarTupRBigd createNew(TupRBigd t);
	 ...
	 * values.
	 */
	VarTupRBigd createNew(BigDecimal... t);
	 ...
	 */
	VarTupRBigd arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRBigd swizzleN(int indexA, int indexB);
}
