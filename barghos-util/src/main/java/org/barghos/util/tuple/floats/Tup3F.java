...
public class Tup3F implements ITup3WF, IBufferableRF, IBufferableWF
{
	...
	@Override
	public Tup3F setAt(int index, float value)
	{
		this.v[index] = value;
	...
	{
		return "tup3f(" + this.v[0] + ", " + this.v[1] + ", " + this.v[2] + ")";
	}
	...
	@Override
	public Tup3F writeTo(FloatBuffer buffer)
	{
		buffer.put(this.v);
	...
	@Override
	public Tup3F readFrom(FloatBuffer buffer, int offset)
	{
