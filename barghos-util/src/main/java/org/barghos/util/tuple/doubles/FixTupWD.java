 ...
 */
public interface FixTupWD extends TupWD, FixTupRD
{
	/**
	...
	/** {@inheritDoc} */
	@Override
	FixTupWD createNew(TupRD t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWD createNew(double... t);
	 ...
	 */
	@Override
	FixTupWD setAt(int index, double value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWD arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWD swizzleN(int indexA, int indexB);
	 ...
	 */
	@Override
	FixTupWD swizzle(int indexA, int indexB);
}
