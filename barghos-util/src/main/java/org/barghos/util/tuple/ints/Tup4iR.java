...
public interface Tup4iR extends TupiR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4iR createNew(TupiR t)
	{
	 ...
	 */
	default Tup4iR createNew(Tup4iR t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup4iR createNew(@MinLength(4) int[] t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup4iR createNew(int value)
	{
	 ...
	 * @return A new instance.
	 */
	Tup4iR createNew(int v0, int v1, int v2, int v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4iR} this will be four.
	 * 
	 ...
	 */
	default boolean equals(@Nullable Tup4iR other)
	{
	 ...
	 * @return True if this tuple is component-wise equal to the other tuple.
	 */
	default boolean equals(@Nullable Tup4iR other, @IntMinValue(0) int tolerance)
	{
		Validation.validateMin("tolerance", tolerance, 0);
	...
	@Deprecated
	@Override
	default Tup4iR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4iR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup4iR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4iR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer4i consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptInt(v0(), v1(), v2(), v3());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer4<Integer,Integer,Integer,Integer> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
