...
public class Tup2D implements ITup2WD
{
	...
	public Tup2D(ITup2RD t)
	{
		set(t);
	}
	
	public Tup2D(ITupRD t)
	{
		set(t);
	}
	
	public Tup2D(double[] t)
	{
		set(t);
	}
	
	public Tup2D(double v0, double v1)
	{
		set(v0, v1);
	}
	...
	@Override
	public Tup2D setAt(int index, double value)
	{
		this.v[index] = value;
	...
	@Override
	public Tup2D set(double v0, double v1)
	{
		this.v[0] = v0;
		this.v[1] = v1;
	...
	{
		return "Tup2d(" + this.v[0] + ", " + this.v[1] + ")";
	}
