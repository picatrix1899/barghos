 ...
 * byte tuples with flexible dimension counts.
 */
public interface TupbR
{
	 ...
	 * @return A new instance.
	 */
	default TupbR createNew(TupbR t)
	{
	 ...
	 */
	default TupbR resizeN(int size)
	{
		Validation.validateMin("size", size, 0);
		
		byte[] oldValues = toArray();
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupbR rearrangeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupbR rearrangeResizeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupbR swapByIndexN(int indexA, int indexB)
	{
		if(Validation.argumentValidation())
		{
