 ...
 * components.
 */
public interface Tup4WO extends Tup4RO, FixTupWO
{
	/** {@inheritDoc} */
	@Override
	Tup4WO createNew(Tup4RO t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WO createNew(TupRO t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WO createNew(Object... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WO createNew(Object value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WO createNew(Object v0, Object v1, Object v2, Object v3);
	 ...
	 */
	@Override
	Tup4WO setAt(int index, Object value);
	 ...
	 * @return This tuple.
	 */
	Tup4WO set(Object v0, Object v1, Object v2, Object v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WO arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WO arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WO swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup4WO arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WO swizzle(int indexA, int indexB);
