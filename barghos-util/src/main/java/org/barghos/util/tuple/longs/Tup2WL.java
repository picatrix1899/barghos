...
/**
 * This interface provides common operations for long tuples with two
 * components.
 */
public interface Tup2WL extends Tup2RL, FixTupWL
{
	/** {@inheritDoc} */
	@Override
	Tup2WL createNew(Tup2RL t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WL createNew(TupRL t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WL createNew(long... t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WL createNew(long value);
	
	/** {@inheritDoc} */
	@Override
	Tup2WL createNew(long v0, long v1);
	 ...
	 */
	@Override
	Tup2WL setAt(int index, long value);
