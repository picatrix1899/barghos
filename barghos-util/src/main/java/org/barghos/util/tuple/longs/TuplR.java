...
/**
 * This interface provides non-invasive (read only) functions and methods for long tuples with
...
public interface TuplR
{
	 ...
	 * @return A new instance.
	 */
	default TuplR createNew(TuplR t)
	{
	...
	/**
	 * Returns true if all component values are exactly zero or within a inclusive margin of the
	 * given tolerance.
	 *
	 ...
	 */
	default TuplR resizeN(int size)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TuplR rearrangeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TuplR rearrangeResizeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TuplR swapByIndexN(int indexA, int indexB)
	{
		if(Validation.argumentValidation())
		{
