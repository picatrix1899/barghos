...
public class ConstTup4D implements ITup4RD
{
	...
	public ConstTup4D(ITup4RD t)
	{
		t.toArray(this.v);
	}
	
	public ConstTup4D(ITupRD t)
	{
		t.toArray(this.v);
	}
	
	public ConstTup4D(double[] t)
	{
		System.arraycopy(t, 0, this.v, 0, 4);
	}
	
	public ConstTup4D(double v0, double v1, double v2, double v3)
	{
		this.v[0] = v0;
		this.v[1] = v1;
		this.v[2] = v2;
	...
	{
		return "constTup4d(" + this.v[0] + ", " + this.v[1] + ", " + this.v[2] + ", " + this.v[3] + ")";
	}
	...
	{
		return TupUtils4D.isZeroAt(index, this.v);
	}
