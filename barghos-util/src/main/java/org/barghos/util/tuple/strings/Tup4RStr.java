 ...
 */
public interface Tup4RStr extends FixTupRStr
{
	/**
	 ...
	 */
	Tup4RStr createNew(String value);
	 ...
	 * component values.
	 */
	Tup4RStr createNew(String v0, String v1, String v2, String v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4RStr} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(String v0, String v1, String v2, String v3);
	 ...
	 */
	@Override
	boolean equalsAt(int index, String value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(String value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(String value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(String value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(String value);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup4RStr arrangeN(int i0, int i1, int i2, int i3);
	 ...
	 */
	@Override
	Tup4RStr swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup4RStr t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable TupRStr t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable String... t);
     ...
     */
	@Override
	int compareAt(int index, String value);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup4RStr t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable TupRStr t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable String... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup4RStr t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable TupRStr t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable String... t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup4RStr t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable TupRStr t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable String... t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable Tup4RStr t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable TupRStr t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable String... t);
