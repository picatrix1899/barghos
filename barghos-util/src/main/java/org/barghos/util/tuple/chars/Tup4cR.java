...
import org.barghos.util.consumer.chars.Consumer4C;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for
 * char tuples with four dimensions.
 */
public interface Tup4cR extends TupcR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4cR createNew(TupcR t)
	{
	 ...
	 */
	default Tup4cR createNew(Tup4cR t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup4cR createNew(@MinLength(4) char[] t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup4cR createNew(char value)
	{
	 ...
	 * @return A new instance.
	 */
	Tup4cR createNew(char v0, char v1, char v2, char v3);
	 ...
	 */
	default boolean equals(@Nullable Tup4cR other)
	{
	...
	@Deprecated
	@Override
	default Tup4cR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4cR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup4cR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4cR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer4C consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptChar(v0(), v1(), v2(), v3());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer4<Character,Character,Character,Character> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
