 ...
 */
public interface Tup4RC extends FixTupRC
{
	/**
	 ...
	 * component values.
	 */
	Tup4RC createNew(char v0, char v1, char v2, char v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4RC} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@Nullable Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(char v0, char v1, char v2, char v3);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@Nullable Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable TupRC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@Nullable char... t);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup4RC arrangeN(int i0, int i1, int i2, int i3);
	 ...
	 */
	@Override
	Tup4RC swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, @Nullable Tup4RC t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable TupRC t);
     ...
     */
	@Override
	int compareAt(int index, @Nullable char... t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable Tup4RC t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable TupRC t);
     ...
     * the given tuple.
     */
	int compareAtV0(@Nullable char... t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable Tup4RC t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable TupRC t);
     ...
     * the given tuple.
     */
	int compareAtV1(@Nullable char... t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable Tup4RC t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable TupRC t);
     ...
     * the given tuple.
     */
	int compareAtV2(@Nullable char... t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable Tup4RC t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable TupRC t);
     ...
     * the given tuple.
     */
	int compareAtV3(@Nullable char... t);
