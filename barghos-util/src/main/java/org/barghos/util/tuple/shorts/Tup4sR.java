...
import org.barghos.util.consumer.shorts.Consumer4S;
...
public interface Tup4sR extends TupsR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sR createNew(TupsR t)
	{
	 ...
	 */
	default Tup4sR createNew(Tup4sR t)
	{
		Validation.validateNotNull("t", t);
	 ...
	 * @return A new instance.
	 */
	default Tup4sR createNew(short value)
	{
	 ...
	 * @return A new instance.
	 */
	Tup4sR createNew(short v0, short v1, short v2, short v3);
	 ...
	 */
	default boolean equals(@Nullable Tup4sR other)
	{
	 ...
	 * @return True if this tuple is component-wise equal to the other tuple.
	 */
	default boolean equals(@Nullable Tup4sR other, @ShortMinValue(0) short tolerance)
	{
		Validation.validateMin("tolerance", tolerance, 0);
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sR rearrangeN(int[] indices)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4sR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer4S consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptShort(v0(), v1(), v2(), v3());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer4<Short,Short,Short,Short> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
