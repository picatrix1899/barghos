 ...
 */
public interface WTupleBaseB extends RTupleBaseB
{
	/**
	 ...
	 * this tuple.
	 */
	WTupleBaseB createNew();
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseB createNew(RTupleBaseB t);
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseB createNew(byte... t);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseB setAt(@IntMinValue(0) int index, byte value);
	...
	/** {@inheritDoc}} */
	@Override
	WTupleBaseB arrangeN(@IntMinValue(0) int... indices);
	
	/** {@inheritDoc}} */
	@Override
	WTupleBaseB swizzleN(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseB arrange(@IntMinValue(0) int... indices);
	 ...
	 * @return This tuple.
	 */
	WTupleBaseB swizzle(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
}
