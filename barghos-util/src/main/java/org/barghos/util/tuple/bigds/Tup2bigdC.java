...
public interface Tup2bigdC extends Tup2bigdR, TupbigdC
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigdC createNew(TupbigdR t)
	{
	 ...
	 * {@link Tup2bigdR}.
	 * 
	 * @param t An existing implementation of {@link Tup2bigdR} to adopt the
	...
	/** {@inheritDoc} */
	@Override
	default Tup2bigdC setArray(@MinLength(2) BigDecimal... t)
	{
	...
	@Deprecated
	@Override
	default Tup2bigdC setResize(TupbigdR t)
	{
	...
	@Deprecated
	@Override
	default Tup2bigdC setArrayResize(BigDecimal... t)
	{
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	default Tup2bigdC resizeN(int size)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigdC rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup2bigdC rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigdC swapV0AndV1N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2bigdC swapByIndexN(int indexA, int indexB)
	{
	...
	@Deprecated
	@Override
	default Tup2bigdC resize(int size)
	{
		throw new UnsupportedOperationException();
	}
	 ...
	 * @return This tuple.
	 */
	default Tup2bigdC rearrange(int[] indices)
	{
		Validation.validateNotNull("indices", indices);
		Validation.validateExpectSize("indices", indices, 2);
	...
	@Deprecated
	@Override
	default Tup2bigdC rearrangeResize(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	 ...
	 * @return This tuple.
	 */
	default Tup2bigdC swapByIndex(int indexA, int indexB)
	{
		Validation.validateInRange("indexA", indexA, 0, 1);
		Validation.validateInRange("indexB", indexB, 0, 1);
