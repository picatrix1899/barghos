...
/**
 * This interface provides common operations for char tuples with two
 * components.
 */
public interface Tup2WC extends Tup2RC, FixTupWC
{
	/** {@inheritDoc} */
	@Override
	Tup2WC createNew(Tup2RC t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WC createNew(TupRC t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WC createNew(char... t);
	
	/** {@inheritDoc} */
	@Override
	Tup2WC createNew(char value);
	
	/** {@inheritDoc} */
	@Override
	Tup2WC createNew(char v0, char v1);
	 ...
	 */
	@Override
	Tup2WC setAt(int index, char value);
	...
	/** {@inheritDoc} */
	@Override
	Tup2WC arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup2WC arrangeN(int iV0, int iV1);
	
	/** {@inheritDoc} */
	@Override
	Tup2WC swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup2WC arrange(int iV0, int iV1);
	 ...
	 */
	@Override
	Tup2WC swizzle(int indexA, int indexB);
