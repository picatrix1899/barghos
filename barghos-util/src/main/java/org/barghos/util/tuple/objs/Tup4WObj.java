 ...
 * components.
 */
public interface Tup4WObj extends Tup4RObj, FixTupWObj
{
	/** {@inheritDoc} */
	@Override
	Tup4WObj createNew(Tup4RObj t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj createNew(TupRObj t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj createNew(Object... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj createNew(Object value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj createNew(Object v0, Object v1, Object v2, Object v3);
	 ...
	 */
	@Override
	Tup4WObj setAt(int index, Object value);
	 ...
	 */
	@Override
	Tup4WObj set(Object... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj set(Object value);
	 ...
	 * @return This tuple.
	 */
	Tup4WObj set(Object v0, Object v1, Object v2, Object v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WObj arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleV0V1N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleV0V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleV0V3N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleV1V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleV1V3N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WObj swizzleV2V3N();
	 ...
	 * @return This tuple.
	 */
	Tup4WObj arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WObj swizzle(int indexA, int indexB);
