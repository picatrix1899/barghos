...
/**
 * This interface provides common operations for int tuples.
 * 
 * <p>
 ...
 */
public interface TupWI extends TupRI
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWI setAt(int index, int value);
	...
	/** {@inheritDoc} */
	@Override
	TupWI swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWI swizzle(int indexA, int indexB);
}
