...
/**
 * This interface provides non-modifying operations for float tuples with a
 ...
 * tuple.
 */
public interface VarTupRF extends TupRF
{
	/**
	 ...
	 */
	VarTupRF arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRF swizzleN(int indexA, int indexB);
}
