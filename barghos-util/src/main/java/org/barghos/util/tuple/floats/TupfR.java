...
/**
 * This interface provides non-invasive (read only) functions and methods for float tuples with flexible dimension counts.
 */
public interface TupfR
{
	...
	{
		return toArray(new float[dimensions()]);
	}
