 ...
 * float tuples with flexible dimension counts.
 */
public interface TupfR
{
	 ...
	 * @return A new instance.
	 */
	default TupfR createNew(TupfR t)
	{
	 ...
	 * {@link Float#isFinite(float)} and are therefore neither NaN or Infinity.
	 *
	 ...
	 */
	default TupfR resizeN(int size)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupfR rearrangeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupfR rearrangeResizeN(int[] indices)
	{
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	default TupfR swapByIndexN(int indexA, int indexB)
	{
		if(Validation.argumentValidation())
		{
