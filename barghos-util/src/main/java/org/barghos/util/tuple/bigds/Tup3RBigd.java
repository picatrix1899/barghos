 ...
 */
public interface Tup3RBigd extends FixTupRBigd
{
	/**
	 ...
	 * component values.
	 */
	Tup3RBigd createNew(Tup3RBigd t);
	 ...
	 */
	@Override
	Tup3RBigd createNew(TupRBigd t);
	 ...
	 */
	@Override
	Tup3RBigd createNew(BigDecimal... t);
	 ...
	 */
	Tup3RBigd createNew(BigDecimal value);
	 ...
	 * component values.
	 */
	Tup3RBigd createNew(BigDecimal v0, BigDecimal v1, BigDecimal v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RBigd} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(BigDecimal v0, BigDecimal v1, BigDecimal v2);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equals(BigDecimal, BigDecimal, BigDecimal)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(BigDecimal tolerance, BigDecimal v0, BigDecimal v1, BigDecimal v2);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equalsAtV2(BigDecimal[]) equalsAtV1(BigDecimal...)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 */
	@Override
	Tup3RBigd arrangeN(int... indices);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RBigd arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RBigd swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup3RBigd t);
     ...
     */
	@Override
	int compareAt(int index, TupRBigd t);
     ...
     */
	@Override
	int compareAt(int index, BigDecimal... t);
     ...
     * the given tuple.
     */
	int compareAt(BigDecimal tolerance, int index, Tup3RBigd t);
     ...
     */
	@Override
	int compareAt(BigDecimal tolerance, int index, TupRBigd t);
     ...
     */
	@Override
	int compareAt(BigDecimal tolerance, int index, BigDecimal... t);
     ...
     * the given tuple.
     */
	int compareAtV0(BigDecimal tolerance, Tup3RBigd t);
     ...
     * the given tuple.
     */
	int compareAtV0(BigDecimal tolerance, TupRBigd t);
     ...
     * the given tuple.
     */
	int compareAtV0(BigDecimal tolerance, BigDecimal... t);
     ...
     * the given tuple.
     */
	int compareAtV1(BigDecimal tolerance, Tup3RBigd t);
     ...
     * the given tuple.
     */
	int compareAtV1(BigDecimal tolerance, TupRBigd t);
     ...
     * the given tuple.
     */
	int compareAtV1(BigDecimal tolerance, BigDecimal... t);
     ...
     * the given tuple.
     */
	int compareAtV2(BigDecimal tolerance, Tup3RBigd t);
     ...
     * the given tuple.
     */
	int compareAtV2(BigDecimal tolerance, TupRBigd t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(BigDecimal[]) compareAtV1(BigDecimal...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(BigDecimal tolerance, BigDecimal... t);
