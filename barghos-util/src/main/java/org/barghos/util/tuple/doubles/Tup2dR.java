...
import org.barghos.util.consumer.doubles.Consumer2d;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for
 * double tuples with two dimensions.
 */
public interface Tup2dR extends TupdR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2dR createNew(TupdR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2dR} this will be two.
	 * 
	...
	@Deprecated
	@Override
	default Tup2dR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2dR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup2dR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2dR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer2d consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptDouble(v0(), v1());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer2<Double,Double> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
