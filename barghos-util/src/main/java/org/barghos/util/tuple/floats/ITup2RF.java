...
public interface ITup2RF extends ITupRF
{
	 ...
	 * component values.
	 */
	ITup2RF createNew(float v0, float v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link ITup2RF} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(float tolerance, @AllowNull ITup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(float tolerance, float v0, float v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(float tolerance, int index, @AllowNull ITup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(float tolerance, @AllowNull ITup2RF t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(float tolerance, @AllowNull ITup2RF t);
	 ...
	 */
	ITup2RF arrangeN(int[] indices);
	
	float[] arrangeT(int[] indices, @ExtractionParam float[] res);
	
	<T extends ITup2WF> T arrangeT(int[] indices, @ExtractionParam T res);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	ITup2RF arrangeN(int indexV0, int indexV1);
	
	float[] arrangeT(int indexV0, int indexV1, @ExtractionParam float[] res);
	
	<T extends ITup2WF> T arrangeT(int indexV0, int indexV1, @ExtractionParam T res);
	 ...
	 */
	@Override
	ITup2RF swizzleN(int indexA, int indexB);
	
	float[] swizzleT(int indexA, int indexB, @ExtractionParam float[] res);
	
	<T extends ITup2WF> T swizzleT(int indexA, int indexB, @ExtractionParam T res);
	 ...
	 */
	ITup2RF swizzleV0V1N();
	
	float[] swizzleV0V1T(@ExtractionParam float[] res);
	
	<T extends ITup2WF> T swizzleV0V1T(@ExtractionParam T res);

	ITup2RF minComponentsN(ITup2RF t);
	
	ITup2RF minComponentsN(ITupRF t);
	
	ITup2RF minComponentsN(float[] t);
	
	ITup2RF minComponentsN(float tv0, float tv1);
	...
	ITup2RF maxComponentsN(ITup2RF t);
	
	ITup2RF maxComponentsN(ITupRF t);
	
	ITup2RF maxComponentsN(float[] t);
	
	ITup2RF maxComponentsN(float tv0, float tv1);
