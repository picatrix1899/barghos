...
/**
 * This interface provides the common functions and methods for string tuples with flexible
 * dimension counts.
 */
public interface TupstrC extends TupstrR
{
	...
	/**
	 * Adopts the component values from an existing instance of {@link TupstrR}. If the other tuple
