...
public interface Tup2iR extends TupiR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2iR createNew(TupiR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2iR} this will be two.
	 * 
	...
	@Deprecated
	@Override
	default Tup2iR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2iR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup2iR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup2iR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer2i consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptInt(v0(), v1());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer2<Integer,Integer> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
