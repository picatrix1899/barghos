 ...
 */
public interface FixTupWL extends TupWL, FixTupRL
{
	/**
	...
	/** {@inheritDoc} */
	@Override
	FixTupWL createNew(TupRL t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWL createNew(long... t);
	 ...
	 */
	@Override
	FixTupWL setAt(int index, long value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWL arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWL swizzleN(int indexA, int indexB);
	 ...
	 */
	@Override
	FixTupWL swizzle(int indexA, int indexB);
}
