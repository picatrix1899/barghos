 ...
 */
public interface Tup2RL extends FixTupRL
{
	/**
	 ...
	 * component values.
	 */
	Tup2RL createNew(long v0, long v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RL} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(long v0, long v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(long tolerance, @Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(long tolerance, long v0, long v1);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(long tolerance, int index, @Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(long tolerance, @Nullable Tup2RL t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(long tolerance, @Nullable Tup2RL t);
	 ...
	 */
	@Override
	Tup2RL swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup2RL t);
     ...
     * the given tuple.
     */
	int compareAt(long tolerance, int index, Tup2RL t);
     ...
     * the given tuple.
     */
	int compareAtV0(long tolerance, Tup2RL t);
     ...
     * the given tuple.
     */
	int compareAtV1(long tolerance, Tup2RL t);
