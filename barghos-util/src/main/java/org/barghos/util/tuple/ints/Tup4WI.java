 ...
 * components.
 */
public interface Tup4WI extends Tup4RI, FixTupWI
{
	/** {@inheritDoc} */
	@Override
	Tup4WI createNew(Tup4RI t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WI createNew(TupRI t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WI createNew(int... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WI createNew(int value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WI createNew(int v0, int v1, int v2, int v3);
	 ...
	 */
	@Override
	Tup4WI setAt(int index, int value);
	 ...
	 * @return This tuple.
	 */
	Tup4WI set(int v0, int v1, int v2, int v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WI arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WI arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WI swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup4WI arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WI swizzle(int indexA, int indexB);
