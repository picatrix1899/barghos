 ...
 */
public interface Tup3RL extends FixTupRL
{
	/**
	 ...
	 * component values.
	 */
	Tup3RL createNew(long v0, long v1, long v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RL} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(long v0, long v1, long v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(long tolerance, long v0, long v1, long v2);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #equalsAtV2(long[]) equalsAtV1(long...)}.
	 * 
	 * <p>
	 * <b>Formula:</b>
	 * <br>
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RL arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RL swizzleN(int indexA, int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, Tup3RL t);
     ...
     */
	@Override
	int compareAt(int index, TupRL t);
     ...
     */
	@Override
	int compareAt(int index, long... t);
     ...
     * the given tuple.
     */
	int compareAt(long tolerance, int index, Tup3RL t);
     ...
     */
	@Override
	int compareAt(long tolerance, int index, TupRL t);
     ...
     */
	@Override
	int compareAt(long tolerance, int index, long... t);
     ...
     * the given tuple.
     */
	int compareAtV0(long tolerance, Tup3RL t);
     ...
     * the given tuple.
     */
	int compareAtV0(long tolerance, TupRL t);
     ...
     * the given tuple.
     */
	int compareAtV0(long tolerance, long... t);
     ...
     * the given tuple.
     */
	int compareAtV1(long tolerance, Tup3RL t);
     ...
     * the given tuple.
     */
	int compareAtV1(long tolerance, TupRL t);
     ...
     * the given tuple.
     */
	int compareAtV1(long tolerance, long... t);
     ...
     * the given tuple.
     */
	int compareAtV2(long tolerance, Tup3RL t);
     ...
     * the given tuple.
     */
	int compareAtV2(long tolerance, TupRL t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0.0f. A tolerance of 0.0f behaves like
	 * {@link #compareAtV2(long[]) compareAtV1(long...)}.
	 * 
     * <p>
	 * The third component in the given tuple has to be available.
     *
     ...
     * the given tuple.
     */
	int compareAtV2(long tolerance, long... t);
