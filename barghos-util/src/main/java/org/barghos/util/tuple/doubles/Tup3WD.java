 ...
 * components.
 */
public interface Tup3WD extends Tup3RD, FixTupWD
{
	/** {@inheritDoc} */
	@Override
	Tup3WD createNew(Tup3RD t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WD createNew(TupRD t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WD createNew(double... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WD createNew(double value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WD createNew(double v0, double v1, double v2);
	 ...
	 */
	@Override
	Tup3WD setAt(int index, double value);
	 ...
	 * @return This tuple.
	 */
	Tup3WD set(double v0, double v1, double v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WD arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WD arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WD swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup3WD arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WD swizzle(int indexA, int indexB);
