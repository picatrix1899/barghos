...
/**
 * This interface provides non-invasive (read only) functions and methods for {@link BigInteger} tuples with flexible dimension counts.
 */
public interface TupbigiR
{
	 ...
	 */
	BigInteger getByIndex(@IntMinValue(0) int index);
	...
	{
		return toArray(new BigInteger[dimensions()]);
	}
