...
/**
 * This interface provides non-invasive (read only) functions and methods for {@link BigDecimal} tuples with flexible dimension counts.
 */
public interface TupbigdR
{
	...
	{
		return toArray(new BigDecimal[dimensions()]);
	}
