...
/**
 * This interface provides non-modifying operations for short tuples with an
...
public interface RTupleBaseS
{
	 ...
	 * component values.
	 */
	RTupleBaseS createNew(RTupleBaseS t);
	 ...
	 */
	short getAt(@IntMinValue(0) int index);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean zero(@ShortMinValue(0) short tolerance);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean zeroAt(@ShortMinValue(0) short tolerance, @IntMinValue(0) int index);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@Nullable RTupleBaseS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@ShortMinValue(0) short tolerance, @Nullable RTupleBaseS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@ShortMinValue(0) short tolerance, @Nullable short... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@ShortMinValue(0) short tolerance, short value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, @Nullable RTupleBaseS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, @Nullable short... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@IntMinValue(0) int index, short value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@ShortMinValue(0) short tolerance, @IntMinValue(0) int index, @Nullable RTupleBaseS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@ShortMinValue(0) short tolerance, @IntMinValue(0) int index, @Nullable short... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(@ShortMinValue(0) short tolerance, @IntMinValue(0) int index, short value);
	 ...
	 */
	RTupleBaseS arrangeN(@IntMinValue(0) int... indices);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	RTupleBaseS swizzleN(@IntMinValue(0) int indexA, @IntMinValue(0) int indexB);
     ...
     * the given tuple.
     */
	int compareAt(int index, RTupleBaseS t);
	 ...
	 * <p>
	 * The minimum allowed tolerance is 0. A tolerance of 0 behaves like
	 * {@link #compareAt(int, RTupleBaseS) compareAt(int, RTupleBaseS)}.
	 * 
     * <p>
	 * The valid index range is from 0 to {@link #size()} - 1.
     *
     ...
     * the given tuple.
     */
	int compareAt(@ShortMinValue(0) short tolerance, int index, @Nullable RTupleBaseS t);
     ...
     * the given tuple.
     */
	int compareAt(@ShortMinValue(0) short tolerance, int index, @Nullable short... t);
     ...
     * {@code 1} - If the component value is greater than the given value.
     */
	int compareAt(@ShortMinValue(0) short tolerance, int index, short value);
}
