 ...
 */
public interface FixTupWObj extends TupWObj, FixTupRObj
{
	/**
	 ...
	 * this tuple.
	 */
	FixTupWObj createNew();
	
	/** {@inheritDoc} */
	@Override
	FixTupWObj createNew(TupRObj t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWObj createNew(Object... t);
	 ...
	 */
	@Override
	FixTupWObj setAt(int index, Object value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWObj arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWObj swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	FixTupWObj arrange(int... indices);
	 ...
	 */
	@Override
	FixTupWObj swizzle(int indexA, int indexB);
}
