...
/**
 * This interface provides non-modifying operations for Object tuples with a
 ...
 * tuple.
 */
public interface VarTupRObj extends TupRObj
{
	/**
	 ...
	 * component values.
	 */
	VarTupRObj createNew(TupRObj t);
	 ...
	 */
	VarTupRObj arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRObj swizzleN(int indexA, int indexB);
}
