...
/**
 * This interface provides common operations for byte tuples.
 * 
 * <p>
 ...
 */
public interface TupWB extends TupRB
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWB setAt(int index, byte value);
	...
	/** {@inheritDoc} */
	@Override
	TupWB swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWB swizzle(int indexA, int indexB);
}
