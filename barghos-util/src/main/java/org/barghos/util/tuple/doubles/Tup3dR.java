...
import org.barghos.util.consumer.doubles.Consumer3d;

import org.barghos.validation.Validation;

/**
 * This interface provides non-invasive (read only) functions and methods for
 * double tuples with three dimensions.
 */
public interface Tup3dR extends TupdR
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup3dR createNew(TupdR t)
	{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3dR} this will be
	 * three.
	 * 
	...
	@Deprecated
	@Override
	default Tup3dR resizeN(int size)
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup3dR rearrangeN(int[] indices)
	{
	...
	@Deprecated
	@Override
	default Tup3dR rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup3dR swapByIndexN(int indexA, int indexB)
	{
	 ...
	 */
	default void passTo(Consumer3d consumer)
	{
		Validation.validateNotNull("consumer", consumer);
		
		consumer.acceptDouble(v0(), v1(), v2());
	}
	 ...
	 * @param consumer The consumer receiving the tuple.
	 */
	default void passTo(Consumer3<Double,Double,Double> consumer)
	{
		Validation.validateNotNull("consumer", consumer);
