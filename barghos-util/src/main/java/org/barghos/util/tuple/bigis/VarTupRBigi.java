 ...
 * tuples with a varying number of components. Therefore the operations of this
 * interface will not alter the component values of this tuple, not the size of
 * this tuple but may create new tuple instances with different sizes than the
 * size of this tuple.
 */
public interface VarTupRBigi extends TupRBigi
{
	/**
	 ...
	 * component values.
	 */
	VarTupRBigi createNew(TupRBigi t);
	 ...
	 * values.
	 */
	VarTupRBigi createNew(BigInteger... t);
	 ...
	 */
	VarTupRBigi arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRBigi swizzleN(int indexA, int indexB);
}
