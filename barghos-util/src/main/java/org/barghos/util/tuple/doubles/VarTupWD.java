...
/**
 * This interface provides common operations for double tuples with a
 * varying number of components.
 */
public interface VarTupWD extends TupWD, VarTupRD
{
	/**
	 ...
	 */
	@Override
	VarTupWD createNew(double... t);
	
	/** {@inheritDoc} */
	@Override
	VarTupWD setAt(int index, double value);
	 ...
	 */
	@Override
	VarTupWD arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWD swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	VarTupWD arrange(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWD swizzle(int indexA, int indexB);
}
