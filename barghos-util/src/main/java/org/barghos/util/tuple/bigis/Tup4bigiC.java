 ...
 * {@link BigInteger} tuples with four dimensions.
 */
public interface Tup4bigiC extends Tup4bigiR, TupbigiC
{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC createNew(TupbigiR t)
	{
	 ...
	 * {@link Tup4bigiR}.
	 * 
	 * @param t An existing implementation of {@link Tup4bigiR} to adopt the
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC setArray(@MinLength(4) BigInteger... t)
	{
	...
	@Deprecated
	@Override
	default Tup4bigiC setResize(TupbigiR t)
	{
	...
	@Deprecated
	@Override
	default Tup4bigiC setArrayResize(BigInteger... t)
	{
		throw new UnsupportedOperationException();
	}
	...
	@Deprecated
	@Override
	default Tup4bigiC resizeN(int size)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC rearrangeN(int[] indices)
	{
		...
		BigInteger v3 = getByIndex(indices[3]);
	...
	@Deprecated
	@Override
	default Tup4bigiC rearrangeResizeN(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapV0AndV1N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapV0AndV2N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapV0AndV3N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapV1AndV2N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapV1AndV3N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapV2AndV3N()
	{
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapByIndexN(int indexA, int indexB)
	{
	...
	@Deprecated
	@Override
	default Tup4bigiC resize(int size)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC rearrange(int[] indices)
	{
		Validation.validateNotNull("indices", indices);
		Validation.validateExpectSize("indices", indices, 4);
	...
	@Deprecated
	@Override
	default Tup4bigiC rearrangeResize(int[] indices)
	{
		throw new UnsupportedOperationException();
	}
	...
	/** {@inheritDoc}} */
	@Override
	default Tup4bigiC swapByIndex(int indexA, int indexB)
	{
		Validation.validateInRange("indexA", indexA, 0, 3);
		Validation.validateInRange("indexB", indexB, 0, 3);
