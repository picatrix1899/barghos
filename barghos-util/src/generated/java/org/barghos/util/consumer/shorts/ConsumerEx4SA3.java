...
public interface ConsumerEx4SA3 extends ConsumerEx4<short[][][],short[][][],short[][][],short[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4SA3 then(ConsumerEx4SA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4SA3 then(ConsumerEx4<? super short[][][],? super short[][][],? super short[][][],? super short[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4SA3 before(ConsumerEx4SA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4SA3 before(ConsumerEx4<? super short[][][],? super short[][][],? super short[][][],? super short[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4SA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx4SA3 onEx(ConsumerEx4SA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4SA3 onEx(ConsumerEx4<? super short[][][],? super short[][][],? super short[][][],? super short[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4SA3 onEx(Consumer4SA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4SA3 onEx(Consumer4<? super short[][][],? super short[][][],? super short[][][],? super short[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx4SA3 of(ConsumerEx4SA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4SA3 consumer : consumers) consumer.acceptS(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4SA3 of(ConsumerEx4<? super short[][][],? super short[][][],? super short[][][],? super short[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4SA3 of(Consumer4SA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4SA3 consumer : consumers) consumer.accept(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4SA3 of(Consumer4<? super short[][][],? super short[][][],? super short[][][],? super short[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
