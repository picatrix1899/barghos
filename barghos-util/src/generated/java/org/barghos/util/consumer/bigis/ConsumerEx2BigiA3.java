 ...
 * arguments and returns no result. Unlike {@link Consumer2BigiA3} this may throw
 * exceptions. {@link ConsumerEx2BigiA3} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx2BigiA3 extends ConsumerEx2<BigInteger[][][],BigInteger[][][]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx2BigiA3} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx2BigiA3} performing the given operations in
	 * sequence.
	 * 
