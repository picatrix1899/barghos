...
/**
 * Represents an operation that accepts four 1-dimensional BigDecimal array input
 * arguments and returns no result. Unlike {@link Consumer4BigdA} this may throw
 * exceptions. {@link ConsumerEx4BigdA} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx4BigdA extends ConsumerEx4<BigDecimal[],BigDecimal[],BigDecimal[],BigDecimal[]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx4BigdA} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx4BigdA} performing the given operations in
	 * sequence.
	 * 
