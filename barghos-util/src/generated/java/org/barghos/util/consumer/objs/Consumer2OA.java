...
public interface Consumer2OA extends Consumer2<Object[],Object[]>
{
	 ...
	 * operation after.
	 */
	default Consumer2OA then(Consumer2OA after)
	{
	 ...
	 */
	@Override
	default Consumer2OA then(Consumer2<? super Object[],? super Object[]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default Consumer2OA before(Consumer2OA before)
	{
	 ...
	 */
	@Override
	default Consumer2OA before(Consumer2<? super Object[],? super Object[]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	@SafeVarargs
	static Consumer2OA of(Consumer2OA... consumers)
	{
		...
		return (a, b) -> { for(Consumer2OA consumer : consumers) consumer.acceptO(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static Consumer2OA of(Consumer2<? super Object[],? super Object[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static Consumer2OA of(java.util.function.BiConsumer<? super Object[],? super Object[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
