 ...
 * arguments and returns no result. Unlike {@link Consumer3BigdA3} this may throw
 * exceptions. {@link ConsumerEx3BigdA3} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx3BigdA3 extends ConsumerEx3<BigDecimal[][][],BigDecimal[][][],BigDecimal[][][]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx3BigdA3} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx3BigdA3} performing the given operations in
	 * sequence.
	 * 
