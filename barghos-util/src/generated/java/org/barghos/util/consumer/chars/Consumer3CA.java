...
public interface Consumer3CA extends Consumer3<char[],char[],char[]>
{
	 ...
	 * operation after.
	 */
	default Consumer3CA then(Consumer3CA after)
	{
	 ...
	 */
	@Override
	default Consumer3CA then(Consumer3<? super char[],? super char[],? super char[]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default Consumer3CA before(Consumer3CA before)
	{
	 ...
	 */
	@Override
	default Consumer3CA before(Consumer3<? super char[],? super char[],? super char[]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	static Consumer3CA of(Consumer3CA... consumers)
	{
		...
		return (a, b, c) -> { for(Consumer3CA consumer : consumers) consumer.acceptC(a, b, c); };
	}
