...
public interface ConsumerEx2StrA2 extends ConsumerEx2<String[][],String[][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2StrA2 then(ConsumerEx2StrA2 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx2StrA2 then(ConsumerEx2<? super String[][],? super String[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx2StrA2 then(java.util.function.BiConsumer<? super String[][],? super String[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx2StrA2 before(ConsumerEx2StrA2 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx2StrA2 before(ConsumerEx2<? super String[][],? super String[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default ConsumerEx2StrA2 before(java.util.function.BiConsumer<? super String[][],? super String[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer2StrA2 handleEx(ExceptionHandler handler)
	{
	...
	@Override
	default Consumer2StrA2 ignoreEx()
	{
		return (a, b) -> {
			try
			{
	...
	default ConsumerEx2StrA2 onEx(ConsumerEx2StrA2 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx2StrA2 onEx(ConsumerEx2<? super String[][],? super String[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer2StrA2 onEx(Consumer2StrA2 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer2StrA2 onEx(Consumer2<? super String[][], ? super String[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@Override
	default Consumer2StrA2 onEx(java.util.function.BiConsumer<? super String[][],? super String[][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx2StrA2 of(ConsumerEx2StrA2... consumers)
	{
		...
		return (a, b) -> { for(ConsumerEx2StrA2 consumer : consumers) consumer.acceptStr(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2StrA2 of(ConsumerEx2<? super String[][],? super String[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2StrA2 of(Consumer2StrA2... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b) -> { for(Consumer2StrA2 consumer : consumers) consumer.accept(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2StrA2 of(Consumer2<? super String[][],? super String[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2StrA2 of(java.util.function.BiConsumer<? super String[][],? super String[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
