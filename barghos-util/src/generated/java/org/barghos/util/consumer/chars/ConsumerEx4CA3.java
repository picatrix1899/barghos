...
public interface ConsumerEx4CA3 extends ConsumerEx4<char[][][],char[][][],char[][][],char[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4CA3 then(ConsumerEx4CA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4CA3 then(ConsumerEx4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4CA3 before(ConsumerEx4CA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4CA3 before(ConsumerEx4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4CA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx4CA3 onEx(ConsumerEx4CA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4CA3 onEx(ConsumerEx4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4CA3 onEx(Consumer4CA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4CA3 onEx(Consumer4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx4CA3 of(ConsumerEx4CA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4CA3 consumer : consumers) consumer.acceptC(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4CA3 of(ConsumerEx4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4CA3 of(Consumer4CA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4CA3 consumer : consumers) consumer.accept(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4CA3 of(Consumer4<? super char[][][],? super char[][][],? super char[][][],? super char[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
