 ...
 * arguments and returns no result. Unlike {@link Consumer3BigdA} this may throw
 * exceptions. {@link ConsumerEx3BigdA} is expected to operate via side-effects.
 *
 * <p>
...
public interface ConsumerEx3BigdA extends ConsumerEx3<BigDecimal[],BigDecimal[],BigDecimal[]>
{
	 ...
	 * 
	 * @return A new {@link ConsumerEx3BigdA} performing the operation before and
	 * this operation.
	 */
	...
	/**
	 * Composes a new {@link ConsumerEx3BigdA} performing the given operations in
	 * sequence.
	 * 
