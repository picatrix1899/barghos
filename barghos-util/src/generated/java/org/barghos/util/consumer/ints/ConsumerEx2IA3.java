...
public interface ConsumerEx2IA3 extends ConsumerEx2<int[][][],int[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2IA3 then(ConsumerEx2IA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx2IA3 then(ConsumerEx2<? super int[][][],? super int[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx2IA3 then(java.util.function.BiConsumer<? super int[][][],? super int[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx2IA3 before(ConsumerEx2IA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx2IA3 before(ConsumerEx2<? super int[][][],? super int[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default ConsumerEx2IA3 before(java.util.function.BiConsumer<? super int[][][],? super int[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer2IA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx2IA3 onEx(ConsumerEx2IA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx2IA3 onEx(ConsumerEx2<? super int[][][],? super int[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer2IA3 onEx(Consumer2IA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer2IA3 onEx(Consumer2<? super int[][][], ? super int[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@Override
	default Consumer2IA3 onEx(java.util.function.BiConsumer<? super int[][][],? super int[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx2IA3 of(ConsumerEx2IA3... consumers)
	{
		...
		return (a, b) -> { for(ConsumerEx2IA3 consumer : consumers) consumer.acceptI(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2IA3 of(ConsumerEx2<? super int[][][],? super int[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2IA3 of(Consumer2IA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b) -> { for(Consumer2IA3 consumer : consumers) consumer.accept(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2IA3 of(Consumer2<? super int[][][],? super int[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2IA3 of(java.util.function.BiConsumer<? super int[][][],? super int[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
