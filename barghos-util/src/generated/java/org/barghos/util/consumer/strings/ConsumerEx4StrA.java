...
public interface ConsumerEx4StrA extends ConsumerEx4<String[],String[],String[],String[]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4StrA then(ConsumerEx4StrA after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4StrA then(ConsumerEx4<? super String[],? super String[],? super String[],? super String[]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4StrA before(ConsumerEx4StrA before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4StrA before(ConsumerEx4<? super String[],? super String[],? super String[],? super String[]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4StrA handleEx(ExceptionHandler handler)
	{
	...
	@Override
	default Consumer4StrA ignoreEx()
	{
		return (a, b, c, d) -> {
			try
			{
	...
	default ConsumerEx4StrA onEx(ConsumerEx4StrA consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4StrA onEx(ConsumerEx4<? super String[],? super String[],? super String[],? super String[]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4StrA onEx(Consumer4StrA consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4StrA onEx(Consumer4<? super String[],? super String[],? super String[],? super String[]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx4StrA of(ConsumerEx4StrA... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4StrA consumer : consumers) consumer.acceptStr(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4StrA of(ConsumerEx4<? super String[],? super String[],? super String[],? super String[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4StrA of(Consumer4StrA... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4StrA consumer : consumers) consumer.accept(a, b, c, d); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx4StrA of(Consumer4<? super String[],? super String[],? super String[],? super String[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
