...
public interface ConsumerEx2FA3 extends ConsumerEx2<float[][][],float[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2FA3 then(ConsumerEx2FA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx2FA3 then(ConsumerEx2<? super float[][][],? super float[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx2FA3 then(java.util.function.BiConsumer<? super float[][][],? super float[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx2FA3 before(ConsumerEx2FA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx2FA3 before(ConsumerEx2<? super float[][][],? super float[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default ConsumerEx2FA3 before(java.util.function.BiConsumer<? super float[][][],? super float[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer2FA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx2FA3 onEx(ConsumerEx2FA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx2FA3 onEx(ConsumerEx2<? super float[][][],? super float[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer2FA3 onEx(Consumer2FA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer2FA3 onEx(Consumer2<? super float[][][], ? super float[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@Override
	default Consumer2FA3 onEx(java.util.function.BiConsumer<? super float[][][],? super float[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@SafeVarargs
	static ConsumerEx2FA3 of(ConsumerEx2FA3... consumers)
	{
		...
		return (a, b) -> { for(ConsumerEx2FA3 consumer : consumers) consumer.acceptF(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2FA3 of(ConsumerEx2<? super float[][][],? super float[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2FA3 of(Consumer2FA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b) -> { for(Consumer2FA3 consumer : consumers) consumer.accept(a, b); };
	}
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2FA3 of(Consumer2<? super float[][][],? super float[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	...
	@SuppressWarnings("unused")
	@SafeVarargs
	static ConsumerEx2FA3 of(java.util.function.BiConsumer<? super float[][][],? super float[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
