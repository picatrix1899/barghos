...
public interface Tup3RB extends FixTupRB
{
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(byte tolerance, @AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(byte tolerance, int index, @AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(byte tolerance, @AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(byte tolerance, @AllowNull Tup3RB t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(byte tolerance, @AllowNull Tup3RB t);
