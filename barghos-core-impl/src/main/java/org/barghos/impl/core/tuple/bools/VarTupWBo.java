 ...
 */
public interface VarTupWBo extends TupWBo, VarTupRBo
{
	/**
	 ...
	 */
	@Override
	VarTupWBo createNew(boolean... t);
	
	/** {@inheritDoc} */
	@Override
	VarTupWBo setAt(int index, boolean value);
	 ...
	 */
	@Override
	VarTupWBo arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWBo swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	VarTupWBo arrange(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWBo swizzle(int indexA, int indexB);
}
