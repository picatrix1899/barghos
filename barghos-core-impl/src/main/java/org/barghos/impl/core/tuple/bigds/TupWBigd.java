...
/**
 * This interface provides common operations for {@link BigDecimal} tuples.
 * 
 * <p>
 ...
 */
public interface TupWBigd extends TupRBigd
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWBigd setAt(int index, BigDecimal value);
	...
	/** {@inheritDoc} */
	@Override
	TupWBigd swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWBigd swizzle(int indexA, int indexB);
}
