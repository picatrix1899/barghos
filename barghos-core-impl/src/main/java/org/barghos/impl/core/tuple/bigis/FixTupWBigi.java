 ...
 * a implicit fixed number of components. Therefore the operations of this
 ...
 */
public interface FixTupWBigi extends TupWBigi, FixTupRBigi
{
	/**
	 ...
	 * this tuple.
	 */
	FixTupWBigi createNew();
	
	/** {@inheritDoc} */
	@Override
	FixTupWBigi createNew(TupRBigi t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWBigi createNew(BigInteger... t);
	 ...
	 */
	@Override
	FixTupWBigi setAt(int index, BigInteger value);
	 ...
	 */
	@Override
	FixTupWBigi set(BigInteger value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWBigi arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWBigi swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	FixTupWBigi arrange(int... indices);
	 ...
	 */
	@Override
	FixTupWBigi swizzle(int indexA, int indexB);
}
