...
/**
 * This interface provides common operations for char tuples with a
 * varying number of components.
 */
public interface VarTupWC extends TupWC, VarTupRC
{
	/**
	 ...
	 */
	@Override
	VarTupWC createNew(char... t);
	
	/** {@inheritDoc} */
	@Override
	VarTupWC setAt(int index, char value);
	 ...
	 */
	@Override
	VarTupWC arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWC swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	VarTupWC arrange(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWC swizzle(int indexA, int indexB);
}
