 ...
 * three components.
 */
public interface Tup4WBigd extends Tup4RBigd, FixTupWBigd
{
	/** {@inheritDoc} */
	@Override
	Tup4WBigd createNew(Tup4RBigd t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd createNew(TupRBigd t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd createNew(BigDecimal... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd createNew(BigDecimal value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd createNew(BigDecimal v0, BigDecimal v1, BigDecimal v2, BigDecimal v3);
	 ...
	 */
	@Override
	Tup4WBigd setAt(int index, BigDecimal value);
	 ...
	 */
	@Override
	Tup4WBigd set(BigDecimal... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd set(BigDecimal value);
	 ...
	 * @return This tuple.
	 */
	Tup4WBigd set(BigDecimal v0, BigDecimal v1, BigDecimal v2, BigDecimal v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WBigd arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleV0V1N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleV0V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleV0V3N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleV1V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleV1V3N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WBigd swizzleV2V3N();
	 ...
	 * @return This tuple.
	 */
	Tup4WBigd arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WBigd swizzle(int indexA, int indexB);
