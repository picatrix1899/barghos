 ...
 * components.
 */
public interface Tup3WO extends Tup3RO, FixTupWO
{
	/** {@inheritDoc} */
	@Override
	Tup3WO createNew(Tup3RO t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WO createNew(TupRO t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WO createNew(Object... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WO createNew(Object value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WO createNew(Object v0, Object v1, Object v2);
	 ...
	 */
	@Override
	Tup3WO setAt(int index, Object value);
	 ...
	 * @return This tuple.
	 */
	Tup3WO set(Object v0, Object v1, Object v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WO arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WO arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WO swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup3WO arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WO swizzle(int indexA, int indexB);
