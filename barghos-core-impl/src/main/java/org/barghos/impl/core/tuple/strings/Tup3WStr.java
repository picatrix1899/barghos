 ...
 * components.
 */
public interface Tup3WStr extends Tup3RStr, FixTupWStr
{
	/** {@inheritDoc} */
	@Override
	Tup3WStr createNew(Tup3RStr t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr createNew(TupRStr t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr createNew(String... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr createNew(String value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr createNew(String v0, String v1, String v2);
	 ...
	 */
	@Override
	Tup3WStr setAt(int index, String value);
	 ...
	 */
	@Override
	Tup3WStr set(String... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr set(String value);
	 ...
	 * @return This tuple.
	 */
	Tup3WStr set(String v0, String v1, String v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WStr arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr swizzleV0V1N();
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr swizzleV0V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup3WStr swizzleV1V2N();
	 ...
	 * @return This tuple.
	 */
	Tup3WStr arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WStr swizzle(int indexA, int indexB);
