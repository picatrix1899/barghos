package org.barghos.impl.core.metrics;
...
public class CumulativeStopwatch
{
	...
	{
		public static final Format SEC = (sec, _, _, _) -> sec + "s";
		public static final Format SEC_MILLI = (sec, milli, _, _) -> sec + "s/" + milli + "ms";
		public static final Format SEC_MILLI_MICRO = (sec, milli, micro, _) -> sec + "s/" + milli + "ms/" + micro + "µs";
		public static final Format SEC_MILLI_MICRO_NANO = (sec, milli, micro, nano) -> sec + "s/" + milli + "ms/" + micro + "µs/" + nano + "ns";
		
		public static final Format MILLI = (_, milli, _, _) -> milli + "ms";
		public static final Format MILLI_MICRO = (_, milli, micro, _) -> milli + "ms/" + micro + "µs";
		public static final Format MILLI_MICRO_NANO = (_, milli, micro, nano) -> milli + "ms/" + micro + "µs/" + nano + "ns";
		
		public static final Format MICRO = (_, _, micro, _) -> micro + "µs";
		public static final Format MICRO_NANO = (_, _, micro, nano) -> micro + "µs/" + nano + "ns";
		
		public static final Format NANO = (_, _, _, nano) -> nano + "ns";
