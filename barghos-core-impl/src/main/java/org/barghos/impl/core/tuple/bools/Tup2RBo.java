 ...
 */
public interface Tup2RBo extends FixTupRBo
{
	/**
	 ...
	 */
	Tup2RBo createNew(boolean value);
	 ...
	 * component values.
	 */
	Tup2RBo createNew(boolean v0, boolean v1);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup2RBo} this will
	 * be always two.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(boolean v0, boolean v1);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup2RBo arrangeN(int i0, int i1);
	 ...
	 */
	@Override
	Tup2RBo swizzleN(int indexA, int indexB);
