 ...
 */
public interface VarTupWL extends TupWL, VarTupRL
{
	/**
	 ...
	 */
	@Override
	VarTupWL createNew(long... t);
	
	/** {@inheritDoc} */
	@Override
	VarTupWL setAt(int index, long value);
	 ...
	 */
	@Override
	VarTupWL arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWL swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	VarTupWL arrange(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWL swizzle(int indexA, int indexB);
}
