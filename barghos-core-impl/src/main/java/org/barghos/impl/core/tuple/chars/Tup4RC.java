...
public interface Tup4RC extends FixTupRC
{
	 ...
	 */
	boolean equals(@AllowNull Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull Tup4RC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull TupRC t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull char... t);
