...
public interface ITup4RD extends ITupRD
{
	 ...
	 * 
	 * <p>
	 * For any derivative or implementation of {@link ITup4RD} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(double tolerance, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(double tolerance, int index, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull ITupRD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull ITupRD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(double tolerance, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(double tolerance, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(double tolerance, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(double tolerance, @AllowNull ITupRD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double tolerance, @AllowNull ITup4RD t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(double tolerance, @AllowNull ITupRD t);
