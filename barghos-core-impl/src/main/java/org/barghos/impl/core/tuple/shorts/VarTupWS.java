 ...
 */
public interface VarTupWS extends TupWS, VarTupRS
{
	/**
	 ...
	 */
	@Override
	VarTupWS createNew(short... t);
	
	/** {@inheritDoc} */
	@Override
	VarTupWS setAt(int index, short value);
	 ...
	 */
	@Override
	VarTupWS arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWS swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	VarTupWS arrange(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupWS swizzle(int indexA, int indexB);
}
