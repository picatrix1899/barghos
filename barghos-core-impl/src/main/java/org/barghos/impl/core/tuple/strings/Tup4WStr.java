...
/**
 * This interface provides common operations for string tuples with three
 * components.
 */
public interface Tup4WStr extends Tup4RStr, FixTupWStr
{
	/** {@inheritDoc} */
	@Override
	Tup4WStr createNew(Tup4RStr t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr createNew(TupRStr t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr createNew(String... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr createNew(String value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr createNew(String v0, String v1, String v2, String v3);
	 ...
	 */
	@Override
	Tup4WStr setAt(int index, String value);
	 ...
	 */
	@Override
	Tup4WStr set(String... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr set(String value);
	 ...
	 * @return This tuple.
	 */
	Tup4WStr set(String v0, String v1, String v2, String v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WStr arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleV0V1N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleV0V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleV0V3N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleV1V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleV1V3N();
	
	/** {@inheritDoc} */
	@Override
	Tup4WStr swizzleV2V3N();
	 ...
	 * @return This tuple.
	 */
	Tup4WStr arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WStr swizzle(int indexA, int indexB);
