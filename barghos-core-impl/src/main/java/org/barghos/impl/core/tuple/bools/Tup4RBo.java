package org.barghos.impl.core.tuple.bools;
 ...
 */
public interface Tup4RBo extends FixTupRBo
{
	/**
	 ...
	 */
	Tup4RBo createNew(boolean value);
	 ...
	 * component values.
	 */
	Tup4RBo createNew(boolean v0, boolean v1, boolean v2, boolean v3);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup4RBo} this will
	 * be always four.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@AllowNull Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(boolean v0, boolean v1, boolean v2, boolean v3);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup4RBo t);
	 ...
	 */
	@Override
	boolean equalsAt(int index, boolean value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(boolean value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(boolean value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull TupRBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull boolean... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(boolean value);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull Tup4RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull TupRBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(@AllowNull boolean... t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV3(boolean value);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup4RBo arrangeN(int i0, int i1, int i2, int i3);
	 ...
	 */
	@Override
	Tup4RBo swizzleN(int indexA, int indexB);
