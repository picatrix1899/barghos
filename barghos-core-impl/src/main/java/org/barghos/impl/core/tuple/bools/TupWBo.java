...
/**
 * This interface provides common operations for boolean tuples.
 * 
 * <p>
 ...
 */
public interface TupWBo extends TupRBo
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWBo setAt(int index, boolean value);
	...
	/** {@inheritDoc} */
	@Override
	TupWBo swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWBo swizzle(int indexA, int indexB);
}
