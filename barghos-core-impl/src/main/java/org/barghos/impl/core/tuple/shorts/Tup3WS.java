 ...
 * components.
 */
public interface Tup3WS extends Tup3RS, FixTupWS
{
	/** {@inheritDoc} */
	@Override
	Tup3WS createNew(Tup3RS t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WS createNew(TupRS t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WS createNew(short... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WS createNew(short value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WS createNew(short v0, short v1, short v2);
	 ...
	 */
	@Override
	Tup3WS setAt(int index, short value);
	 ...
	 * @return This tuple.
	 */
	Tup3WS set(short v0, short v1, short v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WS arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WS arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WS swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup3WS arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WS swizzle(int indexA, int indexB);
