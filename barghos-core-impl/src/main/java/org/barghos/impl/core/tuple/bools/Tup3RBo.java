 ...
 */
public interface Tup3RBo extends FixTupRBo
{
	/**
	 ...
	 */
	Tup3RBo createNew(boolean value);
	 ...
	 * component values.
	 */
	Tup3RBo createNew(boolean v0, boolean v1, boolean v2);
	
	/**
	 * {@inheritDoc}
	 * 
	 * <p>
	 * For any derivative or implementation of {@link Tup3RBo} this will
	 * be always three.
	 * 
	 * @apiNote
	 ...
	 */
	boolean equals(@AllowNull Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(boolean v0, boolean v1, boolean v2);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup3RBo t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull Tup3RBo t);
	 ...
	 * @return A new instance of this type of tuple with the result.
	 */
	Tup3RBo arrangeN(int i0, int i1, int i2);
	 ...
	 */
	@Override
	Tup3RBo swizzleN(int indexA, int indexB);
