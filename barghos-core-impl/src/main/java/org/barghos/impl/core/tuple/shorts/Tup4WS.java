...
/**
 * This interface provides common operations for short tuples with three
 * components.
 */
public interface Tup4WS extends Tup4RS, FixTupWS
{
	/** {@inheritDoc} */
	@Override
	Tup4WS createNew(Tup4RS t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WS createNew(TupRS t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WS createNew(short... t);
	
	/** {@inheritDoc} */
	@Override
	Tup4WS createNew(short value);
	
	/** {@inheritDoc} */
	@Override
	Tup4WS createNew(short v0, short v1, short v2, short v3);
	 ...
	 */
	@Override
	Tup4WS setAt(int index, short value);
	 ...
	 * @return This tuple.
	 */
	Tup4WS set(short v0, short v1, short v2, short v3);
	...
	/** {@inheritDoc} */
	@Override
	Tup4WS arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup4WS arrangeN(int iV0, int iV1, int iV2, int iV3);
	
	/** {@inheritDoc} */
	@Override
	Tup4WS swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	Tup4WS arrange(int iV0, int iV1, int iV2, int iV3);
	 ...
	 */
	@Override
	Tup4WS swizzle(int indexA, int indexB);
