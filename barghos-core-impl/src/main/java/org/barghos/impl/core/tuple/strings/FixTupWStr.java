 ...
 */
public interface FixTupWStr extends TupWStr, FixTupRStr
{
	/**
	 ...
	 * this tuple.
	 */
	FixTupWStr createNew();
	
	/** {@inheritDoc} */
	@Override
	FixTupWStr createNew(TupRStr t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWStr createNew(String... t);
	 ...
	 */
	@Override
	FixTupWStr setAt(int index, String value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWStr arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWStr swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	FixTupWStr arrange(int... indices);
	 ...
	 */
	@Override
	FixTupWStr swizzle(int indexA, int indexB);
}
