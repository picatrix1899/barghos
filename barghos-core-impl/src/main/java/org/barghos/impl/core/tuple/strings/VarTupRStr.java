...
/**
 * This interface provides non-modifying operations for string tuples with a
 ...
 * tuple.
 */
public interface VarTupRStr extends TupRStr
{
	/**
	 ...
	 * component values.
	 */
	VarTupRStr createNew(TupRStr t);
	 ...
	 */
	VarTupRStr arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRStr swizzleN(int indexA, int indexB);
}
