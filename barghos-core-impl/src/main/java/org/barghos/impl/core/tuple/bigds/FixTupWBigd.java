 ...
 */
public interface FixTupWBigd extends TupWBigd, FixTupRBigd
{
	/**
	 ...
	 * this tuple.
	 */
	FixTupWBigd createNew();
	
	/** {@inheritDoc} */
	@Override
	FixTupWBigd createNew(TupRBigd t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWBigd createNew(BigDecimal... t);
	 ...
	 */
	@Override
	FixTupWBigd setAt(int index, BigDecimal value);
	 ...
	 */
	@Override
	FixTupWBigd set(BigDecimal value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWBigd arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWBigd swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	FixTupWBigd arrange(int... indices);
	 ...
	 */
	@Override
	FixTupWBigd swizzle(int indexA, int indexB);
}
