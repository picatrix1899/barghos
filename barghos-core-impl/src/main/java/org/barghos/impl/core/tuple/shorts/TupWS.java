...
/**
 * This interface provides common operations for short tuples.
 * 
 * <p>
 ...
 */
public interface TupWS extends TupRS
{
	/**
	 ...
	 * @return This tuple.
	 */
	TupWS setAt(int index, short value);
	...
	/** {@inheritDoc} */
	@Override
	TupWS swizzleN(int indexA, int indexB);
	 ...
	 * @return This tuple.
	 */
	TupWS swizzle(int indexA, int indexB);
}
