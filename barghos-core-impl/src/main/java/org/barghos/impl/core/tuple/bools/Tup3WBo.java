 ...
 * components.
 */
public interface Tup3WBo extends Tup3RBo, FixTupWBo
{
	/** {@inheritDoc} */
	@Override
	Tup3WBo createNew(Tup3RBo t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo createNew(TupRBo t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo createNew(boolean... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo createNew(boolean value);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo createNew(boolean v0, boolean v1, boolean v2);
	 ...
	 */
	@Override
	Tup3WBo setAt(int index, boolean value);
	 ...
	 */
	@Override
	Tup3WBo set(boolean... t);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo set(boolean value);
	 ...
	 * @return This tuple.
	 */
	Tup3WBo set(boolean v0, boolean v1, boolean v2);
	...
	/** {@inheritDoc} */
	@Override
	Tup3WBo arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo arrangeN(int iV0, int iV1, int iV2);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo swizzleN(int indexA, int indexB);
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo swizzleV0V1N();
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo swizzleV0V2N();
	
	/** {@inheritDoc} */
	@Override
	Tup3WBo swizzleV1V2N();
	 ...
	 * @return This tuple.
	 */
	Tup3WBo arrange(int iV0, int iV1, int iV2);
	 ...
	 */
	@Override
	Tup3WBo swizzle(int indexA, int indexB);
