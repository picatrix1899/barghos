...
/**
 * This interface provides non-modifying operations for int tuples with a
 ...
 * tuple.
 */
public interface VarTupRI extends TupRI
{
	/**
	 ...
	 */
	VarTupRI arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRI swizzleN(int indexA, int indexB);
}
