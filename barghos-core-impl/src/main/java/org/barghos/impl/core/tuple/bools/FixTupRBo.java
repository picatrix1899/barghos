...
/**
 * This interface provides non-modifying operations for boolean tuples with an
 ...
 */
public interface FixTupRBo extends TupRBo
{
	/**
	 ...
	 */
	FixTupRBo arrangeN(int... indices);
}
