package org.barghos.impl.core.tuple.shorts;
...
public interface Tup3RS extends FixTupRS
{
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(@AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equals(short tolerance, @AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(int index, @AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAt(short tolerance, int index, @AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(@AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(@AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(@AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV0(short tolerance, @AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV1(short tolerance, @AllowNull Tup3RS t);
	 ...
	 * {@code false} - Otherwise.
	 */
	boolean equalsAtV2(short tolerance, @AllowNull Tup3RS t);
