...
/**
 * This interface provides non-modifying operations for short tuples with a
 ...
 * tuple.
 */
public interface VarTupRS extends TupRS
{
	/**
	 ...
	 */
	VarTupRS arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	VarTupRS swizzleN(int indexA, int indexB);
}
