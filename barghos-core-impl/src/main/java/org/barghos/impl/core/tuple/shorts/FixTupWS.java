 ...
 */
public interface FixTupWS extends TupWS, FixTupRS
{
	/**
	...
	/** {@inheritDoc} */
	@Override
	FixTupWS createNew(TupRS t);
	
	/** {@inheritDoc} */
	@Override
	FixTupWS createNew(short... t);
	 ...
	 */
	@Override
	FixTupWS setAt(int index, short value);
	...
	/** {@inheritDoc} */
	@Override
	FixTupWS arrangeN(int... indices);
	
	/** {@inheritDoc} */
	@Override
	FixTupWS swizzleN(int indexA, int indexB);
	 ...
	 */
	@Override
	FixTupWS swizzle(int indexA, int indexB);
}
