...
public interface ConsumerEx4OA extends ConsumerEx4<Object[],Object[],Object[],Object[]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4OA then(ConsumerEx4OA after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4OA then(ConsumerEx4<? super Object[],? super Object[],? super Object[],? super Object[]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4OA before(ConsumerEx4OA before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4OA before(ConsumerEx4<? super Object[],? super Object[],? super Object[],? super Object[]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4OA handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx4OA onEx(ConsumerEx4OA consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4OA onEx(ConsumerEx4<? super Object[],? super Object[],? super Object[],? super Object[]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4OA onEx(Consumer4OA consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4OA onEx(Consumer4<? super Object[],? super Object[],? super Object[],? super Object[]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA of(ConsumerEx4OA... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4OA consumer : consumers) consumer.acceptO(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA of(ConsumerEx4<? super Object[],? super Object[],? super Object[],? super Object[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA of(Consumer4OA... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4OA consumer : consumers) consumer.accept(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA of(Consumer4<? super Object[],? super Object[],? super Object[],? super Object[]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
