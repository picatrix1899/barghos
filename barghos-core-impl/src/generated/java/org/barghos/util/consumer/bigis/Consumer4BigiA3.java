 ...
 * arguments and returns no result. {@link Consumer4BigiA3} is expected to operate
 * via side-effects.
 *
 * <p>
...
public interface Consumer4BigiA3 extends Consumer4<BigInteger[][][],BigInteger[][][],BigInteger[][][],BigInteger[][][]>
{
	 ...
	 * operation after.
	 */
	default Consumer4BigiA3 then(Consumer4BigiA3 after)
	{
	 ...
	 */
	@Override
	default Consumer4BigiA3 then(Consumer4<? super BigInteger[][][],? super BigInteger[][][],? super BigInteger[][][],? super BigInteger[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default Consumer4BigiA3 before(Consumer4BigiA3 before)
	{
	 ...
	 */
	@Override
	default Consumer4BigiA3 before(Consumer4<? super BigInteger[][][],? super BigInteger[][][],? super BigInteger[][][],? super BigInteger[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer4BigiA3 of(Consumer4BigiA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(Consumer4BigiA3 consumer : consumers) consumer.acceptBigi(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer4BigiA3 of(Consumer4<? super BigInteger[][][],? super BigInteger[][][],? super BigInteger[][][],? super BigInteger[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
