...
public interface ConsumerEx4OA3 extends ConsumerEx4<Object[][][],Object[][][],Object[][][],Object[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx4OA3 then(ConsumerEx4OA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx4OA3 then(ConsumerEx4<? super Object[][][],? super Object[][][],? super Object[][][],? super Object[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx4OA3 before(ConsumerEx4OA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx4OA3 before(ConsumerEx4<? super Object[][][],? super Object[][][],? super Object[][][],? super Object[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer4OA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx4OA3 onEx(ConsumerEx4OA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx4OA3 onEx(ConsumerEx4<? super Object[][][],? super Object[][][],? super Object[][][],? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer4OA3 onEx(Consumer4OA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer4OA3 onEx(Consumer4<? super Object[][][],? super Object[][][],? super Object[][][],? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA3 of(ConsumerEx4OA3... consumers)
	{
		...
		return (a, b, c, d) -> { for(ConsumerEx4OA3 consumer : consumers) consumer.acceptO(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA3 of(ConsumerEx4<? super Object[][][],? super Object[][][],? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA3 of(Consumer4OA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c, d) -> { for(Consumer4OA3 consumer : consumers) consumer.accept(a, b, c, d); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx4OA3 of(Consumer4<? super Object[][][],? super Object[][][],? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
