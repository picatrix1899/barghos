...
public interface Consumer2SA2 extends Consumer2<short[][],short[][]>
{
	 ...
	 * operation after.
	 */
	default Consumer2SA2 then(Consumer2SA2 after)
	{
	 ...
	 */
	@Override
	default Consumer2SA2 then(Consumer2<? super short[][],? super short[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default Consumer2SA2 before(Consumer2SA2 before)
	{
	 ...
	 */
	@Override
	default Consumer2SA2 before(Consumer2<? super short[][],? super short[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@SafeVarargs
	static Consumer2SA2 of(Consumer2SA2... consumers)
	{
		...
		return (a, b) -> { for(Consumer2SA2 consumer : consumers) consumer.acceptS(a, b); };
	}
	 ...
	 */
	@SafeVarargs
	static Consumer2SA2 of(Consumer2<? super short[][],? super short[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static Consumer2SA2 of(java.util.function.BiConsumer<? super short[][],? super short[][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
