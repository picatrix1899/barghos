...
public interface ConsumerEx3DA3 extends ConsumerEx3<double[][][],double[][][],double[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx3DA3 then(ConsumerEx3DA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx3DA3 then(ConsumerEx3<? super double[][][],? super double[][][],? super double[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx3DA3 before(ConsumerEx3DA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx3DA3 before(ConsumerEx3<? super double[][][],? super double[][][],? super double[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer3DA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx3DA3 onEx(ConsumerEx3DA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx3DA3 onEx(ConsumerEx3<? super double[][][],? super double[][][],? super double[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer3DA3 onEx(Consumer3DA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer3DA3 onEx(Consumer3<? super double[][][],? super double[][][],? super double[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3DA3 of(ConsumerEx3DA3... consumers)
	{
		...
		return (a, b, c) -> { for(ConsumerEx3DA3 consumer : consumers) consumer.acceptD(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3DA3 of(ConsumerEx3<? super double[][][],? super double[][][],? super double[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3DA3 of(Consumer3DA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b, c) -> { for(Consumer3DA3 consumer : consumers) consumer.accept(a, b, c); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx3DA3 of(Consumer3<? super double[][][],? super double[][][],? super double[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
