...
public interface Consumer3CA2 extends Consumer3<char[][],char[][],char[][]>
{
	 ...
	 * operation after.
	 */
	default Consumer3CA2 then(Consumer3CA2 after)
	{
	 ...
	 */
	@Override
	default Consumer3CA2 then(Consumer3<? super char[][],? super char[][],? super char[][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default Consumer3CA2 before(Consumer3CA2 before)
	{
	 ...
	 */
	@Override
	default Consumer3CA2 before(Consumer3<? super char[][],? super char[][],? super char[][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	...
	static Consumer3CA2 of(Consumer3CA2... consumers)
	{
		...
		return (a, b, c) -> { for(Consumer3CA2 consumer : consumers) consumer.acceptC(a, b, c); };
	}
