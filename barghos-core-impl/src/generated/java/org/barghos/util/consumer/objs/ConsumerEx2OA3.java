...
public interface ConsumerEx2OA3 extends ConsumerEx2<Object[][][],Object[][][]>
{
	 ...
	 * operation after.
	 */
	default ConsumerEx2OA3 then(ConsumerEx2OA3 after)
	{
	 ...
	 */
	@Override
	default ConsumerEx2OA3 then(ConsumerEx2<? super Object[][][],? super Object[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 */
	@Override
	default ConsumerEx2OA3 then(java.util.function.BiConsumer<? super Object[][][],? super Object[][][]> after)
	{
		Validate.Arg.checkNotNull("after", after);
	 ...
	 * this operation.
	 */
	default ConsumerEx2OA3 before(ConsumerEx2OA3 before)
	{
	 ...
	 */
	@Override
	default ConsumerEx2OA3 before(ConsumerEx2<? super Object[][][],? super Object[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default ConsumerEx2OA3 before(java.util.function.BiConsumer<? super Object[][][],? super Object[][][]> before)
	{
		Validate.Arg.checkNotNull("before", before);
	 ...
	 */
	@Override
	default Consumer2OA3 handleEx(ExceptionHandler handler)
	{
	...
	default ConsumerEx2OA3 onEx(ConsumerEx2OA3 consumer)
	{
	 ...
	 */
	@Override
	default ConsumerEx2OA3 onEx(ConsumerEx2<? super Object[][][],? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	default Consumer2OA3 onEx(Consumer2OA3 consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@Override
	default Consumer2OA3 onEx(Consumer2<? super Object[][][], ? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	...
	@Override
	default Consumer2OA3 onEx(java.util.function.BiConsumer<? super Object[][][],? super Object[][][]> consumer)
	{
		Validate.Arg.checkNotNull("consumer", consumer);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2OA3 of(ConsumerEx2OA3... consumers)
	{
		...
		return (a, b) -> { for(ConsumerEx2OA3 consumer : consumers) consumer.acceptO(a, b); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2OA3 of(ConsumerEx2<? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2OA3 of(Consumer2OA3... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
		...
		return (a, b) -> { for(Consumer2OA3 consumer : consumers) consumer.accept(a, b); };
	}
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2OA3 of(Consumer2<? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
	 ...
	 */
	@SafeVarargs
	static ConsumerEx2OA3 of(java.util.function.BiConsumer<? super Object[][][],? super Object[][][]>... consumers)
	{
		Validate.Arg.checkNotNull("consumers", consumers);
		Validate.Arg.checkEntriesNotNull("consumers", consumers);
